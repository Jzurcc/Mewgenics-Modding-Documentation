# Enemies and Combat/Enemies and Characters Directory
...
- `ENEMY_BIRD_DESC`: "Whoever kills this gets All Stats Up and finds a bonus item!"
...
**Localization Strings:**
- `ENEMY_CHERUB_FINALBOSS_DESC`: "Whoever kills this gets All Stats Up!"
...
**Localization Strings:**
- `ENEMY_RADICALRAT_DESC`: "Tosses bombs that explode at the end of the round."
...
**Localization Strings:**
- `ENEMY_BORIS_DESC`: "Moves 1 tile towards whatever damages it. <br/> Will Dash on its last turn. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_DUSTDEVIL_DESC`: "He's got the power of an upright in his goddamn hand!"
...
UltraSmough {
    ...
    properties {
        ...
        health 75 //+25 health over regular Smough
    }
...
UltraOrnstein {
    ...
    properties {
        ...
        health 100 //+25 health over normal ornstein
    }
...
Simon {
    ...
    abilities {
        ...
        spells [
            ...
            SimonSays_ComeHere
            SimonSays_GoAway
            //TODO: SimonSays_Spread (each cat has a 2-3 radius danger region surrounding it, spread them out to not get hit)
...
SimonFlopper {
    ...
    passives {
        FormChanger {
            Flop { //initial flopped down state, the state you start in when the king goes to his second form. takex exactly 4 wiggles to get up
            ...
            Flop2 { //subsequent flopped down state, when hit he has a chance to go into this state, takes 2 to 6 wiggles to get up
                animation_suffix "Down"
...
**Localization Strings:**
- `ENEMY_BUMBLEFOOT_DESC`: "Its leap attack will turn it upside down. <br/> When upside down it performs an area attack. <br/> Will eat any bodies in play, and living things if there are no bodies left."
...
**Localization Strings:**
- `ENEMY_ROCKYBOBO_DESC`: "Moves towards what damages it. <br/> Does a body slam attack in the direction he's facing. <br/> Can levitate rocks!"
...
**Localization Strings:**
- `ENEMY_CHUBS_DESC`: "Blind. <br/> Shoots a Poison shot when damaged. <br/> Does a melee spin attack."
...
**Localization Strings:**
- `ENEMY_NUBS_DESC`: "Blind. <br/> Lobs a Poison creep shot when damaged. <br/> Does a leap attack with Knockback."
...
**Localization Strings:**
- `ENEMY_SPIDERQUEEN_DESC`: "Does a bite attack. <br/> Has a chance to spawn Spiderlings when damaged. <br/> Enrages when hit from behind. <br/> Can spawn Spider Cats."
...
SpiderQueen {
    ...
    properties {
        ...
        health 250
        //dispersed_bonus_turns 2
        takes_main_turn false //turns get set in FormChanger
    ...
    passives {
        ...
        FormChanger {
            Start_Ceiling { //no AI until it's on map
                passives {
                    FormChangeOffMap {
    ...
    ai {
        brain NoBrain //brains set in FormChanger
        decision_weights default
        move_weights stay_close_always_move
    }
}
...
**Localization Strings:**
- `ENEMY_JOHNNY_DESC`: "Calls in Cultists for help. <br/> Can only use his psychic spells while being washed."
...
Johnny {
    ...
    ai {
        brain NoBrain //brains set in FormChanger
        //always_allow_player_control true
        decision_weights default
        move_weights stay_close
    }
}
...
**Localization Strings:**
- `ENEMY_CRATERMAKER_DESC`: "Changes its primed attack whenever it takes damage. <br/> Shoots from its sides when damaged."
...
AlienBeast {
    ...
    abilities {
        ...
        spells [
            AlienBeastScream  //0 aux
            AlienBeastEat     //1 aux
            AlienBeastPuke    //2 aux
            AlienBeastRampage //3 aux
...
**Localization Strings:**
- `ENEMY_COVEN_DESC`: "Attempts to finish its ritual..."
...
**Localization Strings:**
- `ENEMY_TORMENTOR_DESC`: "Its demonic runes grant it powers and abilities."
...
Tormentor {
    ...
    passives {
        ...
        PassiveWhileNotHasStatus { //conditionally enabled trample doesnt stack its damage right so this hack handles it lol
            status DemonicGlyph_Movement
            passives {
                Trample 3
            }
...
**Localization Strings:**
- `ENEMY_MANINTHEMOON_DESC`: "Its breath attack will push all units back 10 tiles. <br/> Loses its Brace if it punches itself. <br/> What could be inside?"
...
MoonHead {
        ...
        FormChanger {
            Default {
                ...
                ai {
                    ...
                    round_end_bonusturn_pattern {
                        //do_all [MoonHead_Finisher MoonHead_SpawnHand]
            ...
            HasCat {
                ...
                ai {
                    ...
                    round_end_bonusturn_pattern {
                        //do_all [MoonHead_Finisher MoonHead_ChewCat MoonHead_SpawnHand]
            ...
            //hack for this moon head cracked visual alt nonsense
            Hint_CrackedVisuals {
    ...
    ai {
        brain NoBrain //goverened by FormChanger
        decision_weights default
        move_weights stay_close
    }
}
...
**Localization Strings:**
- `ENEMY_MOONHAND_DESC`: "Will grab units that end movement directly in front of it. <br/> Attack it to turn it away from you. <br/> Attacking it from behind will force it to dash attack or drop what its holding."
        ...
        FormChanger {
            ...
            HasCat {
                ...
                ai {
                    ...
                    pattern {
                        //do_random [attack MoonHandThrow]
                        do attack
                    }
                }
            }
...
**Localization Strings:**
- `ENEMY_BUNGATHRONE_DESC`: "Built from the bones of his enemies."
...
**Localization Strings:**
- `ENEMY_LORDBUNGA_DESC`: "Retaliates when hit. <br/> Consumes adjacent units at the start of his turn. <br/> Blind to units behind him."
...
**Localization Strings:**
- `ENEMY_QUEENHIPPO_DESC`: "Its melee attack deals Chain Knockback. <br/> Uppercuts any adjacent units at the start of its turn. <br/> Has heart problems..."
...
**Localization Strings:**
- `ENEMY_TRAMPY_DESC`: "Does a series of seemingly random things, but not in a random order! <br/> Drunk."
...
Trampy {
    ...
    ai {
        ...
        pattern {
            //do_random [attack *TrampyDrink TrampyDump TrampySpit TrampyFleas TrampySleep]
            do TrampyDump
            do TrampySpit
            do TrampyFleas
            do_priority [*TrampyDrink TrampyDrink]
...
**Localization Strings:**
- `ENEMY_DYBBUK_DESC`: "Avoids your attacks! Will get revenge on the cat who kills it!"
...
**Localization Strings:**
- `ENEMY_HITLERHEAD_DESC`: "Grows his army of Hitlers!"
...
**Localization Strings:**
- `ENEMY_HITLER_DESC`: "Rallies his army. Has a ranged attack and Trample."
...
**Localization Strings:**
- `ENEMY_DREADNOUGHTUSLEG_DESC`: "Stomps towards units that damage it. Lifts when it takes enough damage."
...
**Localization Strings:**
- `ENEMY_DREADNOUGHTUSHEAD_DESC`: "Now's your opportunity! Get him before he gets back up!"
...
MegaDinoHead {
    ...
    ai {
        brain NoBrain //done in FormChanger
        decision_weights default
        move_weights stay_close
    }
}
...
**Localization Strings:**
- `ENEMY_MOTHERTUMOR_DESC`: "Grabs units and pulls them towards The Mother."
...
MotherTumor {
    ...
    passives {
        ...
        MotherTumorPassive {
            considered_forms [Big BigHolding BigHoldingCat] //exclude the small ones from pass/receive consideration
        
            pass_ani pass
            receive_ani receive
            grow_ability MotherTumorGrow

            //copied from the SpawnIn passive (passives to add on RECEIVE)
            Cat {
...
**Localization Strings:**
- `ENEMY_MOTHER_DESC`: "The mother will take back what's hers..."
...
**Localization Strings:**
- `ENEMY_TOMTOM_DESC`: "It's slow, but has a wide melee attack."
...
**Localization Strings:**
- `ENEMY_MANGY_DESC`: "Its ranged attack may inflict Poison. <br/> Spawns maggots when damaged."
...
**Localization Strings:**
- `ENEMY_KITTEN_DESC`: "Runs away when damaged."
...
**Localization Strings:**
- `ENEMY_CATCALLER_DESC`: "Slows units. <br/> Counterattacks when hit."
...
**Localization Strings:**
- `ENEMY_GLASSSPITTER_DESC`: "Its ranged attack spawns glass and inflicts Bleed."
...
**Localization Strings:**
- `ENEMY_SIREN_DESC`: "Calls its enemies towards it and heals its adjacent allies."
...
**Localization Strings:**
- `ENEMY_JEKYLL_DESC`: "It will evolve in several turns."
...
**Localization Strings:**
- `ENEMY_HYDE_DESC`: "Its melee attack can hit multiple times!"
...
**Localization Strings:**
- `ENEMY_SPIKEDCAT_DESC`: "Be careful of its Thorns!"
...
**Localization Strings:**
- `ENEMY_POPEYE_DESC`: "Has a dash attack with knockback."
...
**Localization Strings:**
- `ENEMY_GASSY_DESC`: "Its farts inflict Poison 3. <br/> Farts and projects itself forward when damaged."
...
**Localization Strings:**
- `ENEMY_SHARKY_DESC`: "Its bite inflicts Bleed. <br/> Takes bonus turns for each bleeding unit. <br/> Focuses on bleeding units."
...
**Localization Strings:**
- `ENEMY_BOOMER_DESC`: "Explodes when killed, damaging all nearby units."
...
**Localization Strings:**
- `ENEMY_WATERKITTEN_DESC`: "Moves away when damaged. <br/> May be hiding in water..."
...
**Localization Strings:**
- `ENEMY_ALBINOTOMTOM_DESC`: "Its wide melee attacks have Knockback 2."
...
**Localization Strings:**
- `ENEMY_SPIDERKITTEN_DESC`: "Will Web units, then drain their HP. <br/> Immune to Webs."
...
**Localization Strings:**
- `ENEMY_SPIDERCAT_DESC`: "Its melee attack has Lifesteal. <br/> Will move away after it attacks. <br/> Immune to tile effects."
...
**Localization Strings:**
- `ENEMY_TOADIE_DESC`: "Disguises itself as inanimate objects. <br/> While disguised, ambushes enemies that walk past it, causing Fear."
...
**Localization Strings:**
- `ENEMY_ZOMBIECAT_DESC`: "Eats corpses and becomes stronger! <br/> Taking damage weakens it and spawns poison food. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SKELETONCAT_DESC`: "Comes back from the dead if its body isn't destroyed! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SKELETONCATBODY_DESC`: "Will come back from the dead next turn! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_TALLSKELETONCAT_DESC`: "Its ranged attack can also give [img:shield] to its allies. <br/> Will come back from the dead if its body isn't destroyed! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_TALLSKELETONCATBODY_DESC`: "Will come back from the dead next turn! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_WERECAT_DESC`: "Can use both its dash attack and its leap attack in the same turn."
...
**Localization Strings:**
- `ENEMY_GOLEM_DESC`: "Invulnerable. Dies when all of its allies are dead."
...
**Localization Strings:**
- `ENEMY_SCORPIONCAT_DESC`: "Its melee attacks can Poison or Immobilize."
...
**Localization Strings:**
- `ENEMY_MUMMIFIEDMANGY_DESC`: "Its ranged attack may inflict Poison. <br/> Spawns Maggots when damaged. <br/> Becomes a Carcass when killed."
...
**Localization Strings:**
- `ENEMY_BOUNTYHUNTER_DESC`: "Can shoot anywhere within its line of sight. Prefers long shots."
...
**Localization Strings:**
- `ENEMY_HORNYCAT_DESC`: "Its ranged attack inflicts Blind."
...
**Localization Strings:**
- `ENEMY_INFESTEDKITTEN_DESC`: "Its melee attack inflicts Possessed. <br/> Moves away when damaged."
...
**Localization Strings:**
- `ENEMY_ROCKHEAD_DESC`: "Has a spin attack and a dash attack with Trample. <br/> Blind."
...
**Localization Strings:**
- `ENEMY_HEADLESS_DESC`: "Has a spin attack. <br/> Shoots a Poison shot when damaged. <br/> Blind."
...
**Localization Strings:**
- `ENEMY_ATOMICKITTEN_DESC`: "Emits a burst of radiation at the start of its turn. <br/> Teleports away when damaged. <br/> Explodes when killed."
...
**Localization Strings:**
- `ENEMY_ROBOCAT_DESC`: "Its wide melee attacks have Knockback 10."
...
**Localization Strings:**
- `ENEMY_CATCULTIST_DESC`: "Melee attacker. Increases the amount of times it can attack each turn whenever it takes damage."
...
**Localization Strings:**
- `ENEMY_DEMONHOOKER_DESC`: "Will hook and pull units toward itself. <br/> Immune to fire."
...
**Localization Strings:**
- `ENEMY_BELCHER_DESC`: "Its ranged attack inflicts Burn and creates a lava tile. <br/> Immune to fire."
...
**Localization Strings:**
- `ENEMY_TUMORCAT_DESC`: "Will dash forward 10 tiles with Trample when damaged. <br/> Blind."
...
**Localization Strings:**
- `ENEMY_ROVER_DESC`: "Has a chaining dash attack."
...
**Localization Strings:**
- `ENEMY_ASTRONAUT_DESC`: "Its melee attack has a high chance to inflict Stun."
...
Astro {
    ...
    properties {
        ...
        health 8
        shield 5
        movement 1 //boosted to 3 via low grav since its a jump movement
        faction enemies
        base_mana_regen 999
    }
...
**Localization Strings:**
- `ENEMY_DRCAT_DESC`: "Will randomly cast one of 6 spells."
...
**Localization Strings:**
- `ENEMY_INFESTED_DESC`: "Its ranged attack has a chance to break equipment and attach a parasite. <br/> Spawns a Gamete when killed."
...
**Localization Strings:**
- `ENEMY_SPUNCAT_DESC`: "Has a random class basic attack that inflicts a randomly assigned debuff."
...
Needlecat {
    ...
    passives {
        FormChanger { //dumb hack to get per-class portraits
            Colorless{}
            Fighter{}
            Hunter{}
            Mage{}
        ...
        RandomPassivePool {
            ...
            PassiveGroup {
                ...
                FormChange Medic
                StatusCarefulness 1 //needed so it wont do random status effects if it heals
            }
            PassiveGroup {
            ...
            PassiveGroup {
                ...
                FormChange Tinkerer
                SelfStatusCarefulness 1 //needed so it wont do random status effects on itself
            }
        }
...
**Localization Strings:**
- `ENEMY_STACYNO_DESC`: "Its melee attack inflicts Charm. <br/> Can heal and grant All Stats Up to its allies."
...
**Localization Strings:**
- `ENEMY_RAPTOR_DESC`: "Its melee attack hits a random amount of times. <br/> Pack hunter."
...
**Localization Strings:**
- `ENEMY_RAPTORKITTEN_DESC`: "Its melee attack inflicts bleed. Moves far away after attacking."
...
**Localization Strings:**
- `ENEMY_ANKYLOSAURUS_DESC`: "Has a wide melee attack with Knockback 10 and a chance to inflict Stun. <br/> Does a spin attack when it takes damage."
...
**Localization Strings:**
- `ENEMY_MAELESTES_DESC`: "Steals equipment from cats. <br/> Collects pickups."
...
**Localization Strings:**
- `ENEMY_PARASAUROLOPHUS_DESC`: "Its attacks always crit against Wet units. <br/> Tries to toss units into water."
...
**Localization Strings:**
- `ENEMY_YETICAT_DESC`: "Its ranged ice attack inflicts Slow and has a chance to inflict Freeze. <br/> Counter attacks melee attackers."
...
**Localization Strings:**
- `ENEMY_SABERTOOTHCAT_DESC`: "Pounces on units. <br/> Does a double-hit melee attack that inflicts bleed at the start of its turn if any enemies are adjacent. <br/> Hates Cavemen!"
...
**Localization Strings:**
- `ENEMY_SABERTOOTHKITTEN_DESC`: "Has a multi hit melee attack that inflicts Bleed. <br/> Can heal its allies. <br/> Hates Cavemen!"
...
**Localization Strings:**
- `ENEMY_MAMMOTHKITTEN_DESC`: "Its melee attack knocks units into the air. <br/> Bruises and knocks back adjacent units at the start of its turn. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_SKINNED_DESC`: "Does 3 dash attacks in a row with Knockback."
...
**Localization Strings:**
- `ENEMY_STEMCAT_DESC`: "Melee attacker. <br/> Spawns a Clot when it takes damage."
...
**Localization Strings:**
- `ENEMY_KATZEBOT_DESC`: "Melee attacker. Focuses its lowest health enemy. Will Suplex others out of the way."
...
**Localization Strings:**
- `ENEMY_FATCAT_DESC`: "Has a leap attack that does knockback in an area. <br/> Reflects Projectiles. Uncapped HP."
...
**Localization Strings:**
- `ENEMY_CANCERCAT_DESC`: "Its melee attack causes cats it hits to lose 1 [img:con] permanently and has a chance to give them cancer. <br/> Explodes after 3 turns."
...
**Localization Strings:**
- `ENEMY_COLLECTIVE_DESC`: "Has a spin attack. <br/> Counterattacks when hit. <br/> Mimics the attacks and counters of all other cats in The Collective."
...
**Localization Strings:**
- `ENEMY_SHADECAT_DESC`: "Melee attacker. Teleports behind a random one of its enemies when damaged. <br/> Its backstabs cause Fear and always crit."
...
**Localization Strings:**
- `ENEMY_JACKCAT_DESC`: "Protects his allies."
...
**Localization Strings:**
- `ENEMY_CHAOSSTACY_DESC`: "Its melee attack inflicts Scrambled. <br/> Reflects projectiles and knocks back units that contact."
...
**Localization Strings:**
- `ENEMY_ANGELICCAT_DESC`: "Has a Holy Wind area attack. <br/> Gains 1 [img:divineshield] at the end of its turn. <br/> Immune to Holy. Gains All Stats Up when struck with Holy Element."
...
**Localization Strings:**
- `ENEMY_LOANSHARK_DESC`: "Its bite inflicts Bleed. <br/> Takes bonus turns for each bleeding unit. <br/> Focuses on bleeding units."
...
**Localization Strings:**
- `ENEMY_MAISIE_DESC`: "Protects her kittens when they are attacked."
...
**Localization Strings:**
- `ENEMY_LUCY_DESC`: "Her powerful spells take time to charge up."
...
MageCat {
    ...
    properties {
        ...
        /*mana_regen -2 //the mage collar gives 2 mana regen this offsets it
        mana 100
        initial_mana 100
        mana_matters true*/
...
**Localization Strings:**
- `ENEMY_FENRIR_DESC`: "Tosses bear traps! <br/> Has an affinity for tall grass. <br/> Swats away melee attackers."
...
**Localization Strings:**
- `ENEMY_DACK_DESC`: "His ranged attacks scatter held coins. <br/> Has a melee attack that inflicts Poison. <br/> Seeks coin pickups. <br/> Gains a Backflip every time he collects a coin."
...
**Localization Strings:**
- `ENEMY_MARSHMALLOW_DESC`: "Her lick attack Charms units."
...
MedicCat {
    ...
    abilities {
        move DefaultMove
        attack BasicMedicMelee//BasicMedicRanged
...
**Localization Strings:**
- `ENEMY_MAGNUS_DESC`: "Has a chaining dash attack and a spin attack."
...
**Localization Strings:**
- `ENEMY_PEBBLES_DESC`: "Its melee attack knocks units back. <br/> Can throw rocks."
...
**Localization Strings:**
- `ENEMY_MORANA_DESC`: "Its ranged attack inflicts Leech. <br/> Reanimates dead bodies. <br/> Revives through dead bodies."
...
**Localization Strings:**
- `ENEMY_FRANKLIN_DESC`: "Spawns Robots and crafts weapons. <br/> Enters a Mech when at low HP."
...
**Localization Strings:**
- `ENEMY_GEIN_DESC`: "Hooks and pulls units that end their movement in range, inflicting Bleed. <br/> Does a melee spin attack that spawns meat. <br/> Seeks meat pickups. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_ALICE_DESC`: "Has a psychic choke attack that inflicts Bruise on a unit in her line of sight. <br/> Knocks back any enemy that casts a spell."
...
**Localization Strings:**
- `ENEMY_DRAVEN_DESC`: "Heals and buffs his crows. <br/> Enters Squirrel Form once his crows die."
- `ENEMY_DRAVENSQUIRRELFORM_DESC`: "Has a multi-hit melee attack. <br/> Spawns squirrels."
...
**Localization Strings:**
- `ENEMY_DRAVENCROW_DESC`: "Melee attacker than can also use a wind attack with Knockback. <br/> Will move and attack enemies that attack Draven."
...
**Localization Strings:**
- `ENEMY_CHANHUNG_DESC`: "Uses his own actions every time one of his enemies uses an action. <br/> Has a different response for move, attack/weapon, and spell/trinket."
...
**Localization Strings:**
- `ENEMY_ARTHUR_DESC`: "Who knows what he will do!?"
...
**Localization Strings:**
- `ENEMY_CHUPACAPBRA_DESC`: "More like chupa gato! Am I right?"
...
**Localization Strings:**
- `ENEMY_HELLSPAWN_DESC`: "It has such sights to show you!"
...
**Localization Strings:**
- `ENEMY_PARAISARIA_DESC`: "Takes an extra turn for each Sprout."
...
**Localization Strings:**
- `ENEMY_FRODROCKSNOW_DESC`: "Has a wide melee attack with Knockback and a chance to stun. <br/> Can throw rocks."
            ...
            AllAlive {
                passives {
                    CaveFamilyEnrage {
                        ...
                        tag cavefamily
                        count 1 //when 1 or less others alive use ability
                    }
                }
            }
            TwoAlive {
                passives {
                    ...
                    CaveFamilyEnrage {
                        ...
                        tag cavefamily
                        count 0 //when 0 others alive use ability
                    }
                }
                turns {
                    evenly_dispersed_bonus_turns 1
...
**Localization Strings:**
- `ENEMY_WOLMAROCKSNOW_DESC`: "Has a ranged ice attack that inflicts Slow. Can heal its allies. Can throw enemies to her allies."
...
CaveCatMom {
    ...
    passives {
        Buddy CaveCatDad //for "throw towards buddy" effect
...
**Localization Strings:**
- `ENEMY_POOBLESROCKSNOW_DESC`: "Places bear traps. Has a jumping melee attack."
...
**Localization Strings:**
- `ENEMY_WHITERABBIT_DESC`: "What's he do, nibble your bum?"
...
**Localization Strings:**
- `ENTITY_CROW_DESC`: "Inherits its owner's stats. <br/> Basic attack modifiers on its owner also get applied to the Crow. <br/> Flying."
...
```
MaddenedBear { //used for DarkDen event.
    variant_of Bear
    passives {
        PermanentMadness 1
    }
...
**Localization Strings:**
- `ENTITY_CATERPILLAR_DESC`: "Gains All Stats Up each turn. <br/> Evolves into a Moth when it reaches All Stats Up 5."
...
**Localization Strings:**
- `ENTITY_EGG_DESC`: "What could it hatch into?"
...
**Localization Strings:**
- `ENTITY_GLOWMUSHROOM_DESC`: "Grants Mana to nearby units on its turn."
...
**Localization Strings:**
- `ENTITY_GLOWMUSHROOM2_DESC`: "Grants Mana and health to nearby units on its turn."
...
**Localization Strings:**
- `ENEMY_LILRAT_DESC`: "Dashes in a straight line."
...
**Localization Strings:**
- `ENEMY_POOTER_DESC`: "Ranged attacker. Flying."
...
**Localization Strings:**
- `ENEMY_WORM_DESC`: "Moves away when damaged."
...
Gasser {
    ...
    properties {
        ...
        flying true
        mana_regen 999
        exclude_from_hallucinate true //TODO: uncomment this if the enemy is added for real
    }
...
**Localization Strings:**
- `ENEMY_BLORB_DESC`: "Its ranged attack inflicts Slow in an area."
...
**Localization Strings:**
- `ENEMY_FLORB_DESC`: "Its ranged attack inflicts Slow. Flying."
...
**Localization Strings:**
- `ENEMY_LUMPY_DESC`: "Its ranged attack creates Creep. Spawns Creep when damaged."
...
**Localization Strings:**
- `ENEMY_LEAPER_DESC`: "Its leap attack damages and knocks back all adjacent units."
...
**Localization Strings:**
- `ENEMY_BOMBFLY_DESC`: "Explodes when it dies."
...
**Localization Strings:**
- `ENEMY_BURFERMAGGOT_DESC`: "Its attack surrounds units with Thorny lumps."
...
**Localization Strings:**
- `ENEMY_CHARGEYMAGGOT_DESC`: "Its dash attack has trample."
...
**Localization Strings:**
- `ENEMY_DIGGYMAGGOT_DESC`: "Its melee attack has a chance to Stun. Swaps places with a unit to move."
...
**Localization Strings:**
- `ENEMY_TARBABY_DESC`: "Its ranged attack creates Tar tiles. <br/> Leaves Tar tiles in its path."
...
**Localization Strings:**
- `ENEMY_CHUMBAG_DESC`: "Its long range attack spawns Maggots if it hits an empty tile. Becomes a Chummy when killed. Stationary."
...
**Localization Strings:**
- `ENEMY_CHUMMY_DESC`: "Dashes in a straight line."
...
**Localization Strings:**
- `ENEMY_HOST_DESC`: "Shoots 3 projectiles in a spread. <br/> Reflects projectiles and knocks back units who contact it. <br/> Stationary."
...
**Localization Strings:**
- `ENEMY_PILE_DESC`: "Its ranged attack spawns Dips. Stationary."
...
**Localization Strings:**
- `ENEMY_FLOATER_DESC`: "Melee attacker that moves away after it deals damage."
...
**Localization Strings:**
- `ENEMY_WATERLEECH_DESC`: "Seeks water when its out of water. <br/> While in water, dashes in a straight line with Lifesteal that passes through units."
...
**Localization Strings:**
- `ENEMY_DADDYSHARK_DESC`: "Will instantly kill anything it can reach! <br/> Takes bonus turns for each bleeding unit. <br/> Focuses on bleeding units."
...
**Localization Strings:**
- `ENEMY_BABYSHARK_DESC`: "Its bite inflicts Bleed but does no damage. <br/> Takes bonus turns for each bleeding unit. <br/> Focuses on bleeding units."
...
**Localization Strings:**
- `ENEMY_TENTICKLES_DESC`: "Can attack any tile adjacent to water. <br/> Teleports through water tiles."
...
**Localization Strings:**
- `ENEMY_FETUS_DESC`: "Ranged attacker. <br/> Can drink water to heal."
...
Fetus {
    ...
    passives {
        ...
        FormChangeHealthThreshold {
            threshold X-4      //X is max_health for this passive
            form_below Damaged //health <= threshold
            form_above Full    //health > threshold
        }
    }
...
**Localization Strings:**
- `ENEMY_FETUSGUSHER_DESC`: "Its water attack pushes all units in a straight line. <br/> Must be in water to attack. Seeks water when out of water."
...
**Localization Strings:**
- `ENEMY_BAT_DESC`: "Its melee flurry inflicts Confusion. <br/> 50% Dodge Chance. <br/> Flying."
...
**Localization Strings:**
- `ENEMY_BRAINDRAIN_DESC`: "Infinite ranged magic attacker. <br/> Will counter a spell once per turn. <br/> If it starts its turn with its counterspell still available, it absorbs it for a buff."
...
**Localization Strings:**
- `ENEMY_SKULLOOZE_DESC`: "Its ranged attack destroys equipment."
...
**Localization Strings:**
- `ENEMY_KORBEE_DESC`: "Will suck units in, then spit them out as far away as it can."
...
**Localization Strings:**
- `ENEMY_MEGAFETUS_DESC`: "Performs a spin attack. <br/> Will try to counterattack with its left arm when hit."
...
**Localization Strings:**
- `ENEMY_TATTERS_DESC`: "Its attack inflicts Leech to all units in an area. <br/> Will inflict Hex on units that damage it. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SPOOKIE_DESC`: "Its melee attack drains mana. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SCARY_DESC`: "Its melee attacks can inflict Fear or Doom! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_REAPER_DESC`: "Performs a spin attack at the start of its turn. <br/> Teleports to units that kill its allies. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_TALLROBES_DESC`: "Its ranged attack inflicts Leech. <br/> Can summon Wisps. <br/> Becomes a Tatters when killed. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SHAMBLER_DESC`: "Will throw units it can reach. <br/> Lunges in a random direction at the end of its turn. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_GRAVEWORM_DESC`: "Ranged attacker. <br/> Digs away when damaged."
...
**Localization Strings:**
- `ENEMY_BUTTZOMBIE_DESC`: "Will attack all adjacent units with its melee attack when its backside is underground. <br/> Goes upside down when damaged. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SKELESHAMBLER_DESC`: "Will throw units it can reach. <br/> Lunges in a random direction at the end of its turn. <br/> Comes back from the dead if its body isn't destroyed! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_SKELESHAMBLERDEAD_DESC`: "Comes back from the dead if its body isn't destroyed! <br/> Undead."
...
**Localization Strings:**
- `ENEMY_THUMP_DESC`: "Performs a jump attack. <br/> Can only be damaged from behind."
...
**Localization Strings:**
- `ENEMY_FLYSWARM_DESC`: "Performs a melee attack that hits once for each fly. <br/> Each time it's damaged it loses a fly."
...
**Localization Strings:**
- `ENEMY_BONEWORM_DESC`: "Ranged attacker. <br/> Gains more range the taller it becomes. <br/> Loses height when it takes damage. <br/> Can only take 1 damage at a time when tall. <br/> Undead."
...
**Localization Strings:**
- `ENEMY_CARCASS_DESC`: "Spawns random types of Maggots."
...
**Localization Strings:**
- `ENEMY_PEASHY_DESC`: "May attack its own allies. <br/> Blocks damage from the front. <br/> Becomes enraged when it kills something."
...
**Localization Strings:**
- `ENEMY_BABYDEATHWORM_DESC`: "Dash attacks units that end their movement in line with it. <br/> Can't dash backwards!"
...
**Localization Strings:**
- `ENEMY_DEATHWORM_DESC`: "Digs underground after its dash attack. <br/> Will eat any unit that ends movement on top of it while it's underground."
...
**Localization Strings:**
- `ENEMY_CULTISTLACKEY_NAME`: "Cultist Lackey"
- `ENEMY_CULTISTLACKEY_DESC`: "Melee attacker that throws units. <br/> Becomes a Zealot when it kills something."
- `ENEMY_CULTISTZEALOT_NAME`: "Cultist Zealot"
- `ENEMY_CULTISTZEALOT_DESC`: "Does a multi-stab attack. <br/> Gains +1 Damage at the end of its turn. <br/> Becomes suicidal when at low HP."
- `ENEMY_BOMBZEALOT_NAME`: "Cultist Zealot"
- `ENEMY_BOMBZEALOT_DESC`: "He's gonna blow!"
- `ENEMY_CULTISTMUTANT_NAME`: "Cultist Mutant"
- `ENEMY_CULTISTMUTANT_DESC`: "Does a wide melee attack that knocks units into the air. <br/> Spawns a Tumor when it dies. <br/> Brace 2."
- `ENEMY_CULTISTBISHOP_NAME`: "Cultist Bishop"
- `ENEMY_CULTISTBISHOP_DESC`: "Its lightning attack has a chance to Stun. <br/> Heals its allies. Spawns a Bishop Hat when killed."
- `ENEMY_CULTISTWASHER_NAME`: "Cultist Lackey"
- `ENEMY_CULTISTWASHER_DESC`: "He's here to cool down Johnny!"
...
Cultist {
    ...
    passives {
        FormChanger {
            ...
            Washer { //variant of cultist for johnny washer boss (washers will not become zealots?)
...
CultistMutant {
    ...
    passives {
        ...
        Brace 2 //if you change this number here you also have to change it on the ability BBTransformMutant (special_enemy_abilities.gon)
    }
}
```
...
CultistBishop {
    ...
    passives {
        ...
        DivineShield 2 //if you change these numbers here you also have to change it on the ability BBPickupCrown (special_enemy_abilities.gon)
        KineticSpikes 1
    }
}
```
...
**Localization Strings:**
- `ENEMY_BISHOPHAT_DESC`: "Attracts Cultists. <br/> Can be picked up by a Cultist to promote them into a Bishop."
...
**Localization Strings:**
- `ENEMY_LOVEBOT_DESC`: "Heals and gives +1 [img:spd] to its allies. Its heal can grant an extra turn if healed over max."
...
**Localization Strings:**
- `ENEMY_SECURITYBOT_DESC`: "When its allies are damaged, it will move towards the attacker and attempt to attack it. <br/> Gains +1 movement range at the end of its turn."
...
**Localization Strings:**
- `ENEMY_KILLDOZER_DESC`: "Moves towards what damages it. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_CARNIBULB_DESC`: "Will instantly kill anything it can reach. <br/> Has +1 movement range for each Sprout. <br/> Summons a Sprout at the end of its turn."
...
Carnibulb {
    ...
    passives {
        ...
        AddMovement -1 //this makes it so movement can be 0 on this enemy
...
**Localization Strings:**
- `ENEMY_SPROUT_DESC`: "Possesses adjacent units on its turn."
...
**Localization Strings:**
- `ENEMY_GEOLAD_DESC`: "Performs a jump attack that damages and knocks back all units in an area."
...
**Localization Strings:**
- `ENEMY_BRAMBLEBABY_DESC`: "Spawns Bramble tiles and pulls units into them."
...
**Localization Strings:**
- `ENEMY_HEMLOCK_DESC`: "Attacks units that move in range. <br/> Knocks back adjacent units when damaged. <br/> Heals allies."
...
**Localization Strings:**
- `ENEMY_NETTLE_DESC`: "Melee attacker. <br/> Each time one of its enemies casts a spell, this emits a Sparkle and gains +1 Thorns."
...
**Localization Strings:**
- `ENEMY_BIRTHWORT_DESC`: "Blind. Can melee attack and dash with Trample in random directions. <br/> Fires shots that inflict Rot whenever it's attacked. <br/> Heals itself and its neighbors at the end of its turn."
...
**Localization Strings:**
- `ENEMY_AMOEBA_DESC`: "Can attach itself to equipment slots on cats, and will break existing equipment if it does. <br/> Will attempt to find a rock to defend itself."
...
**Localization Strings:**
- `ENEMY_TREMBLO_DESC`: "Its melee attack inflicts Stun and spawns rocks. <br/> Can suck rocks towards itself and eat them to gain Brace and Shield."
...
**Localization Strings:**
- `ENEMY_CRATERCREEPER_DESC`: "Shoots rocks or dashes forward leaving an Amoeba behind. <br/> Can only be damaged from the front."
...
**Localization Strings:**
- `ENEMY_CRATERCREEPER2_DESC`: "Its ranged attack spawns an Amoeba."
...
**Localization Strings:**
- `ENEMY_COREFREAK_DESC`: "Can perform a flurry melee attack or a headbutt that inflicts Stun. <br/> Blind."
...
**Localization Strings:**
- `ENEMY_HOTPOKER_DESC`: "Has 2 melee attacks, one with Immobilize, the other with Burn that knocks a unit in the direction it's facing. <br/> Can give its allies extra turns. <br/> Immune to Fire."
...
**Localization Strings:**
- `ENEMY_WHISPERER_DESC`: "Its ranged attack inflicts Bruise and -2 [img:spd] to enemies, and Brace and +2 [img:spd] to allies. <br/> Its melee attack inflicts Charm."
...
**Localization Strings:**
- `ENEMY_CLOAKEDDEMON_DESC`: "Casts an area spell that inflicts Burn 3 to enemies and gives +1 Damage to allies. <br/> Inflicts Hex on units that damage it. <br/> Immune to Fire."
...
**Localization Strings:**
- `ENEMY_BRUTE_DESC`: "Throws rocks that have a chance inflict Stun when at range. <br/> Will uppercut units above 50% health. <br/> Will instantly kill units below 50% health. <br/> Immune to Fire."
...
**Localization Strings:**
- `ENEMY_MEGATUMOR_DESC`: "Trample. <br/> Gains +1 movement range at the end of its turns. <br/> Immune to Fire."
...
**Localization Strings:**
- `ENEMY_TUMORHEAD_DESC`: "Its melee attack knocks units back 3 tiles. <br/> Dashes forward when damaged."
...
**Localization Strings:**
- `ENEMY_TALLTUMOR_DESC`: "Drains unspent mana from its enemies when they end their turn. Deals damage equal to the mana drained. <br/> Counterattacks with a spin attack when damaged."
...
**Localization Strings:**
- `ENEMY_BIGASTEROID_DESC`: "Its attack spawns a boulder. <br/> Gets knocked back with Chain Knockback when hit. <br/> Can only recieve 1 damage at a time. <br/> Immune to status effects."
...
BigAsteroid {
    ...
    passives {
        SmallRockBehavior {
            damage 9
            knockback 2 //boosted to 3 via low grav
            chain true
        }
        LimitDamage 1
        LimitHeal 0
        StripStatuses 1
        //AsteroidKnockbackBounce 2
    }
...
**Localization Strings:**
- `ENEMY_SMALLASTEROID_DESC`: "Its attack shoots rocks at random tiles in an area. <br/> Gets knocked back with Chain Knockback when hit. <br/> Can only recieve 1 damage at a time. <br/> Immune to status effects."
...
SmallAsteroid {
    ...
    passives {
        SmallRockBehavior {
            damage 5
            knockback 5 //boosted to 6 via low grav
            chain true
        }
        LimitDamage 1
        LimitHeal 0
        StripStatuses 1
        //AsteroidKnockbackBounce 3
    }
...
**Localization Strings:**
- `ENEMY_SAUCIE_DESC`: "Fires energy shots in an X shape. <br/> Can inflict Marked on enemies or gain [img:divineshield]. <br/> Explodes when killed."
...
**Localization Strings:**
- `ENEMY_MEGASAUCER_DESC`: "Performs a random action on its turn. <br/> Has a dash attack that inflicts Stun. <br/> Has a charge up laser attack that instakills. <br/> Has the ability to summon B-Probers. <br/> Explodes when killed."
...
**Localization Strings:**
- `ENEMY_YBLASTER_DESC`: "Shoots at units that cross its path. <br/> Gains +1 Damage at the end of its turn. <br/> Moves away when in danger."
...
**Localization Strings:**
- `ENEMY_GALIEN_DESC`: "Its ranged attack has Knockback. <br/> Primes a Counterspell at the end of its turn. <br/> Is powered up when Counterspell is primed."
...
GreyAlien {
    ...
    ai {
        brain NoBrain //defined in FormChanger
        decision_weights default
        move_weights keep_distance
    }
}
...
**Localization Strings:**
- `ENEMY_BPROBER_DESC`: "Melee attacker. If it can melee attack a cat from behind it will inflict Charm. <br/> This Charm lasts until the Charmed cat takes damage."
...
**Localization Strings:**
- `ENEMY_WAGGLE_DESC`: "Melee attacker. <br/> Will turn enemy familiars and low health allies into Waggles!"
...
**Localization Strings:**
- `ENEMY_3X3WAGGLE_DESC`: "HOLY FUCKING SHIT"
...
**Localization Strings:**
- `ENEMY_HALFRAT_DESC`: "Does a chaining dash attack with a chance to spread diseases."
...
**Localization Strings:**
- `ENEMY_GAMETE_DESC`: "Spawns random units."
...
**Localization Strings:**
- `ENEMY_HALFDOG_DESC`: "Has a leap attack with Knockback. <br/> Leap attacks in the direction it's facing when damaged."
...
**Localization Strings:**
- `ENEMY_CATHUMAN_DESC`: "Spawns Kittens. <br/> Its melee attack inflicts injuries. <br/> Can howl to Immobilize units."
...
**Localization Strings:**
- `ENEMY_HUMANCAT_DESC`: "Melee attacker that Immobilizes. May dodge attacks unless attacked from the human side."
- `ENEMY_HUMANCAT2_DESC`: "Has a spin attack with Knockback."
...
**Localization Strings:**
- `ENEMY_COPBOT_DESC`: "Melee attacker. Will shoot at enemies who damage its allies."
...
**Localization Strings:**
- `ENEMY_DRDITTO_DESC`: "Fires explosive rockets that hit a random tile in an area. <br/> Will Fear units near it at the start of its turn. <br/> Its body revives at the end of the round."
...
**Localization Strings:**
- `ENEMY_MEGAMUTANT_DESC`: "Melee attacks adjacent units with Knockback 10 at the start of its turn. <br/> Performs a straight, long-range quake attack. <br/> Can grab and instakill units if it can reach them. <br/> Gains +99 Brace until its next turn when damaged."
...
**Localization Strings:**
- `ENEMY_CAVEMAN_DESC`: "Has a multi-hit melee attack. <br/> Hates Cats!"
- `ENEMY_CAVEBABY_NAME`: "Caveman Baby"
- `ENEMY_CAVEBABY_DESC`: "Has a melee attack with Lifesteal. Seeks food. Will grow up when it reaches full health."
- `ENEMY_CAVEMANMAN_NAME`: "Caveman Man"
- `ENEMY_CAVEMANMAN_DESC`: "Has a multi-hit melee attack. Will attempt to pick up spears. <br/> Hates Cats!"
- `ENEMY_SPEARCAVEMAN_NAME`: "Caveman Man"
- `ENEMY_SPEARCAVEMAN_DESC`: "Can throw its spear to inflict Stun. <br/> Hates Cats!"
- `ENEMY_CAVEMANWOMAN_NAME`: "Caveman Woman"
- `ENEMY_CAVEMANWOMAN_DESC`: "Will use cats as weapons. <br/> Pregnant!"
- `ENEMY_CAVEMANWOMAN2_NAME`: "Caveman Woman"
- `ENEMY_CAVEMANWOMAN2_DESC`: "Will use cats as weapons. <br/> Pregnant!"
- `ENEMY_WEREMAN_NAME`: "Wereman"
- `ENEMY_WEREMAN_DESC`: "Has a multi-hit melee attack. <br/> Will jump-attack units in range. <br/> Hates Cavemen!"
...
**Localization Strings:**
- `ENEMY_CAVEMANCHIEF_DESC`: "Its melee attack inflicts Stun. <br/> Goes for killing blows against enemies with 10 or fewer HP. <br/> Buffs its humanoid allies. <br/> Hates Cats!"
...
**Localization Strings:**
- `ENEMY_YETI_DESC`: "Has a triple-hit melee attack and a close-range Freeze attack."
...
**Localization Strings:**
- `ENEMY_FUZZER_DESC`: "Melee attacker that inflicts Confusion, then runs away. Units that contact this gain Confusion. <br/> Heals whenever an enemy damages itself with Confusion."
...
Fuzzer {
    ...
    passives {
        ...
        SmallRockBehavior 0 //max knockback when attacked
...
**Localization Strings:**
- `ENEMY_WOOLYMAMMOTH_DESC`: "Has a melee attack that knocks units into the air, and a dash attack. <br/> Will Bruise and Knockback adjacent units at the start of its turn. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_BUNGACHAMP_DESC`: "One of Lord Bunga's top guys!"
...
**Localization Strings:**
- `ENEMY_TREX_DESC`: "Will seek out the last unit that damaged it and attempt to eat it. <br/> Will stomp and inflict Immobile on adjacent units at the end of its turn. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_STEGOSAURUS_DESC`: "Does a spin attack at the start of its turn. <br/> Will seek grass to consume. <br/> Will counterattack units that attack it from behind. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_TRICERATOPS_DESC`: "Has a dash attack. <br/> Counterattacks units that damage it and flings them backwards. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_PTERODACTYL_DESC`: "Will pick up cats and peck them. <br/> Flying."
...
Pterodactyl {
    ...
    ai {
        brain NoBrain // brain set in form changer
        decision_weights default
        move_weights keep_distance
    }
}
...
**Localization Strings:**
- `ENEMY_PREHISTORICPOOTER_DESC`: "Its ranged attack inflicts Stun. <br/> Flying."
...
**Localization Strings:**
- `ENEMY_DINONEST_DESC`: "Spawns baby Raptors."
...
**Localization Strings:**
- `ENEMY_FATMAN_DESC`: "Melee attacker with Knockback. <br/> Reflects projectiles. Units that contact it get knocked back. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_SCHUTZBOT_DESC`: "Ranged attacker with limited ammo. <br/> Shoots at enemies that damage its allies. <br/> Expends the rest of its ammo and reloads at the end of its turn. <br/> Backflips one attack per turn."
...
**Localization Strings:**
- `ENEMY_HANGERBOT_DESC`: "Its melee attack inflicts Short Circuit. <br/> Retracts when damaged. <br/> Spawns Invaders."
...
**Localization Strings:**
- `ENEMY_DOKTORBOT_DESC`: "Heals its allies and gives them random buffs. <br/> Spawns Invaders. <br/> Collects Pickups."
...
**Localization Strings:**
- `ENEMY_KRUGHEAD_DESC`: "Melee attacker. Gives its allies extra turns. <br/> Immune to Magic and Debuffs."
...
**Localization Strings:**
- `ENEMY_FETUSJAR_DESC`: "Multi-hit melee attacker. Immune to Magic and Debuffs."
...
**Localization Strings:**
- `ENEMY_FETUSNOJAR_DESC`: "Multi-hit melee attacker. <br/> Calls an airstrike when at low health."
...
**Localization Strings:**
- `ENEMY_TVBOT_DESC`: "Its commands restrict the actions of its enemies."
...
**Localization Strings:**
- `ENEMY_TALLBOT_DESC`: "Its suplex attack can Stun or Immobilize. <br/> Primes Airstrikes."
...
**Localization Strings:**
- `ENEMY_HERALD_DESC`: "Melee attacker that summons shadows of itself."
...
**Localization Strings:**
- `ENEMY_HERALDSHADOW_DESC`: "Melee attacker. Dies when the original dies."
...
**Localization Strings:**
- `ENEMY_GASPER_DESC`: "Creates Poison clouds when it attacks or is damaged. <br/> Primes an explosion when killed."
...
**Localization Strings:**
- `ENEMY_FLOAST_DESC`: "Has a melee throw attack and a ranged hook attack."
...
**Localization Strings:**
- `ENEMY_GORGER_DESC`: "Its melee attack consumes what it hits. <br/> Runs all the way towards its next target at the end of its turn. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_SLAG_DESC`: "Does a ranged area attack. Spawns Edemas when damaged by a melee attack and Fly Swarms when damaged by a ranged attack."
...
**Localization Strings:**
- `ENEMY_HITLERCLONE_DESC`: "Has a multi-hit melee attack. Follows orders."
- `ENEMY_HITLERCLONE_NAME`: "Führerclone"
...
**Localization Strings:**
- `ENEMY_EDEMA_DESC`: "Evolves into a Husk when its timer reaches 0. <br/> Spawns Thorny tumors when killed."
...
**Localization Strings:**
- `ENEMY_HUSK_DESC`: "Has a multi-hit melee attack. Turns into an Edema when killed."
...
**Localization Strings:**
- `ENEMY_CONJOINEDHUSK_DESC`: "Its melee attack picks up cats. <br/> Creates evil copies of cats it's holding."
...
**Localization Strings:**
- `ENEMY_HERALDESS_DESC`: "Melee attacker. Becomes scary when damaged."
...
**Localization Strings:**
- `ENEMY_MEATSLIME_DESC`: "Splits into Clots on death."
...
**Localization Strings:**
- `ENEMY_THROBBINGTURRET_DESC`: "Ranged area attack that inflicts Bleed. Spawns Clots if nothing is in range."
...
**Localization Strings:**
- `ENEMY_THROBSERVANT_DESC`: "Ranged attacker that has a chance to destroy equipment and attach a parasite. Spawns Maggots."
...
**Localization Strings:**
- `ENEMY_FLESHLAD_DESC`: "Attacks as many times as it can, then uppercuts and inflicts Bruise. Gains an extra attack per turn each time it takes damage. <br/> Gains Speed at the end of its turn."
...
**Localization Strings:**
- `ENEMY_FLESHYMIND_DESC`: "Has a ranged attack that inflicts Muted. Inflicts Confusion on units that attack it."
...
**Localization Strings:**
- `ENEMY_BUTCHTINK_DESC`: "Moves 1 tile toward whatever damages them. <br/> Will dash on their last turn. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_TRACY_DESC`: "Performs a spin attack. <br/> Will try to counterattack with her left arm when hit."
...
**Localization Strings:**
- `ENEMY_DRBEANIES_DESC`: "Tosses bombs that explode at the end of the round."
...
**Localization Strings:**
- `ENEMY_FRANK_DESC`: "Will suck units in, then spit them out. <br/> Becomes Frank's Bean when killed."
...
**Localization Strings:**
- `ENEMY_CHERUBIUM_DESC`: "Gives its allies [img:divineshield]. <br/> Primes an area attack when damaged. <br/> Immune to Holy. Gains All Stats Up when struck with Holy Element."
...
**Localization Strings:**
- `ENEMY_SERAPHIM_DESC`: "Has a diagonal Holy attack. <br/> Can revive its downed allies. <br/> Units that contact or attack this get knocked back 5 tiles. <br/> Immune to Holy. Gains All Stats Up when struck with Holy Element."
...
**Localization Strings:**
- `ENEMY_ANGELICKITTEN_DESC`: "Attracts units. Dooms what kills it. <br/> Immune to Holy. Gains All Stats Up when struck with Holy Element."
...
**Localization Strings:**
- `ENEMY_GATEKEEPER_DESC`: "Goes after the cat with the lowest max health. <br/> Sucks the soul out of its target, instantly killing it and permanently lowering their [img:con] by 2. <br/> Summons Skeletons. <br/> Undead."
...
**Localization Strings:**
- `FAMILIAR_FLORIANTHEFLEA_DESC`: "Your flea friend till the end!"
...
**Localization Strings:**
- `FAMILIAR_FLY_STEEL_DESC`: "Invulnerable."
...
FeralZombieKitten {
    ...
    passives {
        // this doesn't really *need* to be there but it makes hostile zombies spawned by the necronomicon easier to identify as a threat
        PermanentMadness 1
    }
}
```
...
RoboVacuum2 {
    ...
    passives {
        SharePickupsWithSpawner 0 //turns off the effect of the base level roomba
        SharePickups {
            include_coins true
        }
    }
...
**Localization Strings:**
- `FAMILIAR_SLEEPDEMON_DESC`: "When killed, {SpawnedBy} wakes up."
...
CharmedFetus2 {
    ...
    properties {
        health 24 //2x health of standard fetus
    }
}
```
...
**Localization Strings:**
- `FAMILIAR_CATCOPYCLOT_DESC`: "Has a chance to become a {SpawnedBy} Clone at the end of its turn."
...
**Localization Strings:**
- `FAMILIAR_WHITERABBIT_DESC`: "Has a 50% chance of gaining Madness at the end of each turn."
...
**Localization Strings:**
- `FAMILIAR_FLESHLAD_DESC`: "Gains an extra attack per turn each time it takes damage. <br/> Gains Speed at the end of its turn."
...
**Localization Strings:**
- `FAMILIAR_PHANTOMMASK_DESC`: "Invulnerable. Attack it to knock it forward in a straight line. It deals 5 damage to units it hits."
...
**Localization Strings:**
- `ENEMY_THECREATOR_DESC`: "Nosce te Ipsum!"
...
**Localization Strings:**
- `ENEMY_DESTROYER_DESC`: "Memento Mori!"
- `ENEMY_DESTROYER2_DESC`: "Tenebris Aeternae!"
...
TheDestroyer {
    ...
    passives {
        ...
        FinalBossShieldHealth {
            state_health [
                0  //clean, after any hit becomes scuffed
                35 //scuffed, 35 health for cracked1
                35 //cracked1, 35 health for cracked2
                35 //cracked2, 35 health for cracked3
                35 //cracked3, 35 health for imminent break
                0  //imminent break, any hit to break
            ]
        ...
        FormChanger {
            SwordAndShield {
                ...
                ai {
                    ...
                    pattern {
                        ...
                        do_priority [**DestroyerThrowShield attack] //post holy
                    }
            ...
            SwordAndShield_Primed {
                ...
                ai { //this brain shouldnt ever actually make a decision, just here for redundancy
                    brain PatternBrain
                    pattern {
                        do move
                    }
...
**Localization Strings:**
- `ENEMY_THECHILD_DESC`: "Respice Finem!"
...
TheChild {
    ...
    passives {
        ...
        //ChangeTileOnDeath WaterTile //todo: tie to an animation trigger
...
**Localization Strings:**
- `ENEMY_TINA2HEAD_DESC`: "It may be separated from her body, but they are still working together."
...
**Localization Strings:**
- `ENEMY_TINA2BODY_DESC`: "It may be separated from her head, but they are still working together."
...
**Localization Strings:**
- `ENEMY_TINA1_DESC`: "She lusts with a never ending hunger!"
...
**Localization Strings:**
- `ENEMY_TINA3BODY_DESC`: "It's trying to find it's head..."
...
**Localization Strings:**
- `ENEMY_TINA3HEAD_DESC`: "Sorry I'm dead..."
...
Guillotina3Head {
    ...
    passives {
        ...
        //ImmediateAbilityReaction G3CoughFly
        AbilityReaction {
...
**Localization Strings:**
- `OBJECT_ICECUBE_DESC`: "Slides when attacked."
...
**Localization Strings:**
- `OBJECT_RATBOMB_DESC`: "Explodes on its turn or when hit with fire. <br/> Attack to disarm!"
...
**Localization Strings:**
- `OBJECT_TRASHBAG_DESC`: "Spawns random Pickups when damaged."
...
**Localization Strings:**
- `OBJECT_DUMPSTER_DESC`: "Spawns random Pickups when damaged."
...
Dumpster_interactive {
    ...
    passives {
        SpawnThingOnDamage {
            ...
            coins 1
            chance .25
            good true //good relative to the thing attacking, for luck calculations
        }
        SpawnThingOnDamage {
            object Food
            chance .25
...
**Localization Strings:**
- `OBJECT_SMALLROCK_DESC`: "Attack it to knock it forward in a straight line. It deals 5 damage to units it hits."
- `OBJECT_HOTROCK_NAME`: "Hot Rock"
...
**Localization Strings:**
- `OBJECT_PETROCK_DESC`: "Attack it to knock it forward in a straight line. It deals 5 damage to units it hits."
- `OBJECT_HOTPETROCK_NAME`: "Hot Pet Rock <3"
...
**Localization Strings:**
- `OBJECT_BOULDER_DESC`: "Attack it to push it 1 tile. It deals 9 damage to units it hits."
- `OBJECT_HOTBOULDER_NAME`: "Hot Boulder"
...
**Localization Strings:**
- `OBJECT_PETBOULDER_DESC`: "Attack it to push it 1 tile. It deals 9 damage to units it hits."
- `OBJECT_HOTPETBOULDER_NAME`: "Hot Pet Boulder <3"
...
**Localization Strings:**
- `OBJECT_TIRE_DESC`: "Knocks back all adjacent units when this takes damage."
- `OBJECT_TIREUP_DESC`: "Attack it to send it rolling."
...
**Localization Strings:**
- `OBJECT_CRATE_DESC`: "What could be inside?"
...
**Localization Strings:**
- `OBJECT_D6_DESC`: "Attack to re-roll."
...
**Localization Strings:**
- `OBJECT_PHYLACTERY_DESC`: "When its owner dies, this breaks and revives them."
...
**Localization Strings:**
- `OBJECT_BLOATEDCORPSE_DESC`: "Explodes into Maggots when destroyed."
...
**Localization Strings:**
- `OBJECT_TNT_DESC`: "Explodes when destroyed."
...
**Localization Strings:**
- `OBJECT_HARPOONTRAP_DESC`: "Harpoons units that end movement in front of it."
...
**Localization Strings:**
- `OBJECT_ELECTRICNAIL_DESC`: "It arcs electricity to neighboring tiles whenever any unit spends mana."
...
**Localization Strings:**
- `OBJECT_RUBBERFISTBOT_DESC`: "It punches anything that gets near it."
...
**Localization Strings:**
- `OBJECT_GHOSTTOMBSTONE_DESC`: "Could something be inside?"
...
**Localization Strings:**
- `OBJECT_TOMBSTONE_DESC`: "Summons a Zombie Cat at the end of each round."
...
**Localization Strings:**
- `OBJECT_DRAINTOMBSTONE_DESC`: "Drains mana from units when they end their turn."
...
**Localization Strings:**
- `OBJECT_TWISTER_DESC`: "Moves towards its enemies. Tosses what it touches."
...
**Localization Strings:**
- `OBJECT_NTWISTER_DESC`: "Moves randomly. Tosses what it touches."
...
**Localization Strings:**
- `OBJECT_MININUKE_DESC`: "Explodes when destroyed."
...
**Localization Strings:**
- `OBJECT_NEUTRONSTAR_DESC`: "May go supernova..."
- `OBJECT_BLACKHOLE_NAME`: "Black Hole"
- `OBJECT_BLACKHOLE_DESC`: "Pulls units towards it. Destroys anything that touches it."
...
**Localization Strings:**
- `OBJECT_HELLHAND_DESC`: "Grapples its enemies if they walk past it."
...
**Localization Strings:**
- `OBJECT_CLONINGVAT_DESC`: "Something is moving inside..."
...
**Localization Strings:**
- `OBJECT_GROUNDEDSPEAR_DESC`: "Attack to send it flying."
...
**Localization Strings:**
- `OBJECT_SUPPORTPILLAR_DESC`: "When destroyed will drop random things down around it."
...
**Localization Strings:**
- `OBJECT_SPEWERPILL_DESC`: "Heals and changes the form of Spewer when eaten."
...
**Localization Strings:**
- `OBJECT_SPEWERTUBE_DESC`: "Spawns pills for Spewer."
...
**Localization Strings:**
- `OBJECT_MINIVOLCANO_DESC`: "Spawns lava rocks when attacked."
...
**Localization Strings:**
- `OBJECT_GASCLOUD_DESC`: "Poisons units that walk through it."
...
**Localization Strings:**
- `OBJECT_GRENADE_DESC`: "Explodes on its turn or if it's destroyed. Explosion shreds 5 stacks of random buffs off of whatever it hits."
...
**Localization Strings:**
- `OBJECT_SLOTMACHINE_DESC`: "Attack to play! Explodes when destroyed."
...
**Localization Strings:**
- `OBJECT_BLOATEYE_DESC`: "Moves 1 tile towards units each time they take an action. Trample."
...
**Localization Strings:**
- `ENEMY_PYROPHINASOLO_DESC`: "Pyrophina was baptized in the fires of hell and survived!"
...
**Localization Strings:**
- `ENEMY_ZARATANASOLO_DESC`: "Zaratana's body radiates with galactic energy!"
...
Zaratana {
    ...
    ai {
        // brain DbgPlayerBrain
        brain PatternBrain

        bonusturn_pattern {
            do_priority [*ZaratanaSoloWeatherRoar ZaratanaSoloBombardment]
            do_priority [*ZaratanaSoloWeatherRoar attack]
            do_priority [*ZaratanaSoloWeatherRoar ZaratanaSoloMagnet ZaratanaSoloBombardment] //if no rocks, do bombardment again
...
**Localization Strings:**
- `ENEMY_PYROPHINAVS_DESC`: "She wants to kill Zaratana!"
...
**Localization Strings:**
- `ENEMY_ZARATANAVS_DESC`: "She wants to kill Pyrophina!"
...
**Localization Strings:**
- `ENEMY_KAIJUFRIENDLY_DESC`: "Shes here to help, and trying her best!"
...
PyrophinaFamiliar {
    ...
    passives {
        ...
        ChanceToDisableActionsIfNotCharmed 75% //25% chance of actually attacking on any given turn, unless charmed/posessed/madness/etc
    }
...
**Localization Strings:**
- `ENEMY_CANCREEPER_DESC`: "Shoots diagonally or dashes forward leaving a Fly behind. <br/> Can only be damaged from the front. <br/> Spawns creep."
...
**Localization Strings:**
- `ENEMY_CANCREEPEROUT_DESC`: "Ranged attacker. <br/> Must be in creep to attack."
...
**Localization Strings:**
- `ENEMY_BIGSLIME_DESC`: "Melee attacker. <br/> Splits into 4 medium Slimes on death."
...
**Localization Strings:**
- `ENEMY_MEDIUMSLIME_DESC`: "Melee attacker. <br/> Splits into 4 small Slimes on death."
...
**Localization Strings:**
- `ENEMY_SMALLSLIME_DESC`: "Melee attacker."
...
**Localization Strings:**
- `ENEMY_GAMBIT_DESC`: "Has 6 special moves tied to the number on its dice! Higher numbers are more deadly."
...
Gambit {
    ...
    abilities {
        ...
        spells [
            DiceLeap
            RollDice
            D6Fizzle //if a dice somehow doesnt exist
            D6Confused //1
            D6Poop //2
            D6Laser //3
            D6Quake //4
    ...
    passives {
        ...
        //gambit palettes
        //0: 59  1: 52  2: 65  3: 50  4: 54  5: 63  6:64
    }
    
    ai { //Hi modders! this was an extremely early prototyped boss so he has a unique brain before I figured out how to pack almost any behavior into PatternBrain instead. lol
        brain DicerBrain
...
**Localization Strings:**
- `ENEMY_FLUSHMASTER_DESC`: "Pushes all units back 10 tiles in the direction its facing."
...
**Localization Strings:**
- `ENEMY_MAMAMAGGOT_DESC`: "Spawns Maggots, evolves them and gives them bonus turns. <br/> Trample."
...
**Localization Strings:**
- `ENEMY_LENNY_DESC`: "Loves kitties! Especially {buddyname}!"
...
**Localization Strings:**
- `ENEMY_ZODIAC_DESC`: "Will shoot at anything that moves! <br/> Limited ammo."
...
**Localization Strings:**
- `ENEMY_CERBERUBS_DESC`: "Shoots Lava from its necks when damaged. <br/> Becomes enraged when hit from behind. <br/> Immune to Fire."
...
Cerberubs {
    ...
    ai {
        brain NoBrain // handled in form changer
    }
}
```
...
**Localization Strings:**
- `ENEMY_ASTROZOMBIE_DESC`: "Its melee attacks inflict random injuries."
...
**Localization Strings:**
- `ENEMY_ASTROZOMBIEHEAD_DESC`: "Its melee attack inflicts Burn. <br/> Its scream will inflict Fear."
...
**Localization Strings:**
- `ENEMY_SPEWER_DESC`: "Will eat pills that heal him and change his form. Spits different kinds of liquids depending on his form."
...
**Localization Strings:**
- `ENEMY_FROSTBITER_DESC`: "Slows and knocks back units. <br/> Freezes adjacent units."
...
**Localization Strings:**
- `ENEMY_RATKING_DESC`: "Spawns Lil' Rats and throws adjacent units."
...
**Localization Strings:**
- `ENEMY_DINOLOVER_DESC`: "Melee attacker. Defends its partner."
...
**Localization Strings:**
- `ENEMY_BLOAT_DESC`: "Does a blood blast when units walk past its sides. <br/> Spawns Eyeballs."
...
**Localization Strings:**
- `ENEMY_ZAPPHAUSER_DESC`: "Primes an attack when damaged. <br/> Attacks all tiles of the same parity as his own."
...
LightningElemental {
    ...
    properties {
        ...
        /*elements [ //innate electric is weird
            Electric
        ]*/
...
**Localization Strings:**
- `ENEMY_DRMANGLER_DESC`: "Controls the Monster."
...
**Localization Strings:**
- `ENEMY_MANGLERMONSTER_DESC`: "Controlled by the Doctor."
...
**Localization Strings:**
- `ENEMY_GLOWINGBEAR_DESC`: "It glows with an eternal light."
...
**Localization Strings:**
- `ENEMY_DEATH_DESC`: "He's here to take what he's owed."
...
## File: `non_interactive_objects.gon`
...
**Localization Strings:**
- `PICKUP_COIN_DESC`: "Collect it to get money!"
...
**Localization Strings:**
- `PICKUP_FOOD_DESC`: "Heals 4 HP when eaten."
...
**Localization Strings:**
- `PICKUP_MEDIUMFOOD_DESC`: "Heals 7 HP when eaten."
...
**Localization Strings:**
- `PICKUP_BIGFOOD_DESC`: "Heals 10 HP when eaten."
...
**Localization Strings:**
- `PICKUP_POISONEDFOOD_DESC`: "Gain Poison 2 and Slow 2 if eaten."
...
**Localization Strings:**
- `PICKUP_BAIT_DESC`: "Attracts enemies toward it. <br/> Heals 1 HP when eaten."
...
**Localization Strings:**
- `PICKUP_POISONBAIT_DESC`: "Attracts enemies toward it. <br/> Gain Poison 2 and Slow 2 if eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDFOOD_DESC`: "Heals 4 HP and +1 [img:str] when eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDMEDIUMFOOD_DESC`: "Heals 7 HP and +1 [img:str] when eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDBIGFOOD_DESC`: "Heals 10 HP and +1 [img:str] when eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDPOISONEDFOOD_DESC`: "Gain Poison 2, Slow 2 and +1 [img:str] if eaten."
...
**Localization Strings:**
- `PICKUP_PURIFIEDFOOD_DESC`: "Heals 4 HP when eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDPURIFIEDFOOD_DESC`: "Heals 4 HP and +1 [img:str] when eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDBAIT_DESC`: "Attracts enemies toward it. <br/> Heals 1 HP and +1 [img:str] when eaten."
...
**Localization Strings:**
- `PICKUP_COOKEDPOISONEDBAIT_DESC`: "Attracts enemy units toward it. <br/> Gain Poison 2, Slow 2 and +1 [img:str] if eaten."
...
**Localization Strings:**
- `PICKUP_SCRAP_DESC`: "Gain +2 [img:shield] when collected."
...
**Localization Strings:**
- `PICKUP_MEDIUMSCRAP_DESC`: "Gain +4 [img:shield] when collected."
...
**Localization Strings:**
- `PICKUP_BIGSCRAP_DESC`: "Gain +6 [img:shield] when collected."
...
**Localization Strings:**
- `PICKUP_BLESSING_DESC`: "Gain +1 [img:divineshield] when collected."
...
**Localization Strings:**
- `PICKUP_ANTIDOTE_DESC`: "Cleanse all debuffs when eaten."
...
**Localization Strings:**
- `PICKUP_CATNIP_DESC`: "Gain +2 mana when eaten."
...
**Localization Strings:**
- `PICKUP_MEDIUMCATNIP_DESC`: "Gain +4 mana when eaten."
...
**Localization Strings:**
- `PICKUP_BIGCATNIP_DESC`: "Gain +6 mana when eaten."
...
PlayerCat {
    ...
    properties {
        ...
        //the following properties are added to whatever value they get from stats (defaults shown here)
        base_movement 4
        base_initiative 0
        base_health 0
        base_mana 0
        ...
        //how much HP needed for this character to switch to weak idle animation
        weak_threshold 5 

        can_be_overkilled false //player cats will not instapop on extreme damage kills
        can_collect_coins true
        can_eat_food true
        access_to_player_inventory true
        corpse_health 3
...
**Localization Strings:**
- `ENEMY_BIGSTEVENSLIME_DESC`: "Melee attacker. <br/> Splits into 4 medium Stevens on death."
...
**Localization Strings:**
- `ENEMY_MIDSTEVENSLIME_DESC`: "Melee attacker. <br/> Splits into 4 small Stevens on death."
...
**Localization Strings:**
- `ENEMY_SMALLSTEVENSLIME_DESC`: "Melee attacker. <br/> Becomes a glitch tile on death."
...
**Localization Strings:**
- `ENEMY_CHAOS_DESC`: "Stropelet eh emit hcae egnahc seitiliba sih."
...
Chaos {
    ...
    passives {
        ...
        ChaosBossFormChangeGuide {
            ...
            passives_health_threshold 50% //at 50% hp will start doing passives
            //will also start doing passives once each active has been done once
...
**Localization Strings:**
- `FAMILIAR_RIFTKITTEN_DESC`: "Thank you for releasing me!"

```
RiftKitten { //TODO: do this in a way that lets his one ability get scrambled by glitch tiles
    graphics {
        movieclip _CAT
...
**Localization Strings:**
- `ENEMY_FLY_DESC`: "Melee attacker. <br/> Flying."
...
**Localization Strings:**
- `ENEMY_MAGGOT_DESC`: "Melee attacker."
...
**Localization Strings:**
- `ENEMY_FLEA_DESC`: "Its melee attack damages itself."
...
**Localization Strings:**
- `ENEMY_PINKY_DESC`: "Melee attacker. <br/> Moves randomly."
...
**Localization Strings:**
- `ENEMY_RATTLESNEK_DESC`: "Ambushes enemies who walk past it. <br/> Its attacks inflict Poison."
...
**Localization Strings:**
- `ENEMY_SPIDERLING_DESC`: "Burrows inside its victims, inflicting Infested."
...
**Localization Strings:**
- `ENEMY_WISP_DESC`: "Its melee attack inflicts Burn. <br/> Dodges one attack per turn."
...
**Localization Strings:**
- `ENEMY_MOONWORM_DESC`: "Lobs shots at all of its enemies within range. <br/> Gains +1 Brace when damaged."
...
**Localization Strings:**
- `ENEMY_INVADER_DESC`: "Melee attacker that inflicts Poison."
...
**Localization Strings:**
- `ENEMY_TINYTUMOR_DESC`: "Its melee attack causes cats it hits to lose 1 [img:con] permanently and has a chance to give them cancer."
...
**Localization Strings:**
- `ENEMY_CLOT_DESC`: "Has a chance to become a Stem Cat at the end of its turn."
...
**Localization Strings:**
- `ENEMY_LOUSE_DESC`: "Its melee attacks inflict Bruise."
...
**Localization Strings:**
- `ENEMY_TERMINATOR1_DESC`: "Primary objective: Destroy all cats."
...
**Localization Strings:**
- `ENEMY_TERMINATOR2_DESC`: "Primary objective: Destroy all cats, again!"
...
Terminator2 {
    ...
    abilities {
        ...
        spells [
            DoNothing //first 5 get replaced with cat spells when it copies a cat
            DoNothing
            DoNothing
            DoNothing
            DoNothing
...
**Localization Strings:**
- `ENEMY_TERMINATOR3_TANK_DESC`: "Protects her allies when they are attacked."
...
**Localization Strings:**
- `ENEMY_TERMINATOR3_HUNTER_DESC`: "Tosses bear traps! <br/> Has an affinity for tall grass. <br/> Swats away melee attackes."
...
NecroCat_Terminator {
    ...
    properties {
        ...
        shield 25
        corpse_health 0
        dispersed_bonus_turns 0 //has a round end bonus turn
    }
    passives {
        Robot 1
        SpawnOnDeath Antidote
...
**Localization Strings:**
- `ENEMY_TERMINATOR3_HITLER_DESC`: "Ich bin hier, um diese Katzen zu töten und die Kontrolle über diese wertlose Dimension zu übernehmen! Unter Hitlers Herrschaft werden alle Katzen sterben!!"
- `ENEMY_TERMINATOR3_HITLERHEAD_DESC`: "SMASH THAT HEAD!!!"
            ...
            SpawningPhase {
                ...
                passives {
                    ...
                    T3HitlerSpawningPhase {
                        spell_use_groups [
                            [
                                T3Spawn_Monk T3Spawn_Monk T3Spawn_Monk T3Spawn_Monk //putting the monk here a bunch should make him show up early in the pattern, on average
...
**Localization Strings:**
- `ENEMY_THROBBINGKING_DESC`: "Follow his orders! OR ELSE!"
...
**Localization Strings:**
- `ENEMY_THROBBINGKING2_DESC`: "Oh no, now hes agile!"
...
```
EventBountyHunter { //copied from GunCat
    graphics {
        movieclip _CAT
    ...
    properties {
        ...
        type cat
        health 17
        faction birds //enemies will not bother, but cats will (lol)
        base_mana_regen 999
        movement 2
        kill_required false
...
**Localization Strings:**
- `ENEMY_DEADPINKY_DESC`: "This poor little guy didn't stand a chance!"

```
DeadPinky { //Used for Nest of mice event
    variant_of Pinky
    graphics {
...
```
FastFetus { //used for Grating in the floor event
    variant_of Fetus
...
```
FastRat { //used for Grating in the floor event
    variant_of Rat
...
**Localization Strings:**
- `ENEMY_STRANGEEGG_DESC`: "What could it hatch into?"
...
AlienEgg {
    ...
    passives {
        TransformInXTurns {
            turns [1 4]
            object [
                YellowBlaster GreyAlien GreenProber //moon aliens
                Amoeba MoonWorm Waggle //alien creatures
                KirbyFetus BrainDrain Fetus FetusGusher //alien fetuses
            ]
            animation hatch
        }
    }
