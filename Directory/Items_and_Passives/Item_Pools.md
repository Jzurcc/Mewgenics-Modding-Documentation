# Items and Passives/Item Pools Directory

## File: `ability_specific_pools.gon`

### `tinkerer_0`
**Source:** `ability_specific_pools.gon`  
...
```
pelts [ //used for hunter CollectPelt
    CatHideHat
    CatHideMask
    CatHideArmor
]
...
## File: `event_specific_pools.gon`

### `rat_trinkets`
**Source:** `event_specific_pools.gon`  
...
```
unique [ //TODO: this will be populated with other stuff later (this is currently referenced in 1 treasure box event)
    Shotgun
    Revolver
    Sniper
	22Rifle
...
```
cursed_barbed_wire_items [
    //BarbedPaw //This is the most thematic item but it is not cursed.
    FaceShards
    PawShards
    Splinters
]
...
```
weapons [ //this is referenced in EXACTLY 1 EVENT, and EXACTLY 1 FIGHTER PASSIVE. those should just pull from a chapter pool instead
    GlassShard
    RailSpikes
    NailBoard
    LilSlugger
