...
| [`preferred_distance`](../Reference_and_Meta/Enums.md#enum-preferred_distance) | Enum / Integer  | The ideal distance to maintain from a target, expressed either as an absolute tile count or relative to movement (e.g., `mov+2`) or reach (`mov+reach`). | 55 | `0`<br>`1`<br>`2` |
...
| [`pattern`](../Reference_and_Meta/Miscellaneous.md#object-pattern) | Object  | Defines a sequence of actions the AI will execute in order, with optional priority or all-in-one. | 296 | `{ . . . }` |
...
| `face_camera` | Integer | If true, the spawned unit always faces the camera. | 3 | `1000`<br>`true` |
| `lava` | Integer | A weight or priority value for preferring lava tiles in AI movement decisions. | 3 | `5` |
| `tall_grass` | Integer | A weight or priority value for preferring tall grass tiles in AI movement decisions. | 2 | `5` |
...
| [`alt_animations`](../Reference_and_Meta/Arrays.md#array-alt_animations) | Array | An array of alternative animation state replacements, each as [state, animation_name]. | 56 | `[`<br>`[[idle girlyIdle]]` |
| [`spawnin_animation`](../Reference_and_Meta/Enums.md#enum-spawnin_animation) | Enum  | Specifies the animation played when the unit spawns in. | 38 | `"digUp"`<br>`"howl"`<br>`beamin` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`{Damaging Keys}`](../Engine_Scripts_and_Logic/Engine_DamagingKeys.md#valid-property-keys) | Variable | Parent object containing damage-related subkeys for revenge or retaliatory effects. | 1731 | `damage_instance`<br>`spell`<br>`false` |
...
| [`Buddy`](./Passives_and_Statuses.md#object-buddy) | Enum / Object  | Specifies a buddy unit that accompanies or is spawned alongside the unit, with optional reclaim and targeting properties. | 24 | `{ . . . }`<br>`BoyDino`<br>`CaveCatDad`<br>`Chubs` |
...
| [`AbilityHealthThreshold`](./Passives_and_Statuses.md#object-abilityhealththreshold) | Object  | Defines an ability and conditions for its activation when the unit's health reaches a threshold. | 13 | `{ . . . }` |
...
| [`StatusOnDie`](./Passives_and_Statuses.md#object-statusondie) | Object  | Specifies status effects or actions triggered when the unit dies. | 9 | `{ . . . }` |
...
| [`TransformInXTurns`](./Passives_and_Statuses.md#object-transforminxturns) | Object  | Defines a delayed transformation after a set number of turns, with optional target object and initiative handling. | 11 | `{ . . . }` |
...
| [`AutocastEachRound`](./Passives_and_Statuses.md#object-autocasteachround) | Enum / Object  | Contains an ability name and optional 'even_if_stunned' flag to autocast each round. | 10 | `{ . . . }`<br>`SpiderReturn` |
...
| [`Bird`](../Reference_and_Meta/Enums.md#enum-bird) | Enum  | The object dropped by this bird unit upon death. | 11 | `CookedChickenLeg` |
...
| [`Trapper`](./Passives_and_Statuses.md#object-trapper) | Object  | Specifies a trap-placing ability and its targeting parameters. | 5 | `{ . . . }` |
...
| [`ArmorPickup`](./Passives_and_Statuses.md#object-armorpickup) | Object  | The amount of armor stacks and the frame range for the pickup animation. | 7 | `{ . . . }` |
...
| [`ManaPickup`](./Passives_and_Statuses.md#object-manapickup) | Object  | The amount of mana stacks and the frame range for the pickup animation. | 6 | `{ . . . }` |
...
| [`BungaEntrance`](./Passives_and_Statuses.md#object-bungaentrance) | Object  | Specifies the entrance animation, ability, and conditions for this unit's dramatic battle entrance. | 5 | `{ . . . }` |
...
| [`AlienBeastDangerZones`](../Reference_and_Meta/Arrays.md#array-alienbeastdangerzones) | Array  | An array of ability names that mark dangerous zones for the Alien Beast fight. | 1 | [AlienBeastPuke] |
...
| [`CatPartsTransform`](./Passives_and_Statuses.md#object-catpartstransform) | Object  | Transforms the target's visual cat parts (e.g., head, body, tail) using specified part IDs. | 55 | `{ . . . }` |
...
| [`FinalBossHitCountdownBoris`](./Passives_and_Statuses.md#object-finalbosshitcountdownboris) | Object  | An object defining the countdown status effect properties for the Boris phase, including stacks, icons, and forced abilities. | 3 | `{ . . . }` |
| [`FinalBossHitCountdownExplosive`](./Passives_and_Statuses.md#object-finalbosshitcountdownexplosive) | Object  | An object defining the countdown status effect properties for the Explosive phase, including stacks, icons, and forced abilities. | 2 | `{ . . . }` |
| [`FinalBossHitCountdownHoly`](./Passives_and_Statuses.md#object-finalbosshitcountdownholy) | Object  | An object defining the countdown status effect properties for the Holy phase, including stacks and icons. | 2 | `{ . . . }` |
...
| [`TinkererBasicAttackSwitching`](./Passives_and_Statuses.md#object-tinkererbasicattackswitching) | Object  | Defines the abilities used for the Tinkerer's basic attack switching mechanic. | 3 | `{ . . . }` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`{Damaging Keys}`](../Engine_Scripts_and_Logic/Engine_DamagingKeys.md#valid-property-keys) | Variable | Parent object containing damage-related subkeys for revenge or retaliatory effects. | 534 | `damage_instance`<br>`spell`<br>`false` |
...
| [`type`](../Reference_and_Meta/Enums.md#enum-type) | Enum | Specifies the damage type classification (e.g., melee, spell_cost, enter) used for interactions with mods, statuses, and passives. | 836 | `[attack move spell]`<br>`attack`<br>`battle` |`damage_instance`<br>`spell`<br>`self_damage`
| `movement` | Integer | The movement range of the unit in tiles per turn. | 304 | `0`<br>`1`<br>`2` |
...
| `dispersed_bonus_turns` | Integer | The number of bonus turns granted to this unit when its turn order is dispersed. | 123 | `0`<br>`1`<br>`2` |
...
| [`move_block`](../Reference_and_Meta/Enums.md#enum-move_block) | Enum | Determines which movement directions are blocked. | 73 | `everything_even_when_dead`<br>`nothing` |
...
| `takes_turns` | Boolean | If true, the unit participates in the turn order. | 84 | `false`<br>`true` |
...
| [`banned_elite_buffs`](../Reference_and_Meta/Arrays.md#array-banned_elite_buffs) | Array | A list of elite buff types that cannot be applied to this unit. | 45 | `[Depressing]`<br>`[Mad Twin]`<br>`[Mad]` |
| [`hidden_tag`](../Reference_and_Meta/Arrays.md#array-hidden_tag) | Array / Enum | A tag used for internal categorization, not shown to the player. | 38 | `[bird bonusbird]`<br>`[megadino megadinoleg]`<br>`[moonhand moonboss]` |
...
| [`lock_orientation`](../Reference_and_Meta/Arrays.md#array-lock_orientation) | Array | Forces the unit's facing direction to a fixed vector. | 19 | `[-1 0]`<br>`[-1, 0]`<br>`[0 -1]` |
| `ai_scale` | Float | A multiplier for the unit's AI decision-making weight. | 18 | `.01`<br>`.25`<br>`.5` |
| `layer` | `String` | Specifies the layer on which the ability's effect operates (e.g., characters, tiles, gas). | 61 | `2`<br>`all`<br>`characters` |
| [`auto_run_priority`](../Reference_and_Meta/Enums.md#enum-auto_run_priority) | Enum | Determines the unit's auto-run behavior priority. | 16 | `default`<br>`stationary`<br>`support` |
...
| [`hidden_tags`](../Reference_and_Meta/Arrays.md#array-hidden_tags) | Array / Enum | A list of hidden tags for internal grouping and behavior. | 14 | `[terminator_mini dc_cat]`<br>`terminator_mini` |
...
| `evenly_dispersed_bonus_turns` | Integer | The number of bonus turns spread evenly across the turn order for this unit. | 24 | `1`<br>`2`<br>`3` |
| `initiative_adjustment` | Integer | Adjusts the unit's base initiative. | 4 | `5` |
| `exclude_from_hallucinate` | Boolean | If true, the unit is not included in hallucination effects. | 13 | `true` |
| `round_end_bonus_turns` | Integer | The number of bonus turns granted at the end of each round. | 24 | `1` |
...
| [`held_coins`](../Reference_and_Meta/Arrays.md#array-held_coins) | Array / Integer | The number of coins the unit holds; can be a range [min max]. | 10 | `0`<br>`5`<br>`[0 1]` |
...
| `act_points` | Integer | The number of action points required to use the ability. | 91 | `0`<br>`1`<br>`2` |
| `takes_main_turn` | Boolean | If true, the unit consumes the main turn phase of the round. | 16 | `false`<br>`true` |
...
| `round_start_bonus_turns` | Integer | The number of extra turns the unit gains at the start of each round. | 5 | `1` |
| `view_bleeding_characters_as_enemies` | Boolean | If true, the unit treats any bleeding character as an enemy. | 4 | `true` |
| [`aoe_pierce_mode`](../Reference_and_Meta/Enums.md#enum-aoe_pierce_mode) | Enum | Specifies the area-of-effect piercing behavior for projectiles. | 3 | `block` |
...
| [`disallow_items`](../Reference_and_Meta/Enums.md#enum-disallow_items) | Enum | Determines which items the unit is prohibited from using. | 3 | `Nuke`<br>`all` |
...
| `move_points` | Integer | The number of move points required to use the ability. | 60 | `0`<br>`1`<br>`2` |
...
| [`inanimate_can_receive_specific_statuses`](../Reference_and_Meta/Arrays.md#array-inanimate_can_receive_specific_statuses) | Array | A list of statuses that an inanimate unit can receive. | 1 | `[Burn]` |
...
| [`move_weights`](../Reference_and_Meta/Enums.md#enum-move_weights) | Enum | Determines the movement strategy used by the AI when executing this move ability. | 554 | `bird`<br>`blind_move_far`<br>`chaos_always_move` |
| [`pattern`](../Reference_and_Meta/Miscellaneous.md#object-pattern) | Object  | Defines a sequence of actions the AI will execute in order, with optional priority or all-in-one. | 296 | `{ . . . }` |
| [`mainturn_pattern`](../Reference_and_Meta/Miscellaneous.md#object-mainturn_pattern) | Object  | Specifies the AI behavior pattern used during main turns. | 44 | `{ . . . }` |
| `end_turn_on_formswitch` | Boolean | If true, the unit's turn ends immediately after switching forms. | 41 | `false`<br>`true` |
| [`virtual_abilities`](../Reference_and_Meta/Miscellaneous.md#object-virtual_abilities) | Object  | Defines virtual abilities and their movement weights for AI decision-making. | 35 | `{ . . . }` |
...
| [`bonusturn_pattern`](../Reference_and_Meta/Miscellaneous.md#object-bonusturn_pattern) | Object  | The action sequence the AI follows during a bonus turn. | 27 | `{ . . . }` |
| [`fallback`](../Reference_and_Meta/Miscellaneous.md#object-fallback) | Object  | The action sequence the AI uses when its main pattern cannot execute. | 23 | `{ . . . }` |
| [`round_end_bonusturn_pattern`](../Reference_and_Meta/Miscellaneous.md#object-round_end_bonusturn_pattern) | Object  | The action sequence the AI executes at the end of the round as a bonus turn. | 12 | `{ . . . }` |
| `consider_spells` | Boolean | If true, the AI considers using spells in its decision-making. | 12 | `false` |
...
| [`dispersed_bonusturn_pattern`](../Reference_and_Meta/Miscellaneous.md#object-dispersed_bonusturn_pattern) | Object  | The action sequence used when bonus turns are evenly distributed among multiple units. | 2 | `{ . . . }` |
...
| [`post_absorb_move_weights`](../Reference_and_Meta/Enums.md#enum-post_absorb_move_weights) | Enum | Specifies the movement weight set used after the AI absorbs a target. | 1 | `minimum_move` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`do`](../Reference_and_Meta/Enums.md#enum-do) | Enum | The single, specific ability the AI executes. | 190 | `**BombRatTurtle`<br>`**G3Shake`<br>`**RockySlam` |
| [`do_all`](../Reference_and_Meta/Arrays.md#array-do_all) | Array | The list of abilities the AI executes in sequence during its turn. | 121 | `[*BungaEatCat attack BungaRoar move]`<br>`[*ButtFart, Unflip]`<br>`[*DCBirthSquirrel attack DCBirthSquirrel]` |
| [`do_priority`](../Reference_and_Meta/Arrays.md#array-do_priority) | Array | The list of abilities the AI executes, evaluating them in order of highest priority. | 133 | `[ attack]`<br>`[**DestroyerThrowShield DestroyerHolyAttack]`<br>`[**DestroyerThrowShield attack]` |
| [`move_then_do`](../Reference_and_Meta/Enums.md#enum-move_then_do) | Enum | The specific ability the AI executes after moving. | 15 | `CHuskCatShade`<br>`CerberubsBarrage`<br>`CerberubsCalm` |
| [`do_random`](../Reference_and_Meta/Arrays.md#array-do_random) | Array | The list of abilities from which the AI randomly selects one to execute. | 13 | `[**TVChangeObey **TVChangeStop **TVChangeDumb]`<br>`[AZ_BreakNeck AZ_BreakLeg AZ_BreakArm]`<br>`[CHSpawn CHCry]` |
| [`do_strict`](../Reference_and_Meta/Arrays.md#array-do_strict) | Array | The list of abilities the AI executes in strict sequence, without any alternative. | 13 | `[*CanCreeperSlide, MoveCenter]`<br>`[*CraterCreeperSlide, MoveCenter]`<br>`[*WizSpellShield, WizBlizzard]` |
| [`do_nothing`](../Reference_and_Meta/Arrays.md#array-do_nothing) | Array | The list of actions (typically empty) the AI takes when it does nothing. | 5 | `[]` |
| [`move_then_do_random`](../Reference_and_Meta/Arrays.md#array-move_then_do_random) | Array | The list of abilities from which the AI randomly selects one to execute after moving. | 3 | `[CerberubsJumpBlind CerberubsJumpNormal]`<br>`[ClotEvolve ClotFailEvolve]`<br>`[ClotEvolveCatCopy ClotFailEvolve]` |
| [`move_then_do_priority`](../Reference_and_Meta/Arrays.md#array-move_then_do_priority) | Array | The list of abilities the AI executes after moving, in priority order. | 3 | `[BBPickupCrown, *BBToss, *attack]`<br>`[BBPickupCrown, *attack, *BBToss]`<br>`[DrinkUp attack]` |
| [`do_all_shuffle`](../Reference_and_Meta/Arrays.md#array-do_all_shuffle) | Array | The list of abilities the AI shuffles and then executes in the resulting random order. | 2 | `[YetiSlam YetiSlam YetiSlam`<br>`[attack DybbukWisps DybbukRePossess]` |
| [`do_best`](../Reference_and_Meta/Arrays.md#array-do_best) | Array | The list of abilities the AI evaluates to pick the one with the highest immediate benefit. | 2 | `[JohnnyPush JohnnyPull]` |
| [`do_best_multiple`](../Reference_and_Meta/Arrays.md#array-do_best_multiple) | Array | The list of abilities the AI evaluates to pick multiple beneficial ones to execute. | 1 ||
| [`do_priority_alternating`](../Reference_and_Meta/Arrays.md#array-do_priority_alternating) | Array | The list of abilities the AI executes in a priority order that alternates each turn. | 1 ||
| [`move_then_do_all`](../Reference_and_Meta/Arrays.md#array-move_then_do_all) | Array | The list of abilities the AI executes in sequence after moving. | 1 | `[LennyShove, LennyGrabDead, LennyGrab]` |
...
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 120 | passives<br>class<br>tag |
...
| [`Bishop`](../Reference_and_Meta/Miscellaneous.md#object-bishop) | Object  | Defines the 'Bishop' form for Cultist enemies, with its own attack (BBXLightning) and animation. | 11 | `{ . . . }` |
...
| [`Bomb`](../Reference_and_Meta/Miscellaneous.md#object-bomb) | Object  | Defines the 'Bomb' form, an explosive state that triggers an ability on death. | 21 | `{ . . . }` |
...
| [`Colorless`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-colorless) | Object  | Specifies the 'Colorless' form within FormChanger, used for boss dialogue. | 247 | `{ . . . }` |
...
| [`Druid`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-druid) | Object  | Specifies the 'Druid' form within FormChanger, used for boss dialogue. | 164 | `{ . . . }` |
...
| [`Fighter`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-fighter) | Object  | Specifies the 'Fighter' form within FormChanger, used for boss dialogue. | 136 | `{ . . . }` |
...
| [`Hunter`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-hunter) | Object  | Defines a list of quotes for the Hunter class (vs boss, embark, return early). | 136 | `{ . . . }` |
...
| [`Mage`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-mage) | Object  | Defines a list of quotes for the Mage class. | 133 | `{ . . . }` |
| [`Medic`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-medic) | Object  | Defines a list of quotes for the Medic class. | 119 | `{ . . . }` |
| [`Monk`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-monk) | Object  | Defines a list of quotes for the Monk class. | 127 | `{ . . . }` |
...
| [`Necromancer`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-necromancer) | Object  | Defines a list of quotes for the Necromancer class. | 144 | `{ . . . }` |
...
| [`Psychic`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-psychic) | Object  | Form identifier for the Psychic boss type, used for dialogue references. | 127 | `{ . . . }` |
...
| [`Tank`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-tank) | Object  | Form identifier for the Tank boss type, used for dialogue references. | 129 | `{ . . . }` |
...
| [`Thief`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-thief) | Object  | Form identifier for the Thief boss type. | 132 | `{ . . . }` |
...
| [`Tinkerer`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-tinkerer) | Object  | Form identifier for the Tinkerer boss type. | 132 | `{ . . . }` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `TVBotDie` | Integer | Keyword tooltip definition for the TVBot's death behavior, with name, tooltip, and icon. | 2 ||
| `TVBotDumb` | Integer | Defines the keyword tooltip for the TVBotDumb status or ability. | 2 ||
| `TVBotObey` | Integer | Defines the keyword tooltip for the TVBotObey status or ability. | 2 ||
| `TVBotStop` | Integer | Defines the keyword tooltip for the TVBotStop status or ability. | 2 ||
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`MoveAway`](../Reference_and_Meta/Miscellaneous.md#object-moveaway) | Object  | Defines an AI virtual ability that moves the unit away from its current target using the specified ability and move weights. | 8 | `{ . . . }` |
| [`MoveClose`](../Reference_and_Meta/Miscellaneous.md#object-moveclose) | Object  | Defines an AI virtual ability that moves the unit close to its target using the specified ability and move weights. | 8 | `{ . . . }` |
| [`DashRandomly`](../Reference_and_Meta/Miscellaneous.md#object-dashrandomly) | Object  | Defines an AI virtual ability that causes the unit to dash in a random direction using the specified ability and decision weights. | 4 | `{ . . . }` |
| [`Escape`](../Reference_and_Meta/Miscellaneous.md#object-escape) | Object  | Defines an AI virtual ability that causes the unit to escape using the specified ability and move weights. | 5 | `{ . . . }` |
| [`MoveCenter`](../Reference_and_Meta/Miscellaneous.md#object-movecenter) | Object  | Defines an AI virtual ability that moves the unit toward the center of the map using the specified ability and move weights. | 4 | `{ . . . }` |
| [`MoveForThrow`](../Reference_and_Meta/Miscellaneous.md#object-moveforthrow) | Object  | Defines an AI virtual ability that moves the unit into position for a throw ability. | 4 | `{ . . . }` |
| [`SpearRun`](../Reference_and_Meta/Miscellaneous.md#object-spearrun) | Object  | Defines an AI virtual ability that moves the unit to run with a spear and pick it up. | 4 | `{ . . . }` |
| [`CerberubsJumpBlind`](../Reference_and_Meta/Miscellaneous.md#object-cerberubsjumpblind) | Object  | Defines an AI virtual ability that makes Cerberubs jump with blind decision weights. | 2 | `{ . . . }` |
| [`CerberubsJumpNormal`](../Reference_and_Meta/Miscellaneous.md#object-cerberubsjumpnormal) | Object  | Defines an AI virtual ability that makes Cerberubs jump with default decision weights. | 2 | `{ . . . }` |
| [`CloseConvert`](../Reference_and_Meta/Miscellaneous.md#object-closeconvert) | Object  | Defines an AI virtual ability that moves close and uses the MarshmallowConvert ability. | 3 | `{ . . . }` |
| [`FoodMove`](../Reference_and_Meta/Miscellaneous.md#object-foodmove) | Object  | Defines an AI virtual ability that moves the unit toward food using the CaveBabyFoodMove ability. | 3 | `{ . . . }` |
| [`ForceTrample`](../Reference_and_Meta/Miscellaneous.md#object-forcetrample) | Object  | Defines an AI virtual ability that forces the unit to trample carelessly using the BirthwortTrample ability. | 2 | `{ . . . }` |
| [`LeapClose`](../Reference_and_Meta/Miscellaneous.md#object-leapclose) | Object  | Defines an AI virtual ability that makes the unit leap toward its aggro target. | 2 | `{ . . . }` |
| [`MoveForBarrage`](../Reference_and_Meta/Miscellaneous.md#object-moveforbarrage) | Object  | Defines an AI virtual ability that moves the unit to a position suitable for a barrage ability. | 2 | `{ . . . }` |
| [`MoveForDash`](../Reference_and_Meta/Miscellaneous.md#object-movefordash) | Object  | Defines an AI virtual ability that moves the unit into position for a dash attack. | 2 | `{ . . . }` |
| [`MoveForGrass`](../Reference_and_Meta/Miscellaneous.md#object-moveforgrass) | Object  | Defines an AI virtual ability that moves the unit to stomp and eat grass. | 2 | `{ . . . }` |
| [`MoveForPounce`](../Reference_and_Meta/Miscellaneous.md#object-moveforpounce) | Object  | Defines an AI virtual ability that moves the unit into position for a pounce attack. | 2 | `{ . . . }` |
| [`MoveForSpin`](../Reference_and_Meta/Miscellaneous.md#object-moveforspin) | Object  | Defines an AI virtual ability that moves the unit to set up a spin throw. | 2 | `{ . . . }` |
| [`MoveOneForPuke`](../Reference_and_Meta/Miscellaneous.md#object-moveoneforpuke) | Object  | Defines an AI virtual ability that moves the unit one step for a puke ability. | 1 | `{ . . . }` |
| [`MoveSpaced`](../Reference_and_Meta/Miscellaneous.md#object-movespaced) | Object  | Defines an AI virtual ability that moves the unit while maintaining a specific distance. | 3 | `{ . . . }` |
| [`MoveToHead`](../Reference_and_Meta/Miscellaneous.md#object-movetohead) | Object  | Defines an AI virtual ability that moves the unit to the head of a target to grab it. | 1 | `{ . . . }` |
| [`MoveTowards`](../Reference_and_Meta/Miscellaneous.md#object-movetowards) | Object  | Defines an AI virtual ability that moves the unit toward its target. | 2 | `{ . . . }` |
| [`NCGravecrawlFAR`](../Reference_and_Meta/Miscellaneous.md#object-ncgravecrawlfar) | Object  | Defines an AI virtual ability that makes a NecroCat gravecrawl while staying far from enemies. | 2 | `{ . . . }` |
| [`ReturnA`](../Reference_and_Meta/Miscellaneous.md#object-returna) | Object  | Defines an AI virtual ability that makes a HangerBot return to a close position. | 2 | `{ . . . }` |
| [`RunFar`](../Reference_and_Meta/Miscellaneous.md#object-runfar) | Object  | Defines an AI virtual ability that makes the unit run far away. | 3 | `{ . . . }` |
| [`SuckMF`](../Reference_and_Meta/Miscellaneous.md#object-suckmf) | Object  | Defines an AI virtual ability that makes a Tormentor suck enemies carelessly while keeping distance. | 2 | `{ . . . }` |
| [`TF_TargetAllies`](../Reference_and_Meta/Miscellaneous.md#object-tf_targetallies) | Object  | Defines an AI virtual ability that casts Twisting Flames targeting allies. | 3 | `{ . . . }` |
| [`TF_TargetEnemies`](../Reference_and_Meta/Miscellaneous.md#object-tf_targetenemies) | Object  | Defines an AI virtual ability that casts Twisting Flames targeting enemies. | 3 | `{ . . . }` |
| [`Unflip`](../Reference_and_Meta/Miscellaneous.md#object-unflip) | Object  | Defines an AI virtual ability that teleports the unit to flip up and spin an enemy. | 2 | `{ . . . }` |
...
| [`GainDisorderFromPool`](../Reference_and_Meta/Miscellaneous.md#object-gaindisorderfrompool) | Object  | Specifies a pool of disorders from which one is randomly gained on basic attack, with an optional chance. | 3 | `{ . . . }` |
...
| `cancel_knockback` | Boolean | If true, knockback from the triggering event is negated. | 2 | `true` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `common` | `String` | Defines the common reward block for a boss encounter. | 1226 | `100`<br>`14`<br>`5` |
| [`{Event Keys}`](../Engine_Scripts_and_Logic/Engine_EventKeys.md#valid-property-keys) | Variable | Represents a key for an event entry within an item pool. | 20 | `common`<br>`rare`<br>`cha` |
| `rare` | `String` | Defines the rare reward block for a boss encounter. | 1061 | `1`<br>`10`<br>`15` |
...
| [{Logic Keys}](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Inherits core engine logic parameters. You can utilize any key from the Engine Logic Keys list here to handle special conditions, state tracking, or math formulas. | 2 |`damage_instance`<br>`spell`<br>`self_damage`
...
| `Blessing` | Float | The multiplier for the number of blessing pickups spawned. | 13 | `.5`<br>`1` |
| [`BigCatnip`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-bigcatnip) | Integer / Object  | The number of big catnip pickups spawned. | 5 | `{ . . . }`<br>`1`<br>`10`<br>`2` |
| [`BiggestFood`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-biggestfood) | Integer / Object  | The number of biggest food pickups spawned. | 9 | `{ . . . }`<br>`1`<br>`15`<br>`4` |
| [`BigScrap`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-bigscrap) | Float / Object  | The amount of big scrap pickups spawned. | 5 | `{ . . . }`<br>`1`<br>`2`<br>`4.5` |
| [`Coin`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-coin) | Integer / Object  | The number of coin pickups spawned. | 34 | `{ . . . }`<br>`1`<br>`70` |
| [`BigFood`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-bigfood) | Integer / Object  | The number of big food pickups spawned. | 5 | `{ . . . }`<br>`20`<br>`5` |
| `Coin10` | Float | The multiplier for the number of Coin10 pickups spawned. | 3 | `.1`<br>`1` |
| [`Coin3`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-coin3) | Integer / Object  | The number of Coin3 pickups spawned. | 4 | `{ . . . }`<br>`1` |
| [`Coin4`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-coin4) | Integer / Object  | The number of Coin4 pickups spawned. | 4 | `{ . . . }`<br>`1` |
| [`MedCatnip`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-medcatnip) | Integer / Object  | The number of medium catnip pickups spawned. | 3 | `{ . . . }`<br>`20`<br>`5` |
| [`MedScrap`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-medscrap) | Integer / Object  | The number of medium scrap pickups spawned. | 3 | `{ . . . }`<br>`20`<br>`5` |
| [`RandomArmorPickup`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-randomarmorpickup) | Float / Object  | The amount of random armor pickups spawned. | 61 | `{ . . . }`<br>`4.5`<br>`40` |
| [`RandomCatnipPickup`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-randomcatnippickup) | Integer / Object  | The number of random catnip pickups spawned. | 5 | `{ . . . }`<br>`10`<br>`30` |
| [`RandomFoodPickup`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-randomfoodpickup) | Integer / Object  | The number of random food pickups spawned. | 7 | `{ . . . }`<br>`15`<br>`40` |
| [`Bear`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-bear) | Integer / Object  | The number of bear familiars spawned. | 12 | `{ . . . }`<br>`1` |
| [`BlackBird`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-blackbird) | Integer / Object  | The number of black birds spawned. | 2 | `{ . . . }`<br>`3000` |
| [`Catepillar`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-catepillar) | Integer / Object  | The number of caterpillar familiars spawned. | 6 | `{ . . . }`<br>`10` |
| [`Catnip`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-catnip) | Integer / Object  | The number of catnip pickups spawned. | 18 | `{ . . . }`<br>`20`<br>`3` |
| [`CharmedDip`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-charmeddip) | Integer / Object  | The number of charmed dip pickups spawned. | 5 | `{ . . . }`<br>`1` |
| [`CharmedFloater`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-charmedfloater) | Integer / Object  | The number of charmed floater pickups spawned. | 2 | `{ . . . }`<br>`1` |
| [`CharmedPile`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-charmedpile) | Integer / Object  | The number of charmed pile pickups spawned. | 2 | `{ . . . }`<br>`1` |
| [`Cherub`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-cherub) | Integer / Object  | The number of cherubs spawned. | 4 | `{ . . . }`<br>`1` |
| [`Chicken`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-chicken) | Integer / Object  | The number of chicken pickups spawned. | 11 | `{ . . . }`<br>`.01`<br>`.1`<br>`2` |
| [`Coin2`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-coin2) | Integer / Object  | The number of Coin2 pickups spawned. | 3 | `{ . . . }`<br>`1` |
| [`Dove`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-dove) | Integer / Object  | The number of doves spawned. | 2 | `{ . . . }`<br>`1000` |
| [`Eagle`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-eagle) | Integer / Object  | The number of eagles spawned. | 2 | `{ . . . }`<br>`300` |
| [`Food`](../World_Maps_and_Events/Shops.md#object-food) | Integer / Object  | The number of food pickups spawned. | 35 | `{ . . . }`<br>`20` |
| [`Harpy`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-harpy) | Integer / Object  | The number of harpies spawned. | 2 | `{ . . . }`<br>`1` |
| [`HummingBird`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-hummingbird) | Integer / Object  | The number of hummingbirds spawned. | 2 | `{ . . . }`<br>`300` |
| [`LargeBirdPool`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-largebirdpool) | Integer / Object  | The weight for spawning from the large bird pool. | 2 | `{ . . . }`<br>`1` |
| [`MedBirdPool`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-medbirdpool) | Integer / Object  | The weight for spawning from the medium bird pool. | 2 | `{ . . . }`<br>`1` |
| [`Mutant`](../Reference_and_Meta/Miscellaneous.md#object-mutant) | Integer / Object  | As an object, defines the mutant form with reduced move speed and custom name. As an integer, defines spawn weight. | 11 | `{ . . . }`<br>`1` |
| [`Pigeon`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-pigeon) | Integer / Object  | The number of pigeons spawned. | 3 | `{ . . . }`<br>`3000` |
| [`RandomBiggerArmorPickup`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-randombiggerarmorpickup) | Float / Object  | The amount of bigger random armor pickups spawned. | 2 | `{ . . . }`<br>`4.5` |
| [`RandomBiggerCatnipPickup`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-randombiggercatnippickup) | Integer / Object  | The number of bigger random catnip pickups spawned. | 2 | `{ . . . }`<br>`10` |
| [`RandomBiggerFoodPickup`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-randombiggerfoodpickup) | Integer / Object  | The number of bigger random food pickups spawned. | 2 | `{ . . . }`<br>`15` |
| [`Raven`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-raven) | Integer / Object  | The number of ravens spawned. | 3 | `{ . . . }`<br>`300` |
| [`Scrap`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-scrap) | Integer / Object  | The number of scrap pickups spawned. | 24 | `{ . . . }`<br>`20` |
| [`Seagull`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-seagull) | Integer / Object  | The number of seagulls spawned. | 2 | `{ . . . }`<br>`1000` |
| [`SmallBirdPool`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-smallbirdpool) | Integer / Object  | The weight for spawning from the small bird pool. | 2 | `{ . . . }`<br>`1` |
| [`Snake`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-snake) | Integer / Object  | The number of snake familiars spawned. | 17 | `{ . . . }`<br>`10` |
| [`Squirrel`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-squirrel) | Integer / Object  | The number of squirrel familiars spawned. | 13 | `{ . . . }`<br>`10` |
| [`Toad`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-toad) | Integer / Object  | The number of toad familiars spawned. | 11 | `{ . . . }`<br>`10` |
| [`Turkey`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-turkey) | Integer / Object  | The number of turkeys spawned. | 6 | `{ . . . }`<br>`1000`<br>`2` |
| [`Turtle`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#object-turtle) | Integer / Object  | The number of turtle familiars spawned. | 12 | `{ . . . }`<br>`10` |
...
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 5 | passives<br>class<br>tag |
| [`AllStatsUp`](../Reference_and_Meta/Arrays.md#array-allstatsup) | Array / Integer | The number of stacks of a global stat increase applied to all stats (DamageUp, SpeedUp, ConstitutionUp, DodgeChance). | 125 | `-1`<br>`-2`<br>`1` |
| [`Consumed`](./Passives_and_Statuses.md#object-consumed) | Object  | An object configuring how the target is consumed (e.g., via swallow), with fields like `instant`, `wet`, `force_contact`, and `struggle_ability`. | 23 | `{ . . . }` |
| [{Logic Keys}](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Inherits core engine logic parameters. You can utilize any key from the Engine Logic Keys list here to handle special conditions, state tracking, or math formulas. | 4 | `Default`<br>`FormChange`<br>`Druid`
...
| `Vaporize` | `Number` | Removes the target from play, preventing its corpse from being interacted with. | 33 | `1`<br>`20` |
| `Thorns` | Integer | The amount of thorns damage dealt to attackers on hit. | 130 | `1`<br>`2`<br>`3` |
...
| [`threshold`](../Reference_and_Meta/Enums.md#enum-threshold) | Enum / Integer  | The health threshold value, either as a formula using X (max health) or a fixed integer. | 49 | `"X*.4"`<br>`"X*.8"`<br>`"max(X*.33, 5)"` |
| `even_if_stunned` | Boolean | If true, the autocast triggers even if the unit is stunned. | 27 | `true` |
| `immediate` | Boolean | If true, the action (e.g., attack) occurs instantly without waiting for the unit's turn in the initiative order. | 231 | `false`<br>`true` |
...
| [`FormChange`](../Reference_and_Meta/Enums.md#enum-formchange) | Enum  | Specifies the form the target transforms into, either as a string or an object with a `form` field. | 140 | `Big`<br>`BigHolding`<br>`BigHoldingCat` |
...
| `stacks` | Enum / Equation | Specifies the number of stacks for a temporary status effect, either as a fixed number, a formula string, or by referencing an item's auxiliary value. | 234 | `"floor(lck/4)"`<br>`"max(min(X+1, item_aux), 0)"`<br>`-2` |
| [`object`](../Reference_and_Meta/Arrays.md#array-object) | Array / Enum | Specifies the object or unit to be spawned. | 1014 | `AlbinoTomTom`<br>`AlbinoTomTom_Elite`<br>`AlienBeast` |
| `initiative` | Integer | The unit's turn order priority; can be an integer modifier or 'keep_turns_end_turn' to force end of turn after acting. | 77 | `-10`<br>`-100`<br>`-20` |
...
| [`move`](../Reference_and_Meta/Enums.md#enum-move) | Enum | Specifies the name of the class's default movement ability. | 618 | `BasicJump`<br>`BungaJumpMove`<br>`DefaultMove` |
| `enemies_only` | Boolean | If true, the arc lightning effect only chains to enemy units, ignoring allies. | 39 | `false`<br>`true` |
| [`tag_restriction`](../Reference_and_Meta/Enums.md#enum-tag_restriction) | Enum | Specifies a tag that the target unit must have for the team cast to trigger. | 5 | `collective`<br>`dc_cat`<br>`dinofamily` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`animation_suffix`](../Assets_and_Localization/Strings.md#string-animation_suffix) | String | Specifies an animation suffix for the current form, used to load different sprites. | 89 | `""`<br>`"0"`<br>`"1"` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 23 | Default<br>FormChange<br>Druid |
...
| `self_damage` | Boolean / Integer | Defines damage or effects applied to the caster when using the ability. | 271 | `1`<br>`10`<br>`100%` |
...
| `ConstitutionUp` | Integer | The number of stacks (or [stacks, probability] array) of a Constitution buff applied, increasing maximum health. | 46 | `-1`<br>`-2`<br>`1` |
| [`RemoveStatusStacks`](../Reference_and_Meta/Miscellaneous.md#object-removestatusstacks) | Object  | An object specifying a status name and the number of stacks to remove from the target. | 4 | `{ . . . }` |
...
| :--- | :--- | :--- | :--- | :--- |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 12 | passives<br>class<br>tag |
| [`StacyMutant_Brace`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_brace) | Object  | A passive group granting the Brace ability and cosmetic changes. | 2 | `{ . . . }` |
| [`StacyMutant_Counter`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_counter) | Object  | A passive group granting a counter attack and a bleed effect on basic attacks. | 2 | `{ . . . }` |
| [`StacyMutant_Damage`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_damage) | Object  | A passive group increasing damage and decreasing max health with cosmetic changes. | 2 | `{ . . . }` |
| [`StacyMutant_DoubleHead`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_doublehead) | Object  | A passive group granting an extra dispersed turn and cosmetic changes. | 2 | `{ . . . }` |
| [`StacyMutant_Fire`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_fire) | Object  | A passive group granting fire immunity and a lava shot basic attack. | 2 | `{ . . . }` |
| [`StacyMutant_Health`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_health) | Object  | A passive group increasing max health, reducing speed, and scaling size. | 2 | `{ . . . }` |
| [`StacyMutant_Holy`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_holy) | Object  | A passive group granting a divine shield and cosmetic changes. | 2 | `{ . . . }` |
| [`StacyMutant_Ice`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_ice) | Object  | A passive group granting ice immunity and an ice breath basic attack. | 2 | `{ . . . }` |
| [`StacyMutant_Lightning`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_lightning) | Object  | A passive group granting electric immunity and a lightning dash basic attack. | 2 | `{ . . . }` |
| [`StacyMutant_Mirror`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_mirror) | Object  | A passive group granting projectile reflection and random magic missile each turn. | 2 | `{ . . . }` |
| [`StacyMutant_Speed`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_speed) | Object  | A passive group increasing speed, reducing damage, and scaling size. | 2 | `{ . . . }` |
| [`StacyMutant_Thorns`](../Reference_and_Meta/Miscellaneous.md#object-stacymutant_thorns) | Object  | A passive group granting thorns damage and cosmetic changes. | 2 | `{ . . . }` |
...
| `RemoveKnockback` | `Number` | The number of knockback stacks removed from the received damage. | 2 | `1` |
| [`TempPassiveUntilSettled`](../Reference_and_Meta/Miscellaneous.md#object-temppassiveuntilsettled) | Object  | An object containing a temporary passive that is applied until the character's position is settled. | 3 | `{ . . . }` |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 1 | passives<br>class<br>tag |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`{Global Modifier Keys}`](../Engine_Scripts_and_Logic/Engine_GlobalModifierKeys.md#valid-property-keys) | Variable | If true, activates a global modifier effect on the house environment. | 5 | `CreateGlobalModifiers`<br>`BloodRain`<br>`NextPlayerCatTakesExtraTurn` |
| `BloodRain` | `Number` | If non-zero, enables the blood rain visual effect. | 9 | `1` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `GlobalSpawnCharacter` | `String` | Specifies the name of a character to spawn globally. | 3 | `MegaGuppy` |
| `PlayBackground` | `Number` | Specifies the background index to play. | 5 | `0`<br>`1` |
...
| [`ElementImmune`](../Reference_and_Meta/Enums.md#enum-elementimmune) | Enum  | Specifies an element type (e.g., Fire, Ice) that the unit is immune to damage from. | 51 | `Creep`<br>`Electric`<br>`Fire` |
| [`ReplaceBasicAttack`](../Reference_and_Meta/Enums.md#enum-replacebasicattack) | Enum  | Specifies the ability ID that replaces the unit's basic attack. | 25 | `BasicButcherMeleeWideDoubleSpin`<br>`BasicButcherMeleeWideSpin`<br>`BasicDruidAbilityVersatile` |
| [`ReplaceBrain`](./Passives_and_Statuses.md#object-replacebrain) | Object  | Defines a replacement AI brain and behavior pattern for the mutant. | 4 | `{ . . . }` |
| [{Logic Keys}](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Inherits core engine logic parameters. You can utilize any key from the Engine Logic Keys list here to handle special conditions, state tracking, or math formulas. | 0 | `Default`<br>`FormChange`<br>`Druid`
...
| :--- | :--- | :--- | :--- | :--- |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 5 | passives<br>class<br>tag |
| `RemoveAmbientLightEffects` | Integer | The fade-out duration in seconds for ambient light effects. | 2 | `.5`<br>`4` |
...
| :--- | :--- | :--- | :--- | :--- |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 4 | passives<br>class<br>tag |
| [`BackflipWhenTargeted`](./Passives_and_Statuses.md#object-backflipwhentargeted) | Object  | The number of backflip charges, or an object defining its ability. | 15 | `{ . . . }` |
| [{Logic Keys}](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Inherits core engine logic parameters. You can utilize any key from the Engine Logic Keys list here to handle special conditions, state tracking, or math formulas. | 0 | `Default`<br>`FormChange`<br>`Druid`
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `Die` | `Number` | If set, kills the target immediately. | 10 | `1`<br>`6` |
| [`Dumb`](../Reference_and_Meta/Miscellaneous.md#object-dumb) | Integer / Object  | Defines the 'Dumb' form, which can be either a numeric value or an object with passives that disable spells and turn off TV. | 4 | `{ . . . }`<br>`3` |
