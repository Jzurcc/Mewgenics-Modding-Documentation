...
| `lob` | Boolean | If true, the projectile follows a lobbed trajectory. | 134 | `false`<br>`true` |
| `delay` | Float | The delay in seconds before the ability's effect triggers. | 124 | `.05`<br>`.1`<br>`.25` |
| `dont_visualize_ai` | Boolean | If true, the AI's visualization of this ability is suppressed. | 88 | `true` |
| `dont_orient` | Boolean | If true, the caster does not rotate to face the target. | 86 | `true` |
...
| [`start`](../Reference_and_Meta/Enums.md#enum-start) | Enum | Specifies the initial animation state played at the beginning of an ability. | 13 | `attack`<br>`lickAttack`<br>`monkAttack` |
...
| `aoe_spell_on_land` | Boolean | If true, triggers an area-of-effect spell upon the unit landing after a jump or movement. | 8 | `true` |
...
| [`animate_name`](../Reference_and_Meta/Enums.md#enum-animate_name) | Boolean / Enum | If true, the ability name is animated; if set to an enum, it specifies a specific animation type like 'pointout'. | 178 | `false`<br>`pointout`<br>`true` |
...
| [`effects`](./Passives_and_Statuses.md#object-effects) | Object  | Applies a list of status effects or visual effects to targets. | 2166 | `{ . . . }` |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 2208 | passives<br>class<br>tag |
| [`damage`](../Reference_and_Meta/Miscellaneous.md#object-damage) | Enum / Integer / Object  | Specifies the amount of damage dealt, can be a number or expression. | 1684 | `{ . . . }`<br>`"(15+bonus_melee_damage)*.5"`<br>`"(4+bonus_ranged_damage+1)/2"`<br>`"(5+bonus_melee_ability_damage)*.5"` |
...
| `custom_additional_ai_weight` | `String` | A string identifier for a custom AI weighting condition that modifies the AI's scoring for this damage instance. | 83 | `avoid_redundant_debuffs`<br>`avoid_redundant_debuffs_strict`<br>`avoid_target_map_top` |
...
| :--- | :--- | :--- | :--- | :--- |
| [`max_range`](../Reference_and_Meta/Enums.md#enum-max_range) | Enum / Integer   | The maximum range of the ability, can be a static number or an expression. | 1092 | `"4+(1-clamp(spd,0,1))*2"`<br>`"max(5-int, 1)"`<br>`-1` |
| [`max_aoe`](../Reference_and_Meta/Enums.md#enum-max_aoe) | Enum / Integer   | An equation or integer defining the maximum radius or number of tiles for the area of effect target selection. | 795 | `"(X+1)/2"`<br>`"X/2"`<br>`-1` |
| `min_range` | Integer | The minimum range of the ability. | 588 | `0`<br>`1`<br>`2` |
...
| `redirect_location_if_blocked` | Boolean | If true, the target location is redirected if the original is blocked. | 3 | `true` |
...
| `prime` | Integer | The number of prime points required to use the ability. | 31 | `1` |
...
| `charge` | Equation | The amount of charge required or the formula to calculate charge cost. | 19 | `"1-clamp(spd,0,1)"`<br>`0`<br>`1` |
...
| `durability` | Integer | The amount of durability consumed by this ability or required for its use. | 182 | `0`<br>`1`<br>`10` |
...
| `layer` | `String` | Specifies the layer on which the ability's effect operates (e.g., characters, tiles, gas). | 61 | `2`<br>`all`<br>`characters` |
| [`catdata`](../Reference_and_Meta/Enums.md#enum-catdata) | Enum  | Specifies the cat data identifier for the spawned unit, linking to a character template. | 30 | `Beaver`<br>`Bigfoot`<br>`Bunny` |
...
| `size` | Integer | The scale factor (size multiplier) of the spawned unit. | 153 | `.2`<br>`.5`<br>`1` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 125 | passives<br>class<br>tag |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 35 | passives<br>class<br>tag |
| `Trample` | Integer | The amount of bonus damage dealt when moving through an enemy. | 127 | `1`<br>`3`<br>`4` |
...
| `DoubleLoot` | Integer | The multiplier for loot drops, where 1 or 2 doubles the loot. | 5 | `1`<br>`2` |
| `KnockbackImmunity` | Integer | If set to 1, the unit cannot be knocked back. | 11 | `1` |
...
| `GainDisorderFromPool_PostCast` | `String` | Specifies the pool of disorders the unit can gain after the spell is cast. | 16 | `forbidden_spell_consequences`<br>`forbidden_spell_consequences_crippling` |
...
| `FullHeal` | `Number` | If non-zero, fully restores the target's health. | 23 | `0`<br>`1` |
...
| `SpawnThingIfHitKills` | `String` | The name of the thing (e.g., a food type) to spawn at the target's location upon a killing blow. | 10 | `Bait`<br>`BigFood`<br>`BiggestFood` |
...
| `RandomStatUp` | Enum / Equation | The amount of random stat increase applied, either as a fixed number or a formula string. | 52 | `"ceil(X/2)"`<br>`"ceil(X/3)"`<br>`-1` |
| `Revive` | Integer | Revives a dead target with the specified percentage of health (e.g., "50%", "100%") or a fixed number. | 21 | `1`<br>`100%`<br>`50%` |
...
| [`Conditional_HealthThreshold`](./Items_and_Equipment.md#object-conditional_healththreshold) | Object  | Contains an inner effect block that only executes if the target's health is below a threshold, defined by `threshold_flat`, `threshold_percent`, or `threshold_expr`. | 7 | `{ . . . }` |
...
| `ExplodeCharacter` | `Number` | The radius (in tiles) of an explosion centered on the character. | 2 | `5` |
...
| `FaceCamera` | `Number` | If non-zero, forces the character to rotate and face the camera. | 5 | `1` |
| `FlatAIBonus` | `Number` | A flat adjustment to the AI's evaluation score for this action; positive values encourage the AI to use it, negative values discourage it. | 3 | `-999999`<br>`100`<br>`999999` |
| `ForceImmediateMove` | `Number` | If non-zero, forces the character to move instantly without waiting for normal action order. | 1 | `1` |
| `GenericDebuff` | `Number` | The number of stacks of a generic, untooltipped debuff applied to the target. | 15 | `1`<br>`10`<br>`100` |
| `ImmediateUseAbility` | `String` | Specifies the name of an ability to be triggered instantly from this effect. | 11 | `FuzzerReact`<br>`HitlerCloneHeil`<br>`HitlerCloneTransform` |
| `Instakill` | `Number` | The amount of damage dealt to instantly kill the target; can be a flat value or a probability array (e.g., [damage, chance]). | 12 | `25`<br>`50`<br>`999` |
...
| `PurgeAll` | `Number` | If non-zero, removes all temporary status effects (buffs, debuffs) from the target. | 11 | `1` |
| `RemoveMovePoints` | `Number` | The number of move points to remove from the target, preventing them from moving. | 3 | `1` |
| `RemoveTurnsThisRound` | `Number` | The number of turns to remove from the target's turn order this round. | 1 | `1` |
| `SetHealth` | `Number` | Sets the target's health to a specific flat value or percentage. | 9 | `1`<br>`100%`<br>`50%` |
| `SetShield` | `Number` | Sets the target's shield value to a specific flat amount. | 3 | `0`<br>`88` |
...
| `SpeculativeMoveSelfCorpseOffMap` | `Number` | If true, attempts to remove the character's corpse from the map, used for speculative AI targeting. | 3 | `1` |
...
| `VaporizeInanimate` | `Number` | If non-zero, instantly destroys inanimate objects (corpses, rocks) as if they were vaporized. | 8 | `1` |
...
| [`Bruise`](../Reference_and_Meta/Arrays.md#array-bruise) | Array / Integer  | The number of stacks (or [stacks, probability] array) of the Bruise debuff applied, which increases damage taken. | 133 | `1`<br>`2`<br>`3` |
...
| [`Slow`](../Reference_and_Meta/Arrays.md#array-slow) | Array / Enum / Integer  | The number of stacks (or [stacks, probability] array) of the Slow debuff applied, reducing speed. | 75 | `-1`<br>`1`<br>`2` |
...
| `EvolveAbilityFromPool` | `String` | Specifies the ability pool from which to evolve an ability for the source, optionally upgrading it. | 26 | `Butcher`<br>`Druid`<br>`Fighter` |
| `FormChange` | `String` | Specifies the form the target transforms into, either as a string or an object with a `form` field. | 140 | `Big`<br>`BigHolding`<br>`BigHoldingCat` |
...
| `RefreshActPoints` | `Number` | The amount of action points restored to the source. | 21 | `1` |
| [`ConstitutionUp`](../Reference_and_Meta/Arrays.md#array-constitutionup) | Array / Enum / Integer  | The number of stacks (or [stacks, probability] array) of a Constitution buff applied, increasing maximum health. | 46 | `-1`<br>`-2`<br>`1` |
...
| [`FindItemFromPool`](./Passives_and_Statuses.md#object-finditemfrompool) | Object  | Specifies the loot pool from which to find an item, with an optional chance. | 43 | `{ . . . }` |
...
| `RemoveStatus` | `String` | The name of the status effect to remove from the source. | 16 | `AlphaCat`<br>`Brace`<br>`DodgeChance_Status` |
...
| `RefreshMovePoints` | `Number` | The amount of movement points restored to the source. | 23 | `1` |
| `SpecificInjury` | `String` | The stat (str, spd, int) to which a specific injury is applied, reducing that stat. | 5 | `int`<br>`spd`<br>`str` |
| `StanceSwitchToMelee` | `Number` | If set, switches the source to melee stance. | 3 | `1` |
...
| `TempTrampleUntilSettled` | `Number` | The number of stacks of temporary Trample applied to the source, allowing movement through enemies until the source ends its turn. | 3 | `3` |
...
| [`ForceUseAbility`](../Reference_and_Meta/Enums.md#enum-forceuseability) | Enum  | The name of the ability the source is forced to use, optionally with a chance. | 33 | `CancerExplode`<br>`DustDash`<br>`Hallucinate_Disorder` |
| [`GainCoinsRange`](../Reference_and_Meta/Miscellaneous.md#object-gaincoinsrange) | Object  | An object with `min` and `max` fields specifying a range for the amount of coins gained. | 11 | `{ . . . }` |
...
| [`tag`](../Reference_and_Meta/Enums.md#enum-tag) | Enum  | Specifies the tag(s) to check on the target, used in conditional effects. | 990 | `[alien robot]`<br>`[alien rock]`<br>`[alien]` |
...
| [`Conditional_NotBoss`](./Passives_and_Statuses.md#object-conditional_notboss) | Object  | Contains effects that apply only if the target is not a boss enemy. | 16 | `{ . . . }` |
| `FloatingRockTrap` | `Number` | The number of stacks of Floating Rock Trap applied to the target, dealing damage when stepped on. | 7 | `1` |
| [`Conditional_Boss`](./Passives_and_Statuses.md#object-conditional_boss) | Object  | Contains effects that apply only if the target is a boss enemy. | 21 | `{ . . . }` |
| `IgnoreDamage` | `Number` | If set, the target ignores all damage for the duration. | 9 | `1` |
| [`ApplyToSource`](./Passives_and_Statuses.md#object-applytosource) | Object  | An object of effects that are applied to the source of the ability (the caster). | 59 | `{ . . . }` |
| `ImmediateUseAbility` | `String` | Specifies the name of an ability to be triggered instantly from this effect. | 11 | `FuzzerReact`<br>`HitlerCloneHeil`<br>`HitlerCloneTransform` |
...
| `DeleteObject` | `Number` | If set, deletes the target object from the map. | 7 | `1` |
| `DisplaceTowardsSource` | `Number` | If set, displaces the target towards the source of the effect. | 5 | `1` |
| `FaceAway` | `Number` | If set, forces the target to face away from the source. | 18 | `1` |
| `Instakill` | `Number` | The amount of damage dealt to instantly kill the target; can be a flat value or a probability array (e.g., [damage, chance]). | 12 | `25`<br>`50`<br>`999` |
| `OverrideDamage` | `Number` | Overrides the damage of the current action to this flat value (can be negative to heal). | 17 | `-10`<br>`0`<br>`1` |
...
| `RemoveStatus` | `String` | The name of the status effect to remove from the source. | 16 | `AlphaCat`<br>`Brace`<br>`DodgeChance_Status` |
| `ScatterRandomPickups` | `Number` | The number of random pickups scattered around the target's location. | 2 | `2`<br>`5` |
| `SetKnockback` | `Number` | The knockback distance to set for the damage instance, overriding default. | 2 | `0` |
| `UseAbility` | `String` | The name of the ability the target is forced to use. | 14 | `GirlDinoPoop`<br>`KirbySpit`<br>`MD_PoopChain` |
| `VaporizeCorpse` | `Number` | If set, vaporizes the target's corpse, preventing revival. | 18 | `1` |
...
| [`Madness`](./Passives_and_Statuses.md#object-madness) | Array / Enum / Integer / Object  | The amount of Madness applied, either as a fixed number, a string like "level", or an array of [stacks, probability]. | 45 | `{ . . . }`<br>`1`<br>`2`<br>`3` |
...
| [`Weakness`](../Reference_and_Meta/Arrays.md#array-weakness) | Array / Integer  | The amount of Weakness applied, either as a fixed number or an array of [stacks, probability]. | 59 | `1`<br>`2`<br>`3` |
| [`ApplyToSource`](./Passives_and_Statuses.md#object-applytosource) | Object  | An object of effects that are applied to the source of the ability (the caster). | 59 | `{ . . . }` |
| [`ApplyToSourceOnKill`](../Reference_and_Meta/Miscellaneous.md#object-applytosourceonkill) | Object  | Contains effects that are applied to the source when it kills the target. | 15 | `{ . . . }` |
| `BonusDamage` | Equation | The amount of flat bonus damage added (negative values reduce damage). | 29 | `"ceil(X/2)"`<br>`"max(0, floor(X/2)-1)"`<br>`"max(0, floor(X/6)-1)"` |
| `ForceMoveTowards` | `Number` | The number of tiles to force the target to move toward the caster. | 7 | `1` |
| [`Temporary`](./Passives_and_Statuses.md#object-temporary) | Object  | Contains parameters for applying a temporary status effect with specific stacks, turns, and expiration conditions. | 57 | `{ . . . }` |
...
| [`Marked`](../Reference_and_Meta/Arrays.md#array-marked) | Array / Integer  | The amount of Marked applied, either as a fixed number or an array of [stacks, probability]. | 27 | `1`<br>`3`<br>`5` |
...
| `OverrideDamage` | `Number` | Overrides the damage of the current action to this flat value (can be negative to heal). | 17 | `-10`<br>`0`<br>`1` |
| [`AllStatsUp`](../Reference_and_Meta/Arrays.md#array-allstatsup) | Array / Integer | The number of stacks of a global stat increase applied to all stats (DamageUp, SpeedUp, ConstitutionUp, DodgeChance). | 125 | `-1`<br>`-2`<br>`1` |
| `KnockbackDamageImmuneUntilSettled` | `Number` | If non-zero, makes the target immune to damage from knockback until they stop moving. | 10 | `1` |
| [`Temporary`](./Passives_and_Statuses.md#object-temporary) | Object  | Contains parameters for applying a temporary status effect with specific stacks, turns, and expiration conditions. | 57 | `{ . . . }` |
| `Cleanse` | Integer | The number of stacks of negative status effects removed from the target. | 71 | `0`<br>`1` |
| [`ApplyToSource`](./Passives_and_Statuses.md#object-applytosource) | Object  | An object of effects that are applied to the source of the ability (the caster). | 59 | `{ . . . }` |
| `HealthGain` | Integer | The amount of health restored to the source. | 63 | `1`<br>`10`<br>`2` |
| `RandomStatUp` | Enum / Equation | The amount of random stat increase applied, either as a fixed number or a formula string. | 52 | `"ceil(X/2)"`<br>`"ceil(X/3)"`<br>`-1` |
| [`ApplyToSourceOnKill`](../Reference_and_Meta/Miscellaneous.md#object-applytosourceonkill) | Object  | Contains effects that are applied to the source when it kills the target. | 15 | `{ . . . }` |
| `ChanceToBreak` | `Number` | Specifies the percentage chance that the item breaks on use. | 11 | `100`<br>`15`<br>`20` |
...
| [`Conditional_PlayerCat`](./Items_and_Equipment.md#object-conditional_playercat) | Object  | Defines effects that only apply if the target is a player-controlled cat. | 7 | `{ . . . }` |
| `FullHeal` | `Number` | If non-zero, fully restores the target's health. | 23 | `0`<br>`1` |
| `ManaGain` | Equation | The amount of mana restored to the source, which can be an expression. | 40 | `"-ceil(X/2)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
| `RepairAll` | `Number` | The amount of durability restored to all equipped items. | 5 | `1`<br>`10` |
| `ShowText` | `String` | Specifies the localization key for a popup text displayed on the target. | 3 | `"COMBAT_POPUP_BRAINSTORM"`<br>`"COMBAT_POPUP_RELOAD"`<br>`"COMBAT_POPUP_REPAIRED"` |
| `ThornsDamageImmuneUntilSettled` | `Number` | The number of turns the target is immune to thorns damage until it settles. | 2 | `1` |
| `TileDamageImmuneUntilSettled` | `Number` | The number of turns the target is immune to tile damage until it settles. | 2 | `1` |
...
| [`ApplyToRandomPartyMemberIfPossible`](../Reference_and_Meta/Miscellaneous.md#object-applytorandompartymemberifpossible) | Object  | Contains an inner effect block that is applied to a random living party member if one exists. | 3 | `{ . . . }` |
| [`ApplyToSource`](./Passives_and_Statuses.md#object-applytosource) | Object  | An object of effects that are applied to the source of the ability (the caster). | 59 | `{ . . . }` |
| `GainDisorder` | `String` | Specifies the name of the disorder gained. | 2 | `Chungus`<br>`Psychosis` |
| `ImmediateUseAbility` | `String` | Specifies the name of an ability to be triggered instantly from this effect. | 11 | `FuzzerReact`<br>`HitlerCloneHeil`<br>`HitlerCloneTransform` |
| `RefreshWeaponAbility` | `Number` | The number of times the weapon's ability is refreshed. | 4 | `1` |
| `ShowText` | `String` | Specifies the localization key for a popup text displayed on the target. | 3 | `"COMBAT_POPUP_BRAINSTORM"`<br>`"COMBAT_POPUP_RELOAD"`<br>`"COMBAT_POPUP_REPAIRED"` |
...
| `DamageUp` | Array / Equation | The number of stacks (or a formula string) of a damage buff applied, increasing outgoing damage. | 113 | `"(-ceil(abs(X/2)))"`<br>`"(-ceil(abs(X/3)))"`<br>`-1` |
| `Shield` | Enum / Equation | The amount of shield granted to the source, absorbing incoming damage. | 109 | `"2*(X-1)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
| `TemporaryItem` | Integer | The number of times a temporary item can be used before disappearing. | 2 ||
...
| `RemoveStatus` | `String` | The name of the status effect to remove from the source. | 16 | `AlphaCat`<br>`Brace`<br>`DodgeChance_Status` |
| [`Else`](./Passives_and_Statuses.md#object-else) | Object  | Contains the fallback effects to apply when a preceding conditional check fails. | 86 | `{ . . . }` |
| `VisualFX` | `String` | Specifies the name of the visual effect to play. | 14 | `BigMagicMissileBlast`<br>`Bolt`<br>`Cleanse` |
| [`Stun`](../Reference_and_Meta/Arrays.md#array-stun) | Array / Integer  | The amount of Stun applied, either as a fixed number or an array of [stacks, probability]. | 138 | `1`<br>`2`<br>`3` |
| `BonusDamage` | Equation | The amount of flat bonus damage added (negative values reduce damage). | 29 | `"ceil(X/2)"`<br>`"max(0, floor(X/2)-1)"`<br>`"max(0, floor(X/6)-1)"` |
| [`Charmed`](../Reference_and_Meta/Arrays.md#array-charmed) | Array / Enum / Integer  | The number of stacks (or [stacks, probability] array) of the Charmed status effect applied, making the target act as an ally. | 47 | `1`<br>`2`<br>`3` |
...
| `ExplodeCharacter_NoDie` | `Number` | The damage dealt when a character explodes without dying. | 2 | `1`<br>`5` |
| [`XIsTargetHealth`](../Reference_and_Meta/Miscellaneous.md#object-xistargethealth) | Object  | Evaluates a bonus damage formula where X is the target's current health. | 2 | `{ . . . }` |
| [`Fear`](../Reference_and_Meta/Arrays.md#array-fear) | Array / Integer  | The amount of Fear applied, either as a fixed number or an array of [stacks, probability]. | 108 | `1`<br>`10`<br>`2` |
...
| [`Burn`](../Reference_and_Meta/Arrays.md#array-burn) | Array / Enum / Integer  | The amount of Burn applied, either as a fixed number or a formula string. | 154 | `1`<br>`10`<br>`2` |
| [`RemoveStatus`](../Reference_and_Meta/Enums.md#enum-removestatus) | Enum  | The name of the status effect to remove from the source. | 16 | `AlphaCat`<br>`Brace`<br>`DodgeChance_Status` |
| [`Slow`](../Reference_and_Meta/Arrays.md#array-slow) | Array / Enum / Integer  | The number of stacks (or [stacks, probability] array) of the Slow debuff applied, reducing speed. | 75 | `-1`<br>`1`<br>`2` |
| [`Confusion`](../Reference_and_Meta/Arrays.md#array-confusion) | Array / Integer  | The amount of confusion applied, either as a fixed number or an array of [stacks, probability]. | 86 | `1`<br>`10`<br>`2` |
| [`Fear`](../Reference_and_Meta/Arrays.md#array-fear) | Array / Integer  | The amount of Fear applied, either as a fixed number or an array of [stacks, probability]. | 108 | `1`<br>`10`<br>`2` |
| [`FormChange`](../Reference_and_Meta/Miscellaneous.md#object-formchange) | Enum / Object  | Specifies the form the target transforms into, either as a string or an object with a `form` field. | 140 | `{ . . . }`<br>`Big`<br>`BigHolding`<br>`BigHoldingCat` |
...
| `GainCoins` | Integer | The amount of coins gained, or a [min, max] range. | 10 | `-5`<br>`1`<br>`2` |
| [`AllStatsUp`](../Reference_and_Meta/Arrays.md#array-allstatsup) | Array / Integer | The number of stacks of a global stat increase applied to all stats (DamageUp, SpeedUp, ConstitutionUp, DodgeChance). | 125 | `-1`<br>`-2`<br>`1` |
| [`Burn`](../Reference_and_Meta/Arrays.md#array-burn) | Array / Enum / Integer  | The amount of Burn applied, either as a fixed number or a formula string. | 154 | `1`<br>`10`<br>`2` |
| `MoveQuivered` | Float | The number of stacks of bonus movement points applied to the source. Can be an array [stacks, probability]. | 22 | `1`<br>`2`<br>`[1, 0.1]` |
| `Quivered` | Integer | The amount of quivered stacks applied, or an [stacks, probability] array. | 36 | `1`<br>`2`<br>`5` |
...
| `StrengthUp` | Enum / Equation | The number of stacks of Strength Up applied to the source, increasing its Strength stat. | 71 | `"max(int, 0)"`<br>`-1`<br>`-2` |
| [`BackflipWhenTargeted`](./Passives_and_Statuses.md#object-backflipwhentargeted) | Integer / Object  | The number of backflip charges, or an object defining its ability. | 15 | `{ . . . }`<br>`1`<br>`2`<br>`X` |
| `BonusDamage` | Equation | The amount of flat bonus damage added (negative values reduce damage). | 29 | `"ceil(X/2)"`<br>`"max(0, floor(X/2)-1)"`<br>`"max(0, floor(X/6)-1)"` |
...
| `LuckUp` | Enum / Integer | The amount of Luck stat changed on the source, affecting random chance outcomes. | 51 | `-1`<br>`-2`<br>`-4` |
| `PoisonLace` | Enum / Equation | Integer or fractional string (e.g., 'X/3') specifying the duration or intensity of the PoisonLace effect. | 10 | `"X/3"`<br>`"X/5"`<br>`1` |
| [`RandomStatDown`](../Reference_and_Meta/Arrays.md#array-randomstatdown) | Array / Enum / Integer  | The amount of random stat reduction applied, either as a fixed number, a formula string, or an array of [stacks, probability]. | 12 | `"ceil(X/2)"`<br>`"ceil(X/3)"`<br>`1` |
...
| `Infested` | Integer | The number of stacks of Infested applied. | 15 | `1` |
| `ManaGain` | Equation | The amount of mana restored to the source, which can be an expression. | 40 | `"-ceil(X/2)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`form`](../Assets_and_Localization/Strings.md#string-form) | String | Specifies the name of the form the unit changes into. | 95 | `"Angry"`<br>`"Big"`<br>`"Bishop"` |
...
| `RemoveItem` | `String` | Specifies the item ID to remove from the source on kill. | 4 | `BlackShard`<br>`BlackShard_Glowing`<br>`ScaldingOrb` |
| `CompleteItemQuest` | `String` | Specifies the item quest ID to mark as complete on kill. | 5 | `BlackShard`<br>`Nuke`<br>`ScaldingOrb` |
| `ManaGain` | Equation | The amount of mana restored to the source, which can be an expression. | 40 | `"-ceil(X/2)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [{Status and Passive Keys}](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | Inherits standard status effect and passive mechanics. You can inject any key from the Engine Status and Passive Keys list here to apply buffs, debuffs, or triggered behaviors. | 9 | `passives`<br>`class`<br>`tag` | [`formula`](../Engine_Scripts_and_Logic/Math_Equations.md) | Equation | A mathematical expression evaluated to determine if its result is positive, enabling the parent conditional. | 1 | passives<br>class<br>tag |
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 8 | Default<br>FormChange<br>Druid |
| [`Burn`](../Reference_and_Meta/Arrays.md#array-burn) | Array / Enum / Integer  | The amount of Burn applied, either as a fixed number or a formula string. | 154 | `1`<br>`10`<br>`2` |
| [`Immobile`](../Reference_and_Meta/Arrays.md#array-immobile) | Array / Integer  | The number of stacks (or [stacks, probability] array) of the Immobile debuff applied, preventing movement. | 47 | `0`<br>`1`<br>`10%` |
| `Shield` | Enum / Equation | The amount of shield granted to the source, absorbing incoming damage. | 109 | `"2*(X-1)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
| `OverrideKnockbackDamage` | `String` | A formula or flat value that sets the damage dealt when knockback occurs, overriding default calculations. | 17 | `"max(5+bonus_melee_ability_damage, 1)"`<br>`0`<br>`2` |
| [`Freeze`](../Reference_and_Meta/Arrays.md#array-freeze) | Array / Integer  | The amount of freeze stacks applied, or an [stacks, probability] array. | 51 | `1`<br>`2`<br>`[1 .01]` |
| [`Slow`](../Reference_and_Meta/Arrays.md#array-slow) | Array / Enum / Integer  | The number of stacks (or [stacks, probability] array) of the Slow debuff applied, reducing speed. | 75 | `-1`<br>`1`<br>`2` |
| `SpeedUp` | Enum / Integer | The number of stacks of a Speed buff applied, increasing the target's turn order priority. | 91 | `-1`<br>`-2`<br>`-4` |
| [`Stun`](../Reference_and_Meta/Arrays.md#array-stun) | Array / Integer  | The amount of Stun applied, either as a fixed number or an array of [stacks, probability]. | 138 | `1`<br>`2`<br>`3` |
...
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 8 | Default<br>FormChange<br>Druid |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 6 | passives<br>class<br>tag |
| `DieViolently` | `Number` | If true, causes the target to die with a violent, explosive visual effect. | 4 | `1` |
| `Instakill` | `Number` | The amount of damage dealt to instantly kill the target; can be a flat value or a probability array (e.g., [damage, chance]). | 12 | `25`<br>`50`<br>`999` |
...
| `FlatLeech` | `Number` | The flat amount of health restored to the source when dealing damage, applied after the hit. | 9 | `1`<br>`10`<br>`2` |
| `FullHeal` | `Number` | If non-zero, fully restores the target's health. | 23 | `0`<br>`1` |
| `Instakill` | `Number` | The amount of damage dealt to instantly kill the target; can be a flat value or a probability array (e.g., [damage, chance]). | 12 | `25`<br>`50`<br>`999` |
...
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 3 | Default<br>FormChange<br>Druid |
| `CompleteItemQuest` | `String` | Specifies the item quest ID to mark as complete on kill. | 5 | `BlackShard`<br>`Nuke`<br>`ScaldingOrb` |
| `TriggerGameEnding` | `Number` | If set to 1, triggers the game's ending sequence; 0 disables it. | 3 | `0`<br>`1` |
...
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 1 | Default<br>FormChange<br>Druid |
| [`DoDamage`](../Reference_and_Meta/Miscellaneous.md#object-dodamage) | Object  | Contains damage parameters (amount, type, tile targets) to deal damage to the target. | 7 | `{ . . . }` |
| `EnterMount` | `String` | Specifies the name of the mount status to apply to the unit. | 2 | `enter` |
| `VisualFXTile` | `String` | Specifies the name of the visual effect to play on the target tile. | 39 | `Bolt`<br>`BurnTrigger`<br>`Explosion` |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 3 | passives<br>class<br>tag |
...
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 2 | Default<br>FormChange<br>Druid |
| [`DoScreenShake`](../Reference_and_Meta/Miscellaneous.md#object-doscreenshake) | Integer / Object  | If an integer, the number of screen shakes; if an object, defines the duration and intensity of the screen shake. | 12 | `{ . . . }`<br>`1` |
| `FormChange` | `String` | Specifies the form the target transforms into, either as a string or an object with a `form` field. | 140 | `Big`<br>`BigHolding`<br>`BigHoldingCat` |
| `FullHeal` | `Number` | If non-zero, fully restores the target's health. | 23 | `0`<br>`1` |
...
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 0 | Default<br>FormChange<br>Druid |
| `BonusDamage` | Equation | The amount of flat bonus damage added (negative values reduce damage). | 29 | `"ceil(X/2)"`<br>`"max(0, floor(X/2)-1)"`<br>`"max(0, floor(X/6)-1)"` |
| `DelayCastAbility` | `String` | Specifies the name of an ability to cast after a delay. | 2 | `HitlerNuke` |
| [`Bruise`](../Reference_and_Meta/Arrays.md#array-bruise) | Array / Integer  | The number of stacks (or [stacks, probability] array) of the Bruise debuff applied, which increases damage taken. | 133 | `1`<br>`2`<br>`3` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `ObjectOnHit` | `String` | Specifies the object to spawn on the hit tile. | 7 | `Bait`<br>`BiggestFood`<br>`Carcus` |
| `SpawnBearTrap` | `Number` | If non-zero, spawns a bear trap on the tile. | 7 | `1` |
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 0 | Default<br>FormChange<br>Druid |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [{Status and Passive Keys}](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | Inherits standard status effect and passive mechanics. You can inject any key from the Engine Status and Passive Keys list here to apply buffs, debuffs, or triggered behaviors. | 2 | `passives`<br>`class`<br>`tag` | `LaunchOffScreen` | String | A formula string that determines the knockback force to launch the unit off-screen. | 1 | passives<br>class<br>tag |
...
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 2 | passives<br>class<br>tag |
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 2 | Default<br>FormChange<br>Druid |
| `GenericBuff` | `Number` | A generic buff value applied to the unit. | 2 | `100`<br>`5` |
| [`RandomStatusFromPool`](./Passives_and_Statuses.md#object-randomstatusfrompool) | Object  | A collection of status effects; one is randomly chosen and applied to the target. | 35 | `{ . . . }` |
| `PartialCleanse` | Integer | The number of stacks of temporary status effects to remove from the target. | 9 | `1`<br>`9999` |
...
| `BloodRain` | Integer | If non-zero, enables the blood rain visual effect. | 9 | `1` |
| [{Status and Passive Keys}](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | Inherits standard status effect and passive mechanics. You can inject any key from the Engine Status and Passive Keys list here to apply buffs, debuffs, or triggered behaviors. | 0 | `passives`<br>`class`<br>`tag`
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `BonusCritChance` | `Number` | The flat percentage increase to critical hit chance. | 8 | `100`<br>`25`<br>`50` |
| [`{Status and Passive Keys}`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | A generic key for defining a status effect or passive, where the key name is the identifier and the value is its configuration. | 1 | passives<br>class<br>tag |
| [`Fear`](../Reference_and_Meta/Arrays.md#array-fear) | Array / Integer  | The amount of Fear applied, either as a fixed number or an array of [stacks, probability]. | 108 | `1`<br>`10`<br>`2` |
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 0 | Default<br>FormChange<br>Druid |
...
| :--- | :--- | :--- | :--- | :--- |
| [{Status and Passive Keys}](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | Inherits standard status effect and passive mechanics. You can inject any key from the Engine Status and Passive Keys list here to apply buffs, debuffs, or triggered behaviors. | 0 | passives<br>class<br>tag |
| `Imprison` | `String` | Specifies the type of unit or object to summon as a prison. | 6 | `BeefyCharmedLeech`<br>`CharmedLeech`<br>`Fly` |
| [`{Logic Keys}`](../Engine_Scripts_and_Logic/Engine_LogicKeys.md#valid-property-keys) | Variable | Placeholder for logic keys used within the Conditional_Shielded object; no specific examples provided. | 0 | Default<br>FormChange<br>Druid |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `heaviestMelee` | Integer | The minimum damage value to trigger the heaviest melee hit animation. | 5 | `20` |
| `heavyMelee` | Integer | The minimum damage value to trigger a heavy melee hit animation. | 2 | `10` |
...
| :--- | :--- | :--- | :--- | :--- |
| [{Status and Passive Keys}](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#valid-property-keys) | Variable | Inherits standard status effect and passive mechanics. You can inject any key from the Engine Status and Passive Keys list here to apply buffs, debuffs, or triggered behaviors. | 1 | passives<br>class<br>tag |
| `MadnessChanceOnTurnBegin` | `Number` | The chance (as a multiplier) to inflict Madness status at the start of each turn in the next battle. | 2 | `2` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`dying`](../Reference_and_Meta/Enums.md#enum-dying) | Enum | Determines the animation set used when the unit is in a dying state. | 32 | `shot` |
| [`dead`](../Reference_and_Meta/Enums.md#enum-dead) | Enum  | Determines the animation set used when the unit is dead. | 27 | `deadShot` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`from`](../Reference_and_Meta/Enums.md#enum-from) | Enum | Specifies the source equipment item to be transformed. | 5 | `JarOfChaos`<br>`Necro_SoulDagger_Charged`<br>`Necro_SoulDagger_Uncharged` |
| [`to`](../Reference_and_Meta/Enums.md#enum-to) | Enum | Specifies the target equipment item after transformation. | 7 | `JarOfNothing`<br>`Necro_SoulDagger_Charged`<br>`Necro_SoulDagger_Uncharged` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| [`cWaggle`](../Reference_and_Meta/Miscellaneous.md#object-cwaggle) | Object  | Defines a clone variant of the Waggle unit with its own graphics and properties. | 3 | `{ . . . }` |
| [`cWaggle2x2`](../Reference_and_Meta/Miscellaneous.md#object-cwaggle2x2) | Object  | Defines a larger 2x2 tile clone variant of the Waggle unit. | 3 | `{ . . . }` |
| `stacks` | Enum / Equation | Specifies the number of stacks for a temporary status effect, either as a fixed number, a formula string, or by referencing an item's auxiliary value. | 234 | `"floor(lck/4)"`<br>`"max(min(X+1, item_aux), 0)"`<br>`-2` |
| [`cWaggle3x3`](../Reference_and_Meta/Miscellaneous.md#object-cwaggle3x3) | Object  | Defines an even larger 3x3 tile clone variant of the Waggle unit. | 2 | `{ . . . }` |
...
| [`Poison`](../Reference_and_Meta/Arrays.md#array-poison) | Array / Integer  | The amount of Poison applied, either as a fixed number or an array of [stacks, probability]. | 203 | `1`<br>`10`<br>`2` |
| `ChangeTile` | `String` | Specifies the tile type to change to, or an object defining tile change parameters (tile type and area of effect). | 74 | `BlankTile`<br>`BrambleTile`<br>`CreepTile` |
| [`Else`](./Passives_and_Statuses.md#object-else) | Object  | Contains the fallback effects to apply when a preceding conditional check fails. | 86 | `{ . . . }` |
| [`Bleed`](../Reference_and_Meta/Arrays.md#array-bleed) | Array / Integer  | The amount of bleed stacks applied, or an [stacks, probability] array. | 171 | `1`<br>`10`<br>`2` |
| `Shield` | Enum / Equation | The amount of shield granted to the source, absorbing incoming damage. | 109 | `"2*(X-1)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
| `Cleanse` | Integer | The number of stacks of negative status effects removed from the target. | 71 | `0`<br>`1` |
...
| `DamageUp` | Array / Equation | The number of stacks (or a formula string) of a damage buff applied, increasing outgoing damage. | 113 | `"(-ceil(abs(X/2)))"`<br>`"(-ceil(abs(X/3)))"`<br>`-1` |
| [`ApplyToSource`](./Passives_and_Statuses.md#object-applytosource) | Object  | An object of effects that are applied to the source of the ability (the caster). | 59 | `{ . . . }` |
| `BounceObject` | `String` | Specifies the object or projectile to spawn and bounce from the target. | 39 | `AllyRotFly`<br>`Amoeba`<br>`BeefyCharmedLeech` |
| [`Temporary`](./Passives_and_Statuses.md#object-temporary) | Object  | Contains parameters for applying a temporary status effect with specific stacks, turns, and expiration conditions. | 57 | `{ . . . }` |
| `ManaGain` | Equation | The amount of mana restored to the source, which can be an expression. | 40 | `"-ceil(X/2)"`<br>`"max((X-1)*2, 0)"`<br>`"max(X*3, 0)"` |
...
| `OverrideChainKnockback` | `Number` | The custom number of tiles for chain knockback, overriding the default. | 11 | `0`<br>`1`<br>`10` |
...
| `Grappled` | Integer | The number of stacks and probability of applying the Grappled status, in format [stacks, probability] or just stacks. | 9 | `1`<br>`[1, .50]`<br>`[1, .75]` |
| `HealthRegenUp` | Integer | The amount of bonus health regeneration granted to a unit per turn, additive with existing regeneration. | 95 | `1`<br>`2`<br>`3` |
...
| `ForceAttack` | `Number` | If set to 1, forces the target to perform an attack against a random or specified target. | 11 | `1` |
| `Instakill` | `Number` | The amount of damage dealt to instantly kill the target; can be a flat value or a probability array (e.g., [damage, chance]). | 12 | `25`<br>`50`<br>`999` |
| `KnockbackDamageImmuneUntilSettled` | `Number` | If non-zero, makes the target immune to damage from knockback until they stop moving. | 10 | `1` |
...
| [`Conditional_Corpse`](./Passives_and_Statuses.md#object-conditional_corpse) | Object  | Contains an inner effect block that only executes if the target is a corpse. | 11 | `{ . . . }` |
| `ConjureBonusAbility` | `String` | Specifies the name of the bonus ability to conjure. | 8 | `Class`<br>`Colorless`<br>`Mage` |
| [`Craft`](./Passives_and_Statuses.md#object-craft) | Object  | Specifies the loot pool and slot to craft an item for the source. | 20 | `{ . . . }` |
...
| `Metronome` | `Number` | The number of times Metronome triggers, or an object with stacks and banned abilities. | 16 | `1`<br>`2` |
...
| [`Conditional_Object`](./Abilities_and_Spells.md#object-conditional_object) | Object  | Evaluates whether the target is an object (vs a character); if true, applies the effects within; otherwise, runs the Else block. | 6 | `{ . . . }` |
| [`Conditional_PlayerCat`](./Items_and_Equipment.md#object-conditional_playercat) | Object  | Defines effects that only apply if the target is a player-controlled cat. | 7 | `{ . . . }` |
| `FillMana` | `Number` | The amount of mana restored, or an [amount, probability] array. | 11 | `1`<br>`[1 .10]`<br>`[1 .25]` |
| `FlatLeech` | `Number` | The flat amount of health restored to the source when dealing damage, applied after the hit. | 9 | `1`<br>`10`<br>`2` |
| `ForceMoveAway` | `Number` | The distance to force the target away from the source. | 7 | `1` |
| `ForceMoveTowards` | `Number` | The number of tiles to force the target to move toward the caster. | 7 | `1` |
...
| `PopAndSpawn` | `String` | The object (enemy or entity) to spawn on the target's tile, optionally with visual effects. | 6 | `Sprout`<br>`StemCat_HalfHealth`<br>`TheDestroyer` |
| `Purge` | `Number` | The number of status effects to purge from the target. | 10 | `0`<br>`3` |
| `RefreshMovePointsIfHit` | `Number` | The amount of movement points restored on hit. | 5 | `1` |
| `SafeDie` | `Number` | The number of times the unit can survive a fatal hit. | 7 | `1` |
| `SpawnBearTrap` | `Number` | If non-zero, spawns a bear trap on the tile. | 7 | `1` |
...
| `DeleteObject` | `Number` | If set, deletes the target object from the map. | 7 | `1` |
| `DestroyTrinket` | `Number` | The number of trinkets destroyed. | 5 | `1` |
...
| `PullSourceToTarget` | `Number` | The amount of tiles the source is pulled towards the target after the attack. | 4 | `1` |
| `RefreshWeaponAbility` | `Number` | The number of times the weapon's ability is refreshed. | 4 | `1` |
| `RepairAll` | `Number` | The amount of durability restored to all equipped items. | 5 | `1`<br>`10` |
...
| [`ReviveNextRound`](../Reference_and_Meta/Miscellaneous.md#object-revivenextround) | Integer / Object  | The number of revives granted, or an object defining revive properties. | 6 | `{ . . . }`<br>`2` |
| `SpellDamageUp` | Integer | The number of stacks of SpellDamageUp applied, increasing spell damage. | 24 | `1`<br>`3` |
| [`Tangled`](../Reference_and_Meta/Miscellaneous.md#object-tangled) | Integer / Object  | The number of stacks of the Tangled status effect applied, or an object defining its properties such as `stacks` and `alt_art`. | 10 | `{ . . . }`<br>`1`<br>`2`<br>`[1, .05]` |
...
| `BonusKnockbackDamage` | `Number` | The extra damage dealt per tile of knockback. | 4 | `2`<br>`3`<br>`5` |
| `Bound` | `Number` | The number of stacks of the Bound status effect applied to the target. | 2 | `3` |
| `BurgleCoin` | `Number` | The number of coins stolen from the target, or an array of `[number, probability]`. | 6 | `1`<br>`3`<br>`[1 .5]` |
...
| `Counterspell` | `Number` | If non-zero, negates the next incoming enemy spell and triggers the configured counterspell effects. | 6 | `1` |
...
| `LeaveBehindRockOnKnockback` | `Number` | If non-zero, leaves behind a rock on each tile the target is knocked through. | 4 | `1` |
| [`Math`](../Reference_and_Meta/Miscellaneous.md#object-math) | Object  | An object containing a `stacks` value that determines how many times the nested effects are applied. | 6 | `{ . . . }` |
...
| `PermanentStrength` | `Number` | The amount of permanent bonus strength (physical damage modifier) granted. | 5 | `1`<br>`2` |
| `PermanentUpgradeRandomActive` | `Number` | The number of random active abilities permanently upgraded. | 2 | `1`<br>`4` |
| `PullSourceToKnockbackImmuneTarget` | `Number` | The amount of pull force applied to the source toward a knockback-immune target. | 4 | `1` |
...
| `RepairWeaponCondition` | `Number` | The amount of weapon condition restored. | 3 | `1` |
...
| `SetShield` | `Number` | Sets the target's shield value to a specific flat amount. | 3 | `0`<br>`88` |
| `Shatter` | `Number` | The amount of damage dealt when a frozen or petrified status is shattered, or a template definition for a Shatter ability. | 5 | `15` |
| `SignalFinalBossShieldBroke` | `Number` | If set to a non-zero number, signals that the final boss's shield has been broken. | 2 | `1` |
| `SmartMetronome` | `Number` | The number of stacks of a buff that increases damage by a percentage, with an optional upgrade flag. | 8 | `20` |
| `SpeculativeMoveSelfCorpseOffMap` | `Number` | If true, attempts to remove the character's corpse from the map, used for speculative AI targeting. | 3 | `1` |
| `StanceSwitchToMelee` | `Number` | If set, switches the source to melee stance. | 3 | `1` |
...
| `TempTrampleUntilSettled` | `Number` | The number of stacks of temporary Trample applied to the source, allowing movement through enemies until the source ends its turn. | 3 | `3` |
| `TradeLife` | `Number` | The amount of health life traded, or a template for a TradeLife ability. | 6 | `1` |
...
| [`BodyGuard`](../Reference_and_Meta/Miscellaneous.md#object-bodyguard) | Object  | An object that applies a bodyguard status, optionally linking to a swap ability. | 8 | `{ . . . }` |
| `CritChanceUp` | Integer | The amount of critical hit chance added as a flat percentage. | 50 | `1`<br>`10`<br>`100` |
| `DiminishingHealthRegen` | Integer | The number of diminishing health regen stacks applied. | 12 | `1`<br>`2`<br>`3` |
...
| `TrailBlazer` | Enum / Integer | The number of trail blazer stacks applied, or a string alias like 'mov'. | 5 | `1`<br>`mov` |
| `Trample` | Integer | The amount of bonus damage dealt when moving through an enemy. | 127 | `1`<br>`3`<br>`4` |
...
| `BombRatTurtle` | `Number` | The number of bomb rat turtle spawns triggered. | 4 | `1` |
...
| [`Conditional_Displaceable`](./Abilities_and_Spells.md#object-conditional_displaceable) | Object  | Contains an inner effect block that only executes if the target can be displaced (knocked back). | 2 | `{ . . . }` |
| [`Conditional_HasCleansableDebuffs`](../Engine_Scripts_and_Logic/Engine_StatusAndPassiveKeys.md#object-conditional_hascleansabledebuffs) | Object  | An object containing effects that execute only if the unit has cleansable debuffs. | 2 | `{ . . . }` |
...
| [`Conditional_RandomChance`](./Items_and_Equipment.md#object-conditional_randomchance) | Object  | An object containing effects that execute only if a random roll succeeds, with an odds value defined inside. | 4 | `{ . . . }` |
...
| `Disguised` | `Number` | If true, the unit is disguised, appearing as a different faction or model. | 2 | `1` |
...
| `DoubleCastSpellsEachTurn_Status` | `Number` | The number of turns the unit gains Double Cast for spells each turn. | 2 | `1` |
...
| `Enlarge` | `Number` | The number of turns the unit is enlarged, increasing its size and stats. | 3 | `3` |
| `EnterMount` | `String` | Specifies the name of the mount status to apply to the unit. | 2 | `enter` |
| `ExistUntilIdleUpkeep` | `Number` | If true, the entity persists until the source unit enters idle upkeep. | 2 | `1` |
| `ExplodeCharacter` | `Number` | The radius (in tiles) of an explosion centered on the character. | 2 | `5` |
...
| [`NextBasicAttackCritsThisTurn`](../Reference_and_Meta/Miscellaneous.md#object-nextbasicattackcritsthisturn) | Object  | An object or number configuring the next basic attack to be a critical hit this turn. An object may contain stack, cant_miss, or piercing sub-keys. | 3 | `{ . . . }` |
...
| `PermanentCharisma` | `Number` | The amount of permanent Charisma added to the unit's base stats. | 3 | `1`<br>`2` |
| `PermanentLuck` | `Number` | The amount of permanent Luck added to the unit's base stats. | 3 | `1`<br>`2` |
...
| `SmellBlood` | `Number` | If non-zero, activates the Smell Blood ability which reveals nearby injured units. | 5 | `1` |
...
| `SplashDamage` | `Number` | The radius (in tiles) for splash damage applied to adjacent targets. | 2 | `1`<br>`2` |
| `StackingSandstorm` | `Number` | If non-zero, enables the stacking sandstorm mechanic which increases damage per stack. | 2 | `1` |
...
| `SwapHighestAndLowestStat` | `Number` | If non-zero, swaps the unit's highest base stat value with its lowest. | 2 | `1` |
...
| `TempLuckUp` | `Number` | The amount of temporary luck increase. | 2 | `2`<br>`99` |
...
| [`TransformEquipment`](../Reference_and_Meta/Miscellaneous.md#object-transformequipment) | Object  | Defines an equipment transformation from one item to another, with 'from' and 'to' sub-keys. | 2 | `{ . . . }` |
...
| [`WaggleClone`](../Reference_and_Meta/Miscellaneous.md#object-waggleclone) | Object  | Defines a waggle clone ability with health thresholds and object sizes. | 4 | `{ . . . }` |
| `Attraction` | Integer | The number of stacks of Attraction applied, drawing enemy units toward the target. | 4 | `1` |
...
| [`ChangeTilesUnder`](../Reference_and_Meta/Enums.md#enum-changetilesunder) | Enum  | The tile type to change the ground tiles under the target to. | 9 | `DirtTile`<br>`GlassTile`<br>`LavaTile` |
| `ChargeFists` | Integer | The number of charge stacks applied to unarmed attacks. | 6 | `1` |
| [`CreateGlobalModifiers`](./Passives_and_Statuses.md#object-createglobalmodifiers) | Object  | Defines global gameplay modifiers to activate. | 5 | `{ . . . }` |
...
| `EmptyMind` | Integer | The number of Empty Mind stacks, likely disabling special abilities. | 6 | `1` |
| `ExtraBasicMoves_Status` | Integer | The number of extra basic moves per turn granted. | 6 | `1` |
| `FireArmor` | Integer | The number of Fire Armor stacks providing damage reflection. | 6 | `1` |
| `FireArmor2` | Integer | The number of Fire Armor2 stacks (likely a variant). | 4 | `1` |
| [`ForceUseAbility`](../Reference_and_Meta/Enums.md#enum-forceuseability) | Enum  | The name of the ability the source is forced to use, optionally with a chance. | 33 | `CancerExplode`<br>`DustDash`<br>`Hallucinate_Disorder` |
| [`GainCoinsRange`](../Reference_and_Meta/Miscellaneous.md#object-gaincoinsrange) | Object  | An object with `min` and `max` fields specifying a range for the amount of coins gained. | 11 | `{ . . . }` |
| `HealRandomInjury` | Integer | The number of random injuries healed on the target. | 4 | `1` |
| `HeavyHits` | Integer | The number of Heavy Hits stacks increasing attack impact. | 2 | `1` |
| `IceArmor` | Integer | The number of Ice Armor stacks granting defensive properties. | 7 | `1` |
| `Infested` | Integer | The number of stacks of Infested applied. | 15 | `1` |
...
| `Regurge` | Integer | The number of regurgitation triggers. | 5 | `1` |
...
| `ShortCircuit` | Integer | The number of stacks of the ShortCircuit status effect. | 7 | `1` |
...
| `Switcheroo` | Integer | The number of stacks of the Switcheroo status effect. | 5 | `1` |
