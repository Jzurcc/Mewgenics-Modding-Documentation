...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| [`cat_choice`](./Enums.md#enum-cat_choice) | Enum | {'type': '`Enum/String`', 'df': ''} | 214 |
| [`event_clip`](./Enums.md#enum-event_clip) | Enum | {'type': '`Enum/String`', 'df': ''} | 214 |
| [`subject_clip`](./Enums.md#enum-subject_clip) | Enum | {'type': '`Enum/String`', 'df': ''} | 214 |
| [`subject_frame`](./Enums.md#enum-subject_frame) | Enum | {'type': '`Enum/String`', 'df': ''} | 214 |
| [`title`](./Strings.md#string-title) | String | {'type': '`String`', 'df': ''} | 214 |
| [`choose_cat_with_item`](./Enums.md#enum-choose_cat_with_item) | Enum | {'type': '`Enum/String`', 'df': ''} | 17 |
| `different_from_last_x_cats` | Number | {'type': '`Number`', 'df': ''} | 3 |
| `subject_frame_inner` | Number | {'type': '`Number`', 'df': ''} | 3 |
| [`choose_cat_with_highest_stat`](./Math_Equations.md) | Equation | {'type': '`Enum/String`', 'df': ''} | 1 |
| [`choose_cat_with_item_slot_equipped`](./Enums.md#enum-choose_cat_with_item_slot_equipped) | Enum | {'type': '`Enum/String`', 'df': ''} | 1 |
...
| [`destroy`](./Events_and_Encounters.md#context-destroy) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Destroy\' action. | 13 |
| [`bash`](./Events_and_Encounters.md#context-bash) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Bash\' action. | 12 |
| [`sneak`](./Events_and_Encounters.md#context-sneak) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Sneak\' action. | 11 |
| [`open`](./Events_and_Encounters.md#context-open) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Open\' action. | 8 |
| [`take`](./Events_and_Encounters.md#context-take) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Take\' action. | 8 |
| [`a`](./Events_and_Encounters.md#context-a) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'A\' action. | 7 |
| [`attack`](./Events_and_Encounters.md#context-attack) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Attack\' action. | 7 |
| [`b`](./Events_and_Encounters.md#context-b) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'B\' action. | 7 |
| [`c`](./Events_and_Encounters.md#context-c) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'C\' action. | 7 |
| [`charm`](./Events_and_Encounters.md#context-charm) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Charm\' action. | 7 |
| [`fight`](./Events_and_Encounters.md#context-fight) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Fight\' action. | 7 |
| [`touch`](./Events_and_Encounters.md#context-touch) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Touch\' action. | 7 |
| [`activate_p`](./Events_and_Encounters.md#context-activate_p) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Activate P' action. | 6 |
| [`activate_z`](./Events_and_Encounters.md#context-activate_z) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Activate Z' action. | 6 |
| [`d`](./Events_and_Encounters.md#context-d) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'D\' action. | 6 |
| [`enter`](./Events_and_Encounters.md#context-enter) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Enter\' action. | 6 |
| [`inspect`](./Events_and_Encounters.md#context-inspect) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Inspect\' action. | 6 |
| [`lick`](./Events_and_Encounters.md#context-lick) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Lick\' action. | 6 |
...
| [`copy`](./Events_and_Encounters.md#context-copy) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Copy\' action. | 2 |
| [`find_another_way`](./Events_and_Encounters.md#context-find_another_way) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Find Another Way\' action. | 2 |
| [`move_closer`](./Events_and_Encounters.md#context-move_closer) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Move Closer\' action. | 2 |
| [`play`](./Events_and_Encounters.md#context-play) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Play\' action. | 2 |
| [`poop`](./Events_and_Encounters.md#context-poop) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Poop\' action. | 2 |
| [`print`](./Events_and_Encounters.md#context-print) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Print\' action. | 2 |
...
| [`attach_leech`](./Events_and_Encounters.md#context-attach_leech) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Attach Leech' action. | 1 |
| [`bash_past_alt`](./Events_and_Encounters.md#context-bash_past_alt) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Bash Past Alt\' action. | 1 |
| [`bite_it_off`](./Events_and_Encounters.md#context-bite_it_off) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Bite It Off\' action. | 1 |
| [`blue`](./Events_and_Encounters.md#context-blue) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Blue\' action. | 1 |
| [`blue_needle`](./Events_and_Encounters.md#context-blue_needle) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Blue Needle\' action. | 1 |
| [`body`](./Events_and_Encounters.md#context-body) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Body' action. | 1 |
| [`book`](./Events_and_Encounters.md#context-book) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Book\' action. | 1 |
| [`brace`](./Events_and_Encounters.md#context-brace) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Brace\' action. | 1 |
| [`break_ice`](./Events_and_Encounters.md#context-break_ice) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Break Ice\' action. | 1 |
| [`break_lock`](./Events_and_Encounters.md#context-break_lock) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Break Lock\' action. | 1 |
| [`bribe`](./Events_and_Encounters.md#context-bribe) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Bribe' action. | 1 |
| [`button`](./Events_and_Encounters.md#context-button) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Button\' action. | 1 |
| [`buy1`](./Events_and_Encounters.md#context-buy1) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Buy1\' action. | 1 |
| [`catch`](./Events_and_Encounters.md#context-catch) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Catch\' action. | 1 |
| [`challenge_to_game`](./Events_and_Encounters.md#context-challenge_to_game) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Challenge To Game\' action. | 1 |
| [`chaos_ending`](./Events_and_Encounters.md#context-chaos_ending) | Block | {'type': '`Block`', 'df': 'Event Node: Triggers the Chaos Boss victory sequence. | 1 |
| [`chapter_cutscene`](./Events_and_Encounters.md#context-chapter_cutscene) | Block | {'type': '`Block`', 'df': 'Event Node: Triggers an intermission cutscene. | 1 |
| [`charm_past_alt`](./Events_and_Encounters.md#context-charm_past_alt) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Charm Past Alt\' action. | 1 |
| [`climb`](./Events_and_Encounters.md#context-climb) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Climb\' action. | 1 |
| [`comfort`](./Events_and_Encounters.md#context-comfort) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Comfort\' action. | 1 |
| [`communicate`](./Events_and_Encounters.md#context-communicate) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Communicate\' action. | 1 |
| [`concheck`](./Events_and_Encounters.md#context-concheck) | Block | {'type': '`Block`', 'df': 'Event Node: Stat check branch evaluating the \'con\' attribute. | 1 |
| [`counter`](./Events_and_Encounters.md#context-counter) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Counter\' action. | 1 |
| [`crack_open`](./Events_and_Encounters.md#context-crack_open) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Crack Open\' action. | 1 |
| [`cross`](./Events_and_Encounters.md#context-cross) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Cross\' action. | 1 |
| [`cut_wires`](./Events_and_Encounters.md#context-cut_wires) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Cut Wires\' action. | 1 |
| [`damage_1`](./Events_and_Encounters.md#context-damage_1) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Damage 1\' action. | 1 |
| [`damage_full`](./Events_and_Encounters.md#context-damage_full) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Damage Full\' action. | 1 |
| [`damage_half`](./Events_and_Encounters.md#context-damage_half) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Damage Half\' action. | 1 |
| [`desert_cutscene`](./Events_and_Encounters.md#context-desert_cutscene) | Block | {'type': '`Block`', 'df': 'Event Node: Triggers the desert transition cutscene. | 1 |
| [`dexcheck`](./Events_and_Encounters.md#context-dexcheck) | Block | {'type': '`Block`', 'df': 'Event Node: Stat check branch evaluating the \'dex\' attribute. | 1 |
| [`dig`](./Events_and_Encounters.md#context-dig) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Dig\' action. | 1 |
| [`disarm`](./Events_and_Encounters.md#context-disarm) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Disarm\' action. | 1 |
| [`dive`](./Events_and_Encounters.md#context-dive) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Dive\' action. | 1 |
| [`donate`](./Events_and_Encounters.md#context-donate) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Donate\' action. | 1 |
| [`donate_10`](./Events_and_Encounters.md#context-donate_10) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Donate 10\' action. | 1 |
| [`donate_15`](./Events_and_Encounters.md#context-donate_15) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Donate 15\' action. | 1 |
| [`donate_20`](./Events_and_Encounters.md#context-donate_20) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Donate 20\' action. | 1 |
| [`donate_5`](./Events_and_Encounters.md#context-donate_5) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Donate 5\' action. | 1 |
| [`double`](./Events_and_Encounters.md#context-double) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Double\' action. | 1 |
| [`eat_meat`](./Events_and_Encounters.md#context-eat_meat) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Eat Meat\' action. | 1 |
| [`enter_crater`](./Events_and_Encounters.md#context-enter_crater) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Enter Crater\' action. | 1 |
| [`face`](./Events_and_Encounters.md#context-face) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Face\' action. | 1 |
| [`fiddle`](./Events_and_Encounters.md#context-fiddle) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Fiddle' action. | 1 |
| [`fill_jar`](./Events_and_Encounters.md#context-fill_jar) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Fill Jar' action. | 1 |
| [`find`](./Events_and_Encounters.md#context-find) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Find\' action. | 1 |
| [`fire`](./Events_and_Encounters.md#context-fire) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Fire\' action. | 1 |
| [`flush_yourself`](./Events_and_Encounters.md#context-flush_yourself) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Flush Yourself\' action. | 1 |
...
| [`head`](./Events_and_Encounters.md#context-head) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Head\' action. | 1 |
| [`holy`](./Events_and_Encounters.md#context-holy) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Holy\' action. | 1 |
| [`hp`](./Events_and_Encounters.md#context-hp) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Hp\' action. | 1 |
| [`ice`](./Events_and_Encounters.md#context-ice) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Ice\' action. | 1 |
| [`infinite`](./Events_and_Encounters.md#context-infinite) | Block | {'type': '`Block`', 'df': "Event Node: A looping or endlessly repeating story branch. | 1 |
| [`intcheck`](./Events_and_Encounters.md#context-intcheck) | Block | {'type': '`Block`', 'df': 'Event Node: Stat check branch evaluating the \'int\' attribute. | 1 |
| [`intimidation`](./Events_and_Encounters.md#context-intimidation) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Intimidation\' action. | 1 |
| [`itchies`](./Events_and_Encounters.md#context-itchies) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Itchies\' action. | 1 |
| [`join`](./Events_and_Encounters.md#context-join) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Join\' action. | 1 |
| [`jump`](./Events_and_Encounters.md#context-jump) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Jump\' action. | 1 |
| [`jump_over`](./Events_and_Encounters.md#context-jump_over) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Jump Over\' action. | 1 |
| [`keep_going`](./Events_and_Encounters.md#context-keep_going) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Keep Going\' action. | 1 |
| [`kiss_meat`](./Events_and_Encounters.md#context-kiss_meat) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Kiss Meat\' action. | 1 |
| [`knife`](./Events_and_Encounters.md#context-knife) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Knife\' action. | 1 |
| [`label`](./Strings.md#string-label) | String | {'type': 'String', 'df': ''} | 1 |
| [`leave_it_in`](./Events_and_Encounters.md#context-leave_it_in) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Leave It In\' action. | 1 |
| [`leg`](./Events_and_Encounters.md#context-leg) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Leg\' action. | 1 |
| [`lever`](./Events_and_Encounters.md#context-lever) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Lever\' action. | 1 |
| [`lick_alt`](./Events_and_Encounters.md#context-lick_alt) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Lick Alt\' action. | 1 |
| [`lightning`](./Events_and_Encounters.md#context-lightning) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Lightning\' action. | 1 |
| [`listen`](./Events_and_Encounters.md#context-listen) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Listen\' action. | 1 |
| [`looks`](./Events_and_Encounters.md#context-looks) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Looks' action. | 1 |
| [`loot_heart`](./Events_and_Encounters.md#context-loot_heart) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Loot Heart' action. | 1 |
| [`makeup`](./Events_and_Encounters.md#context-makeup) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Makeup\' action. | 1 |
| [`mind`](./Events_and_Encounters.md#context-mind) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Mind' action. | 1 |
| [`neck`](./Events_and_Encounters.md#context-neck) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Neck\' action. | 1 |
| [`nothanks`](./Events_and_Encounters.md#context-nothanks) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Nothanks\' action. | 1 |
| [`outsmart`](./Events_and_Encounters.md#context-outsmart) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Outsmart\' action. | 1 |
| [`patch_up`](./Events_and_Encounters.md#context-patch_up) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Patch Up\' action. | 1 |
| [`pick_lock`](./Events_and_Encounters.md#context-pick_lock) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Pick Lock\' action. | 1 |
...
| [`pull_lever`](./Events_and_Encounters.md#context-pull_lever) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Pull Lever\' action. | 1 |
| [`purify`](./Events_and_Encounters.md#context-purify) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Purify\' action. | 1 |
| [`push_buttons`](./Events_and_Encounters.md#context-push_buttons) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Push Buttons\' action. | 1 |
| [`push_through`](./Events_and_Encounters.md#context-push_through) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Push Through\' action. | 1 |
| [`put_in_coins`](./Events_and_Encounters.md#context-put_in_coins) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Put In Coins\' action. | 1 |
| [`put_out_of_misery`](./Events_and_Encounters.md#context-put_out_of_misery) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Put Out Of Misery\' action. | 1 |
| [`reach_inside`](./Events_and_Encounters.md#context-reach_inside) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Reach Inside\' action. | 1 |
| [`read`](./Events_and_Encounters.md#context-read) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Read\' action. | 1 |
| [`receive`](./Events_and_Encounters.md#context-receive) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Receive\' action. | 1 |
| [`red`](./Events_and_Encounters.md#context-red) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Red\' action. | 1 |
| [`red_needle`](./Events_and_Encounters.md#context-red_needle) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Red Needle\' action. | 1 |
| [`reflect`](./Events_and_Encounters.md#context-reflect) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Reflect\' action. | 1 |
| [`remove`](./Events_and_Encounters.md#context-remove) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Remove\' action. | 1 |
| [`remove_the_nail`](./Events_and_Encounters.md#context-remove_the_nail) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Remove The Nail\' action. | 1 |
| [`repair_quest`](./Events_and_Encounters.md#context-repair_quest) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Repair Quest' action. | 1 |
| [`rest`](./Events_and_Encounters.md#context-rest) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Rest\' action. | 1 |
| [`revive`](./Events_and_Encounters.md#context-revive) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Revive\' action. | 1 |
| [`rub`](./Events_and_Encounters.md#context-rub) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Rub\' action. | 1 |
| [`run_again`](./Events_and_Encounters.md#context-run_again) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Run Again\' action. | 1 |
| [`run_away`](./Events_and_Encounters.md#context-run_away) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Run Away\' action. | 1 |
| [`sacrifice_full_favor`](./Events_and_Encounters.md#context-sacrifice_full_favor) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Sacrifice Full Favor\' action. | 1 |
| [`sacrifice_normal`](./Events_and_Encounters.md#context-sacrifice_normal) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Sacrifice Normal' action. | 1 |
...
| [`sneak_past_alt`](./Events_and_Encounters.md#context-sneak_past_alt) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Sneak Past Alt\' action. | 1 |
| [`soul`](./Events_and_Encounters.md#context-soul) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Soul' action. | 1 |
| [`speed`](./Events_and_Encounters.md#context-speed) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Speed\' action. | 1 |
| [`stat`](./Enums.md#enum-stat) | Enum | {'type': 'Enum/String', 'df': ''} | 1 |
| `stat_max` | Number | {'type': 'Number', 'df': ''} | 1 |
| `stat_min` | Number | {'type': 'Number', 'df': ''} | 1 |
| [`surprise`](./Events_and_Encounters.md#context-surprise) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Surprise\' action. | 1 |
| [`sweet_talk`](./Events_and_Encounters.md#context-sweet_talk) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Sweet Talk\' action. | 1 |
| [`swim`](./Events_and_Encounters.md#context-swim) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Swim\' action. | 1 |
| [`tail`](./Events_and_Encounters.md#context-tail) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Tail\' action. | 1 |
| [`take_blood`](./Events_and_Encounters.md#context-take_blood) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Take Blood' action. | 1 |
| [`talk`](./Events_and_Encounters.md#context-talk) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Talk' action. | 1 |
| [`talk_to`](./Events_and_Encounters.md#context-talk_to) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Talk To\' action. | 1 |
| [`tappytoes`](./Events_and_Encounters.md#context-tappytoes) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Tappytoes\' action. | 1 |
| [`teleport`](./Events_and_Encounters.md#context-teleport) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Teleport\' action. | 1 |
| [`thorns`](./Events_and_Encounters.md#context-thorns) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Thorns\' action. | 1 |
| [`throw`](./Events_and_Encounters.md#context-throw) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Throw\' action. | 1 |
| [`timemachine`](./Events_and_Encounters.md#context-timemachine) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Timemachine\' action. | 1 |
| [`traverse`](./Events_and_Encounters.md#context-traverse) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Traverse\' action. | 1 |
| [`upgrade_yourself`](./Events_and_Encounters.md#context-upgrade_yourself) | Block | {'type': '`Block`', 'df': 'Event Reward: Upgrades an existing ability or item. | 1 |
| [`use_item`](./Events_and_Encounters.md#context-use_item) | Block | {'type': '`Block`', 'df': 'Event Requirement: Requires the player to consume a specific item to proceed. | 1 |
| [`use_toilet_con`](./Events_and_Encounters.md#context-use_toilet_con) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Use Toilet Con\' action. | 1 |
| [`use_toilet_str`](./Events_and_Encounters.md#context-use_toilet_str) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Use Toilet Str\' action. | 1 |
| [`use_weapon`](./Events_and_Encounters.md#context-use_weapon) | Block | {'type': '`Block`', 'df': 'Event Requirement: Uses the properties of the equipped weapon to resolve an outcome. | 1 |
| [`w1`](./Events_and_Encounters.md#context-w1) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'W1\' action. | 1 |
| [`w2`](./Events_and_Encounters.md#context-w2) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'W2\' action. | 1 |
| [`w3`](./Events_and_Encounters.md#context-w3) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'W3\' action. | 1 |
| [`w4`](./Events_and_Encounters.md#context-w4) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'W4\' action. | 1 |
| [`w5`](./Events_and_Encounters.md#context-w5) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'W5\' action. | 1 |
| [`w6`](./Events_and_Encounters.md#context-w6) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'W6\' action. | 1 |
| [`wealth`](./Events_and_Encounters.md#context-wealth) | Block | {'type': '`Block`', 'df': "Event Node: Story branch or dialog option representing the 'Wealth' action. | 1 |
| [`wheezies`](./Events_and_Encounters.md#context-wheezies) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Wheezies\' action. | 1 |
| [`wish_genes`](./Events_and_Encounters.md#context-wish_genes) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Wish Genes\' action. | 1 |
| [`wish_items`](./Events_and_Encounters.md#context-wish_items) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Wish Items\' action. | 1 |
| [`wish_levelups`](./Events_and_Encounters.md#context-wish_levelups) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Wish Levelups\' action. | 1 |
| [`wish_strength`](./Events_and_Encounters.md#context-wish_strength) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Wish Strength\' action. | 1 |
| [`withstand`](./Events_and_Encounters.md#context-withstand) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Withstand\' action. | 1 |
| [`yank_it_out`](./Events_and_Encounters.md#context-yank_it_out) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Yank It Out\' action. | 1 |
| [`yellow_needle`](./Events_and_Encounters.md#context-yellow_needle) | Block | {'type': '`Block`', 'df': 'Event Node: Story branch or dialog option representing the \'Yellow Needle\' action. | 1 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| [`has_token`](./Enums.md#enum-has_token) | Enum | {'type': '`Enum/String`', 'df': ''} | 80 |
| [`counter_range`](./Arrays.md#array-counter_range) | Array | {'type': '`Array`', 'df': ''} | 37 |
| [`not_has_token`](./Enums.md#enum-not_has_token) | Enum | {'type': '`Enum/String`', 'df': ''} | 30 |
| [`counter_minimum`](./Arrays.md#array-counter_minimum) | Array | {'type': '`Array`', 'df': ''} | 25 |
| [`cat_has_item_equipped`](./Enums.md#enum-cat_has_item_equipped) | Enum | {'type': '`Enum/String`', 'df': ''} | 22 |
| [`counter_maximum`](./Arrays.md#array-counter_maximum) | Array | {'type': '`Array`', 'df': ''} | 18 |
| [`is_not_chapter`](./Arrays.md#array-is_not_chapter) | Array | {'type': '`Array`', 'df': ''} | 16 |
| [`is_chapter`](./Arrays.md#array-is_chapter) | Array | {'type': '`Array`', 'df': ''} | 8 |
| `minimum_party_size` | Number | {'type': '`Number`', 'df': ''} | 2 |
| [`not_cat_has_item_equipped`](./Enums.md#enum-not_cat_has_item_equipped) | Enum | {'type': '`Enum/String`', 'df': ''} | 2 |
| `not_on_quest` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `cat_has_injury_count_min` | Number | {'type': '`Number`', 'df': ''} | 1 |
| [`cat_has_item_slot_equipped`](./Enums.md#enum-cat_has_item_slot_equipped) | Enum | {'type': '`Enum/String`', 'df': ''} | 1 |
| `cat_has_parasite` | Boolean | {'type': '`Boolean`', 'df': ''} | 1 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `con` | Number | {'type': '`Number`', 'df': ''} | 35 |
| `random` | Number | {'type': '`Number`', 'df': ''} | 25 |
| `int` | Number | {'type': '`Number`', 'df': ''} | 21 |
| `lck` | Number | {'type': '`Number`', 'df': ''} | 18 |
| `spd` | Number | {'type': '`Number`', 'df': ''} | 18 |
| `str` | Number | {'type': '`Number`', 'df': ''} | 16 |
| `cha` | Mixed | {'type': '`Enum/String`', 'df': ''} | 14 |
| `dex` | Number | {'type': '`Number`', 'df': ''} | 9 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `count` | Number | {'type': '`Number`', 'df': 'Quantity.'} | 15 |
| [`tag`](./Enums.md#enum-tag) | Enum | {'type': '`Enum/String`', 'df': 'Specific entity tag required.'} | 12 |
| `asymmetric` | Boolean | {'type': '`Boolean`', 'df': ''} | 8 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| [`object`](./Arrays.md#array-object) | Array | {'type': '`Enum/String`', 'df': ''} | 40 |
| [`count`](./Arrays.md#array-count) | Array | {'type': '`Number`', 'df': 'Quantity.'} | 34 |
| [`spawn_side`](./Enums.md#enum-spawn_side) | Enum | {'type': '`Enum/String`', 'df': ''} | 31 |
| [`side`](./Enums.md#enum-side) | Enum | {'type': '`Enum/String`', 'df': ''} | 3 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `eyes` | Number | {'type': '`Number`', 'df': ''} | 12 |
| `mouth` | Number | {'type': '`Number`', 'df': ''} | 11 |
| `ears` | Number | {'type': '`Number`', 'df': ''} | 10 |
| `eyebrows` | Number | {'type': '`Number`', 'df': ''} | 8 |
| `head` | Number | {'type': '`Number`', 'df': "Event Node: Story branch or dialog option representing the 'Head' action."} | 7 |
| `legs` | Number | {'type': '`Number`', 'df': ''} | 7 |
| `arms` | Number | {'type': '`Number`', 'df': ''} | 6 |
| `body` | Number | {'type': '`Number`', 'df': "Event Node: Story branch or dialog option representing the 'Body' action."} | 6 |
| `tail` | Number | {'type': '`Number`', 'df': "Event Node: Story branch or dialog option representing the 'Tail' action."} | 6 |
| `eye1` | Number | {'type': '`Number`', 'df': ''} | 3 |
| `arm1` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `ear1` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `eyebrow1` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `leg1` | Number | {'type': '`Number`', 'df': ''} | 2 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `mouth` | Number | {'type': '`Number`', 'df': ''} | 9 |
| `count` | Number | {'type': '`Number`', 'df': 'Quantity.'} | 8 |
| `tail` | Number | {'type': '`Number`', 'df': "Event Node: Story branch or dialog option representing the 'Tail' action."} | 7 |
| `ears` | Number | {'type': '`Number`', 'df': ''} | 5 |
| `eyes` | Number | {'type': '`Number`', 'df': ''} | 5 |
| `legs` | Number | {'type': '`Number`', 'df': ''} | 5 |
| `body` | Number | {'type': '`Number`', 'df': "Event Node: Story branch or dialog option representing the 'Body' action."} | 4 |
| `eyebrows` | Number | {'type': '`Number`', 'df': ''} | 3 |
| `head` | Number | {'type': '`Number`', 'df': "Event Node: Story branch or dialog option representing the 'Head' action."} | 3 |
| `arm1` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `arm2` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `leg1` | Number | {'type': '`Number`', 'df': ''} | 1 |
| `leg2` | Number | {'type': '`Number`', 'df': ''} | 1 |
| `texture` | Number | {'type': '`Number`', 'df': ''} | 1 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `fights_skipped` | Number | {'type': '`Number`', 'df': ''} | 7 |
| [`return_as`](./Enums.md#enum-return_as) | Enum | {'type': '`Enum/String`', 'df': ''} | 3 |
| [`return_during`](./Enums.md#enum-return_during) | Enum | {'type': '`Enum/String`', 'df': ''} | 3 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| [`event`](./Enums.md#enum-event) | Enum | {'type': '`Enum/String`', 'df': ''} | 5 |
| `same_cat` | Boolean | {'type': '`Boolean`', 'df': ''} | 5 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `cha` | Number | {'type': '`Number`', 'df': ''} | 4 |
| `con` | Number | {'type': '`Number`', 'df': ''} | 4 |
| `dex` | Number | {'type': '`Number`', 'df': ''} | 4 |
| `int` | Number | {'type': '`Number`', 'df': ''} | 4 |
| `lck` | Number | {'type': '`Number`', 'df': ''} | 4 |
| `spd` | Number | {'type': '`Number`', 'df': ''} | 4 |
| `str` | Number | {'type': '`Number`', 'df': ''} | 4 |
...
| [`hint_chapter_exit`](./Enums.md#enum-hint_chapter_exit) | Enum | {'type': '`Enum/String`', 'df': ''} | 4 |
| [`label`](./Enums.md#enum-label) | Enum | {'type': '`Enum/String`', 'df': ''} | 4 |
| [`requirements`](./Events_and_Encounters.md#context-requirements) | Block | {'type': '`Block`', 'df': 'Event Block: Pre-requisites (e.g., minimum gold, specific item, or minimum stat value) needed to select an option. | 4 |
| [`stat`](./Enums.md#enum-stat) | Enum | {'type': '`Enum/String`', 'df': ''} | 4 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `count` | Number | {'type': '`Number`', 'df': 'Quantity.'} | 2 |
| `ears` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `eyebrows` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `eyes` | Number | {'type': '`Number`', 'df': ''} | 2 |
| `mouth` | Number | {'type': '`Number`', 'df': ''} | 2 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| `initial_health` | Number | {'type': '`Number`', 'df': ''} | 1 |
| [`object`](./Enums.md#enum-object) | Enum | {'type': '`Enum/String`', 'df': ''} | 1 |
