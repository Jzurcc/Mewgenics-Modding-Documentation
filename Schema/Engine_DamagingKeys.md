...
> **Referenced by:** [`damage_instance` (Abilities_and_Spells)](./Abilities_and_Spells.md#object-damage_instance), [`self_damage` (Abilities_and_Spells)](./Abilities_and_Spells.md#object-self_damage), [`splash_damage` (Abilities_and_Spells)](./Abilities_and_Spells.md#object-splash_damage), [`bonk_damage` (Abilities_and_Spells)](./Abilities_and_Spells.md#object-bonk_damage), [`damage_instance` (Characters_and_Bosses)](./Characters_and_Bosses.md#object-damage_instance), [`damage_instance` (Items_and_Equipment)](./Items_and_Equipment.md#object-damage_instance)
