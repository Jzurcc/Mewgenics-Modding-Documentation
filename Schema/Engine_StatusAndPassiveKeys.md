...
| [`self_status_next_fight`](#self_status_next_fight) | Block | Event Penalty/Reward: Applies a status effect specifically to the character that triggered the event during the next combat encounter. | 143 |
| [`bonus_passives`](#bonus_passives) | Block | Passives granted to the character while this ability is equipped. | 138 |
...
| [`SpawnOnDeath`](./Enums.md#enum-spawnondeath) | Block | Event Trigger: Spawns a specific entity when killed. | 81 |
| [`{Damaging Keys}`](./Engine_DamagingKeys.md#valid-property-keys) | Block | All valid keys from the specified engine key are applicable to this context/block. | 76 |
...
| [`passives`](#passives) | Block | Examples: `{ ... }` | 53 |
...
| [`RevengeDamage`](#revengedamage) | Block | Reaction trigger: Deals damage to the attacker when hit. | 31 |
...
| [`party_status_next_fight`](#party_status_next_fight) | Block | Event Penalty/Reward: Applies a status effect to the entire party at the start of the next combat encounter. | 24 |
| `water` | Variable |  | 24 |
...
| [`threshold`](#threshold) | Block | Examples: `4*champion_multiplier, 3*champion_multiplier, 1` | 22 |
...
| [`additional_passives`](#additional_passives) | Block | Passives granted intrinsically to a spawned entity. | 20 |
...
| [`FindItemFromPool`](./Enums.md#enum-finditemfrompool) | Block | Generates an item drop from the specified loot pool. | 19 |
...
| [`PassiveWhenAffectedByElement`](#passivewhenaffectedbyelement) | Block | Examples: `{ ... }` | 18 |
...
| `Conditional_GoodRoll` | Block | Conditional trigger: Executes nested logic based on a randomized favorable outcome probability. | 17 |
| `LuckUp` | Number | Applies or references the 'LuckUp' effect/state. | 17 |
| `RandomMagicMissile` | Block | Fires a randomized number of magic missiles. | 17 |
...
| [`statuses`](#statuses) | Block | Status effects possessed by the character. | 14 |
...
| [`DeathRattleRevive`](./Enums.md#enum-deathrattlerevive) | Block | Event Trigger: Revives the character immediately upon death. | 13 |
...
| [`ObjectOnHitCharacter`](./Enums.md#enum-objectonhitcharacter) | Block | Spawns a specific character or entity upon impact. | 12 |
...
| [`AddStatusToBasicMeleeAttack`](#addstatustobasicmeleeattack) | Block | Examples: `{ ... }` | 11 |
...
| [`DepressionAura`](#depressionaura) | Block | Examples: `1` | 10 |
...
| [`CharacterTypeGainsStatusAtBattleStart`](#charactertypegainsstatusatbattlestart) | Block | Encounter Modifier: Applies a status effect to all characters of a specific type (e.g., Cats, Bosses) at the start of battle. | 8 |
...
| [`RandomStatusFromPool`](#randomstatusfrompool) | Block | Selects and applies a random status effect from the provided nested block. | 8 |
...
| [`StatusEachRoundBegin`](#statuseachroundbegin) | Block | Examples: `{ ... }` | 8 |
...
| `GainCoinsRange` | Block | Grants the player a randomized amount of coins within a min/max range. | 7 |
...
| `Conditional_BadRoll` | Block | Conditional trigger: Executes nested logic based on a randomized bad outcome probability. | 6 |
...
| [`ScatterCoins`](./Arrays.md#array-scattercoins) | Block | Throws coins out into the level randomly. | 6 |
...
| [`StatusGroup`](#statusgroup) | Block | Groups multiple status effects together for batch application. | 5 |
...
| [`Tangled`](./Arrays.md#array-tangled) | Block | Applies a tangled/ensnared status effect, often modifying visual sprites. | 5 |
...
| `Conditional_PartyMember` | Block | Conditional constraint. Nested properties only trigger if this is true. | 4 |
...
| [`DamageNeighborsAfterMove`](#damageneighborsaftermove) | Block | Examples: `{ ... }` | 4 |
...
| [`ProtectTargetedAllies`](./Enums.md#enum-protecttargetedallies) | Block | AI Logic: Navigates to intercept attacks directed at allies. | 4 |
...
| `bug` | Variable |  | 4 |
| `equal` | Variable |  | 4 |
| [`extra_statuses`](#extra_statuses) | Block | Additional generic status applications. | 4 |
...
| `Conditional_RandomChance` | Block | Conditional trigger: Executes nested logic based on a flat percentage random roll. | 3 |
| `Conditional_Shielded` | Block | Conditional trigger: Executes nested logic if the target currently has a Shield status. | 3 |
...
| `CreateGlobalModifiers` | Block | Generates global map or encounter rules/modifiers. | 3 |
...
| [`KnockOutCoin`](./Arrays.md#array-knockoutcoin) | Block | Forces the target to drop coins. | 3 |
...
| [`StatusAllCharactersOnSpawn`](#statusallcharactersonspawn) | Block | Applies or references the 'StatusAllCharactersOnSpawn' effect/state. | 3 |
...
| `TVOff` | Variable |  | 3 |
| [`TakeBonusTurnWithAIControl`](#takebonusturnwithaicontrol) | Block | Grants the character an immediate extra turn, but forces the AI to control them during it. | 3 |
| `ThornUpX` | Variable |  | 3 |
...
| [`ApplyStatusIfCrit`](#applystatusifcrit) | Block | Conditional trigger: Executes the nested logic only if the triggering action was a critical hit. | 2 |
...
| `SetItemAux` | Block | Applies or references the 'SetItemAux' effect/state. | 2 |
...
| [`SpawnCatCopyWhenDowned`](#spawncatcopywhendowned) | Block | Examples: `{ ... }` | 2 |
...
| [`StatusOnEatPill`](#statusoneatpill) | Block | Examples: `{ ... }` | 2 |
...
| [`StatusOnSetPieceBreak`](#statusonsetpiecebreak) | Block | Examples: `{ ... }` | 2 |
...
| [`AddStatusToFirstSpellEachTurn`](#addstatustofirstspelleachturn) | Block | Examples: `{ ... }` | 1 |
...
| [`Conditional_Flying`](#conditional_flying) | Block | Examples: `{ ... }` | 1 |
...
| [`Conditional_Tiny`](#conditional_tiny) | Block | Examples: `{ ... }` | 1 |
...
| [`CyborgTurns`](#cyborgturns) | Block | Examples: `{ ... }` | 1 |
...
| [`GlobalFlowerTrapperAura`](#globalflowertrapperaura) | Block | Examples: `{ ... }` | 1 |
...
| [`RandomPermanentStatsDistinct`](#randompermanentstatsdistinct) | Block | Examples: `{ ... }` | 1 |
| `RatKing` | Variable |  | 1 |
...
| [`StatusEveryXSpellCastsEachTurn`](#statuseveryxspellcastseachturn) | Block | Examples: `{ ... }` | 1 |
...
| [`StatusIfDidntMove`](#statusifdidntmove) | Block | Examples: `{ ... }` | 1 |
| [`StatusOnDodge`](#statusondodge) | Block | Event Trigger: Applies statuses when this action occurs. | 1 |
| [`StatusOnEnemyCastSpell`](#statusonenemycastspell) | Block | Examples: `{ ... }` | 1 |
...
| [`TakeBonusTurnWithStatus`](#takebonusturnwithstatus) | Block | Grants the character an immediate extra turn while afflicted with specific statuses. | 1 |
...
| [`damage`](./Arrays.md#array-damage) | Integer | The base damage properties of an attack. | 22 |
...
| [`passives`](#passives) | Block | Examples: `{ ... }` | 13 |
| [`threshold`](#threshold) | Block | Examples: `4*champion_multiplier, 3*champion_multiplier, 1` | 13 |
| [`{Status and Passive Keys}`](./Engine_StatusAndPassiveKeys.md#valid-property-keys) | Block | All valid keys from the specified engine key are applicable to this context/block. | 0 |
...
| [`passives`](#passives) | Block | Examples: `{ ... }` | 18 |
| [`{Status and Passive Keys}`](./Engine_StatusAndPassiveKeys.md#valid-property-keys) | Block | All valid keys from the specified engine key are applicable to this context/block. | 0 |
...
| Property Key | Type | Definition | Count |
| :--- | :--- | :--- | :--- |
| [`effects`](#effects) | Block | Non-damaging status applications and logic triggers executed on impact. | 29 |
| [`damage`](./Arrays.md#array-damage) | Integer | The base damage properties of an attack. | 8 |
