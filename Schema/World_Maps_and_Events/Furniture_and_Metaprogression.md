...
| `Comfort` | Integer | The amount of comfort provided by the furniture piece to the room. | 408 | `-1`<br>`-2`<br>`-3` |
| `Appeal` | Integer | The amount of appeal provided by the furniture piece to the room. | 340 | `-1`<br>`-2`<br>`-4` |
...
| `Stimulation` | Integer | The amount of stimulation provided by the furniture piece to the room. | 270 | `-1`<br>`-2`<br>`1` |
| `Health` | Integer | The amount of health provided by the furniture piece to the room. | 68 | `-1`<br>`-2`<br>`-5` |
| `Evolution` | Integer | The amount of evolution provided by the furniture piece to the room. | 54 | `1`<br>`2`<br>`4` |
| `special` | Boolean | An array or boolean indicating that an item or entry is a special container or category. | 49 | `[special]`<br>`true` |
