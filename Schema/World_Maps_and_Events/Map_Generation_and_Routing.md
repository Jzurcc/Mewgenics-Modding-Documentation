...
| `rare` | `Array`  | Defines the rare reward block for a boss encounter. | 1061 | `1`<br>`10`<br>`15` |
...
| [`special`](../Reference_and_Meta/Arrays.md#array-special) | Array | An array or boolean indicating that an item or entry is a special container or category. | 49 | `[special]`<br>`true` |
...
| [`battle`](../Reference_and_Meta/Miscellaneous.md#object-battle) | Object | Defines a battle encounter by preset, level file path, or reverb settings. | 36 | `{ . . . }` |
| [`hard`](../Reference_and_Meta/Arrays.md#array-hard) | Array | Configuration for hard difficulty, including elite/champ budgets and rewards. | 47 | `[easy bigsharklevels]`<br>`[easy]`<br>`[hard]` |
| [`miniboss`](../Reference_and_Meta/Arrays.md#array-miniboss) | Array | An array or object defining the reward table for miniboss encounters, including coin ranges, food ranges, and loot chances. | 54 | `[miniboss]` |
...
| [`easy`](../Reference_and_Meta/Arrays.md#array-easy) | Array | Configuration for easy difficulty, including elite/champ budgets and rewards. | 67 | `[easy bigsharklevels]`<br>`[easy]` |
...
| [`large`](../Reference_and_Meta/Arrays.md#array-large) | Array | An array of enemy unit identifiers used as the large enemy pool for an area or boss encounter. | 21 | `[Carnibulb]`<br>`[KillDozer]`<br>`[MegaFetus]` |
| [`medium`](../Reference_and_Meta/Arrays.md#array-medium) | Array | An array of enemy unit identifiers used as the medium enemy pool for an area or boss encounter. | 42 | `[Rat Leaper Pooter Kitten TomTom Mangy CatCaller]` |
| [`small`](../Reference_and_Meta/Arrays.md#array-small) | Array | An array of enemy unit identifiers used as the small enemy pool for an area or boss encounter. | 45 | `[Amoeba]`<br>`[Flea Wisp Fly Maggot]`<br>`[Maggot Fly Flea Pinky]` |
...
| [`override_art`](../Reference_and_Meta/Enums.md#enum-override_art) | Enum | Specifies the visual art key used to override the default node appearance on the map. | 64 | `MapNodeExit_Bunker`<br>`MapNodeExit_Core`<br>`MapNodeExit_Crater` |
...
| [`time_machine`](../Reference_and_Meta/Miscellaneous.md#object-time_machine) | Object | Defines a special event node that leads to a time machine quest level. | 6 | `{ . . . }` |
| [`dimensionx`](../Reference_and_Meta/Miscellaneous.md#object-dimensionx) | Object | An enum specifying the Dimension X chapter area, or an object with its specific properties. | 45 | `{ . . . }` |
| [`meatworld`](../Reference_and_Meta/Miscellaneous.md#object-meatworld) | Object | An enum specifying the Meatworld chapter area, or an object with its specific properties. | 45 | `{ . . . }` |
| [`boneyard`](../Reference_and_Meta/Miscellaneous.md#object-boneyard) | Object | Specifies the name, map flag, or connection for the Boneyard area. | 45 | `{ . . . }` |
| [`bunker`](../Reference_and_Meta/Miscellaneous.md#object-bunker) | Object | Specifies the name, map flag, or connection for the Bunker area. | 21 | `{ . . . }` |
| [`core`](../Reference_and_Meta/Miscellaneous.md#object-core) | Object | Specifies the name, map flag, or connection for the Core area. | 45 | `{ . . . }` |
| [`moon`](../Reference_and_Meta/Miscellaneous.md#object-moon) | Object | Specifies the name, map flag, or connection for the Moon area. | 45 | `{ . . . }` |
| [`alley`](../Reference_and_Meta/Miscellaneous.md#object-alley) | Object | Specifies the name, map flag, or connection for the Alley area. | 25 | `{ . . . }` |
| [`endoftime`](../Reference_and_Meta/Miscellaneous.md#object-endoftime) | Object | Configures various attributes of the End of Time area, depending on context. | 45 | `{ . . . }` |
| [`crater`](../Reference_and_Meta/Miscellaneous.md#object-crater) | Object | Specifies the name, map flag, or connection for the Crater area. | 20 | `{ . . . }` |
| [`desert`](../Reference_and_Meta/Miscellaneous.md#object-desert) | Object | Specifies the name, map flag, or connection for the Desert area. | 23 | `{ . . . }` |
...
| [`sewers`](../Reference_and_Meta/Miscellaneous.md#object-sewers) | Object | Specifies the name, map flag, or connection for the Sewers area. | 20 | `{ . . . }` |
| [`iceage`](../Reference_and_Meta/Miscellaneous.md#object-iceage) | Object | Specifies the name, map flag, or connection for the Ice Age area. | 32 | `{ . . . }` |
| [`jurassic`](../Reference_and_Meta/Miscellaneous.md#object-jurassic) | Object | Specifies the name, map flag, or connection for the Jurassic area. | 56 | `{ . . . }` |
| [`lab`](../Reference_and_Meta/Miscellaneous.md#object-lab) | Object | Specifies the name, map flag, or connection for the Lab area. | 20 | `{ . . . }` |
| [`theend`](../Reference_and_Meta/Miscellaneous.md#object-theend) | Object | Specifies the name, map flag, or connection for The End area. | 51 | `{ . . . }` |
| [`caves`](../Reference_and_Meta/Miscellaneous.md#object-caves) | Object | Specifies the name, map flag, or connection for the Caves area. | 42 | `{ . . . }` |
| [`junkyard`](../Reference_and_Meta/Miscellaneous.md#object-junkyard) | Object | Specifies the name, map flag, or connection for the Junkyard area. | 18 | `{ . . . }` |
| [`jestercat`](../Reference_and_Meta/Enums.md#enum-jestercat) | Enum | Specifies the boss or miniboss configuration for JesterCat, often set to "auto" for procedural generation. | 7 | `auto` |
...
| [`BothObelisksUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-bothobelisksunlocked) | Object  | Configures the map event and art when both obelisks have been unlocked. | 4 | `{ . . . }` |
| [`MeatWorldUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-meatworldunlocked) | Object  | Configures the map event and routes when MeatWorld is initially unlocked. | 3 | `{ . . . }` |
| [`DimensionXUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-dimensionxunlocked) | Object  | Configures the map event and art when Dimension X is unlocked. | 3 | `{ . . . }` |
| [`EndOfTimeUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-endoftimeunlocked) | Object  | Configures the map event and route visibility when End of Time is unlocked. | 3 | `{ . . . }` |
| [`hard_initial`](../Reference_and_Meta/Miscellaneous.md#object-hard_initial) | Object  | An object defining the properties of the initial hard path node. | 4 | `{ . . . }` |
| [`HardPathUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-hardpathunlocked) | Object  | Unlocks the hard difficulty path on the map, usually by setting a node's locked state to false. | 3 | `{ . . . }` |
...
| [`CoreObeliskUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-coreobeliskunlocked) | Object  | Configures the map event and art when the Core Obelisk is raised and unlocked. | 3 | `{ . . . }` |
| [`MoonObeliskUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-moonobeliskunlocked) | Object  | Configures the map event and art when the Moon Obelisk is raised and unlocked. | 3 | `{ . . . }` |
| [`queenhippo`](../Reference_and_Meta/Enums.md#enum-queenhippo) | Enum | Specifies the boss configuration for QueenHippo. Setting to "auto" generates it procedurally, or an inline object can define custom subfolder and cutscene. | 5 | `auto` |
| [`butchercat`](../Reference_and_Meta/Enums.md#enum-butchercat) | Enum | Specifies the miniboss configuration for ButcherCat, typically set to "auto". | 3 | `auto` |
| [`fightercat`](../Reference_and_Meta/Enums.md#enum-fightercat) | Enum | Specifies the miniboss configuration for FighterCat, typically set to "auto". | 3 | `auto` |
| [`magecat`](../Reference_and_Meta/Enums.md#enum-magecat) | Enum | Specifies the miniboss configuration for MageCat, typically set to "auto". | 3 | `auto` |
| [`monkcat`](../Reference_and_Meta/Enums.md#enum-monkcat) | Enum | Specifies the miniboss configuration for MonkCat, typically set to "auto". | 3 | `auto` |
| [`necrocat`](../Reference_and_Meta/Enums.md#enum-necrocat) | Enum | Specifies the miniboss configuration for NecroCat, typically set to "auto". | 3 | `auto` |
| [`psychiccat`](../Reference_and_Meta/Enums.md#enum-psychiccat) | Enum | Specifies the miniboss configuration for PsychicCat, typically set to "auto". | 2 | `auto` |
...
| [`thiefcat`](../Reference_and_Meta/Enums.md#enum-thiefcat) | Enum | Specifies the miniboss configuration for ThiefCat, typically set to "auto". | 3 | `auto` |
| [`tinkerercat`](../Reference_and_Meta/Enums.md#enum-tinkerercat) | Enum | Specifies the miniboss configuration for TinkerCat, typically set to "auto". | 3 | `auto` |
| [`bumblefoot`](../Reference_and_Meta/Enums.md#enum-bumblefoot) | Enum | Specifies the Bumblefoot miniboss encounter. | 7 | `auto` |
| [`flushmaster`](../Reference_and_Meta/Enums.md#enum-flushmaster) | Enum | Specifies the Flushmaster miniboss encounter. | 3 | `auto` |
| [`gambit`](../Reference_and_Meta/Enums.md#enum-gambit) | Enum | Determines which Gambit boss encounter occurs. | 5 | `auto` |
| [`radicalrat`](../Reference_and_Meta/Enums.md#enum-radicalrat) | Enum | Specifies the Radical Rat boss encounter. | 4 | `auto` |
| [`spewer`](../Reference_and_Meta/Enums.md#enum-spewer) | Enum | Specifies the Spewer boss encounter. | 4 | `auto` |
| [`zodiac`](../Reference_and_Meta/Enums.md#enum-zodiac) | Enum | Specifies the Zodiac boss encounter. | 3 | `auto` |
| [`abandonedones`](../Reference_and_Meta/Enums.md#enum-abandonedones) | Enum | Specifies the Abandoned Ones miniboss encounter. | 3 | `auto` |
| `advance` | Number | The number of levels the nemesis advances when triggered. | 1 | `1` |
| [`BoneyardUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-boneyardunlocked) | Object  | Unlocks an exit route to the Boneyard on the map. | 2 | `{ . . . }` |
| [`BunkerUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-bunkerunlocked) | Object  | Unlocks an exit route to the Bunker on the map. | 2 | `{ . . . }` |
| [`cancreeper`](../Reference_and_Meta/Enums.md#enum-cancreeper) | Enum | Specifies the Cancreeper miniboss encounter. | 3 | `auto` |
| [`cavecatfamily`](../Reference_and_Meta/Enums.md#enum-cavecatfamily) | Enum | Specifies the Cave Cat Family miniboss encounter. | 2 | `auto` |
| [`CavesUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-cavesunlocked) | Object  | Unlocks an exit route to the Caves on the map. | 2 | `{ . . . }` |
| [`cerberubs`](../Reference_and_Meta/Enums.md#enum-cerberubs) | Enum | Specifies the Cerberubs miniboss encounter. | 3 | `auto` |
...
| [`clericcat`](../Reference_and_Meta/Enums.md#enum-clericcat) | Enum | Specifies the Cleric Cat miniboss encounter. | 3 | `auto` |
| [`CoreUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-coreunlocked) | Object  | Unlocks an exit route to the Core on the map. | 2 | `{ . . . }` |
| [`CraterUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-craterunlocked) | Object  | Unlocks an exit route to the Crater on the map. | 2 | `{ . . . }` |
| [`dinocouple`](../Reference_and_Meta/Enums.md#enum-dinocouple) | Enum | Specifies the Dino Couple miniboss encounter. | 2 | `auto` |
| [`drmangler`](../Reference_and_Meta/Enums.md#enum-drmangler) | Enum | Specifies the Dr. Mangler miniboss encounter. | 4 | `auto` |
| [`druidcat`](../Reference_and_Meta/Enums.md#enum-druidcat) | Enum | Specifies the Druid Cat miniboss encounter. | 3 | `auto` |
...
| [`FutureUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-futureunlocked) | Object  | Configures the map event and art when the Future is unlocked. | 2 | `{ . . . }` |
...
| [`huntercat`](../Reference_and_Meta/Enums.md#enum-huntercat) | Enum | Specifies the Hunter Cat miniboss encounter. | 3 | `auto` |
| [`IceAgeUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-iceageunlocked) | Object  | Configures the map event and art when Ice Age is unlocked. | 2 | `{ . . . }` |
| [`iceelemental`](../Reference_and_Meta/Enums.md#enum-iceelemental) | Enum | Specifies the Ice Elemental miniboss encounter. | 2 | `auto` |
| [`infestedduo`](../Reference_and_Meta/Enums.md#enum-infestedduo) | Enum | Specifies the Infested Duo miniboss encounter. | 4 | `auto` |
| [`JunkyardUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-junkyardunlocked) | Object  | Unlocks an exit route to the Junkyard on the map. | 2 | `{ . . . }` |
| [`JurassicUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-jurassicunlocked) | Object  | Unlocks an exit route to the Jurassic area on the map. | 2 | `{ . . . }` |
| [`lenny`](../Reference_and_Meta/Enums.md#enum-lenny) | Enum | Specifies the Lenny miniboss encounter. | 3 | `auto` |
| [`lightningelemental`](../Reference_and_Meta/Enums.md#enum-lightningelemental) | Enum | Specifies the Lightning Elemental miniboss encounter. | 2 | `auto` |
| `locked` | Boolean | If true, this exit is locked and cannot be used until unlocked by a condition. | 29 | `false`<br>`true` |
| [`mamamaggot`](../Reference_and_Meta/Enums.md#enum-mamamaggot) | Enum | Specifies the Mama Maggot miniboss encounter. | 3 | `auto` |
| [`MeatWorldUnlockedFull`](../Reference_and_Meta/Miscellaneous.md#object-meatworldunlockedfull) | Object  | Unlocks hidden battle and hard nodes within the MeatWorld area on the map. | 2 | `{ . . . }` |
...
| [`MoonUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-moonunlocked) | Object  | Unlocks an exit route to the Moon on the map. | 2 | `{ . . . }` |
| [`musiclayer`](../Reference_and_Meta/Enums.md#enum-musiclayer) | Enum | Specifies the music layer to play for this node (e.g., 'boss'). | 2 | `boss` |
...
| [`mw_battle1`](../Reference_and_Meta/Miscellaneous.md#object-mw_battle1) | Object  | An object defining the properties of the first MeatWorld battle node. | 2 | `{ . . . }` |
| [`mw_boss`](../Reference_and_Meta/Miscellaneous.md#object-mw_boss) | Object  | An object defining the properties of the MeatWorld boss node. | 2 | `{ . . . }` |
| [`mw_earlyhome`](../Reference_and_Meta/Miscellaneous.md#object-mw_earlyhome) | Object  | An object defining the properties of the MeatWorld early home node. | 2 | `{ . . . }` |
| [`mw_event1`](../Reference_and_Meta/Miscellaneous.md#object-mw_event1) | Object  | An object defining the properties of the first MeatWorld event node. | 2 | `{ . . . }` |
| [`mw_hard1`](../Reference_and_Meta/Miscellaneous.md#object-mw_hard1) | Object  | An object defining the properties of the first MeatWorld hard path node. | 2 | `{ . . . }` |
| [`mw_home`](../Reference_and_Meta/Miscellaneous.md#object-mw_home) | Object  | An object defining the properties of the MeatWorld home node. | 2 | `{ . . . }` |
| [`mw_quest_event`](../Reference_and_Meta/Miscellaneous.md#object-mw_quest_event) | Object  | An object defining the properties of the MeatWorld quest event node. | 2 | `{ . . . }` |
| [`mw_treasure`](../Reference_and_Meta/Miscellaneous.md#object-mw_treasure) | Object  | An object defining the properties of the MeatWorld treasure node. | 2 | `{ . . . }` |
| [`ratking`](../Reference_and_Meta/Enums.md#enum-ratking) | Enum | Specifies the Rat King miniboss encounter. | 4 | `auto` |
| [`rockybobo`](../Reference_and_Meta/Enums.md#enum-rockybobo) | Enum | Specifies the Rocky Bobo miniboss encounter. | 3 | `auto` |
| [`SewersUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-sewersunlocked) | Object  | Unlocks an exit route to the Sewers on the map. | 2 | `{ . . . }` |
...
| [`slime`](../Reference_and_Meta/Enums.md#enum-slime) | Enum | Specifies the Slime miniboss encounter. | 3 | `auto` |
...
| [`stacy`](../Reference_and_Meta/Enums.md#enum-stacy) | Enum | Specifies the Stacy boss encounter. | 3 | `auto` |
| [`tankcat`](../Reference_and_Meta/Enums.md#enum-tankcat) | Enum | Specifies the Tank Cat miniboss encounter. | 3 | `auto` |
| [`thebloat`](../Reference_and_Meta/Enums.md#enum-thebloat) | Enum | Specifies The Bloat miniboss encounter. | 2 | `auto` |
| [`TheEndUnlocked`](../Reference_and_Meta/Miscellaneous.md#object-theendunlocked) | Object  | An object that stores flags related to unlocking the 'The End' chapter. | 2 | `{ . . . }` |
...
| [`trampy`](../Reference_and_Meta/Enums.md#enum-trampy) | Enum | Specifies the Trampy miniboss encounter. | 3 | `auto` |
...
| :--- | :--- | :--- | :--- | :--- |
| [`type`](../Reference_and_Meta/Enums.md#enum-type) | Enum | Specifies the damage type classification (e.g., melee, spell_cost, enter) used for interactions with mods, statuses, and passives. | 836 | `[attack move spell]`<br>`attack`<br>`battle` |
| [`boss_cutscene`](../Reference_and_Meta/Enums.md#enum-boss_cutscene) | Enum | Specifies which boss cutscene to play before this encounter. | 17 | `alienqueen`<br>`coven`<br>`dybbuk` |
| `is_final_boss` | Boolean | If true, this encounter is the final boss of the chapter. | 2 | `true` |
| [`level`](../Reference_and_Meta/Enums.md#enum-level) | Enum | The level or quest identifier to load. | 67 | `"house_bosses/guillotina1.lvl"`<br>`"house_bosses/guillotina2.lvl"`<br>`"house_bosses/guillotina3.lvl"` |
| [`override_music`](../Reference_and_Meta/Enums.md#enum-override_music) | Enum | Specifies an alternative music track to play during this boss encounter. | 3 | `chaos_boss`<br>`finalboss`<br>`throbbingking` |
| [`tileset`](../Reference_and_Meta/Enums.md#enum-tileset) | Enum | Specifies the tileset to use for this boss arena. | 20 | `finalboss` |
...
| :--- | :--- | :--- | :--- | :--- |
| `locked` | Boolean | If true, this exit is locked and cannot be used until unlocked by a condition. | 29 | `false`<br>`true` |
| [`next_map`](../Reference_and_Meta/Enums.md#enum-next_map) | Enum | Specifies which map file to load when this exit is used. | 20 | `bunker.gon`<br>`core.gon`<br>`crater.gon` |
| [`override_art`](../Reference_and_Meta/Enums.md#enum-override_art) | Enum | Specifies the visual art key used to override the default node appearance on the map. | 64 | `MapNodeExit_Bunker`<br>`MapNodeExit_Core`<br>`MapNodeExit_Crater` |
| [`type`](../Reference_and_Meta/Enums.md#enum-type) | Enum | Specifies the damage type classification (e.g., melee, spell_cost, enter) used for interactions with mods, statuses, and passives. | 836 | `[attack move spell]`<br>`attack`<br>`battle` |
| `hidden` | Boolean | If true, this exit is not shown on the map until it is discovered. | 29 | `false`<br>`true` |
...
| Key | Type | Definition | Count | Example Inputs |
| :--- | :--- | :--- | :--- | :--- |
| `spin_cats` | Boolean | If true, cats on this node will rotate to face their movement direction. | 6 | `true` |
