...
| [`default_face`](../Reference_and_Meta/Enums.md#enum-default_face) | Enum | Specifies the default facial expression for the unit's portrait. | 16 | `angry`<br>`happy`<br>`mad` |
...
| [`misc`](../Reference_and_Meta/Arrays.md#array-misc) | Array | A list of ability names that do not fit into other categories. | 110 | `[` |
...
| [`defense`](../Reference_and_Meta/Arrays.md#array-defense) | Array | An array of defensive ability names. | 54 | `[` |
...
| [`SpawnOnBattleStart`](../Reference_and_Meta/Enums.md#enum-spawnonbattlestart) | Enum  | Specifies the object that spawns adjacent to the unit at the start of battle. | 54 | `BeefyCharmedLeech`<br>`BuffCharmedKitten`<br>`CharmedCultist` |
