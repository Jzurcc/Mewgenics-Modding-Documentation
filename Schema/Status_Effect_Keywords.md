...
| [`tooltip_stacks_singular`](./Strings.md#string-tooltip_stacks_singular) | String |  | 15 | `"KEYWORD_AUTOREVIVE_DESC_SINGULAR"`<br>`"KEYWORD_BLIND_DESC_STACKLESS"`<br>`"KEYWORD_BONUSMOVE_DESC"` |
